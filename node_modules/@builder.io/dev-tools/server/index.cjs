...
`)}async function Eo(e,t){let n=await Yi(e),r=e.getFrameworks();return t.replace(/__LOCAL_APP_ID__/g,n).replace(/__DEV_TOOLS_URL__/g,e.devToolsServerUrl).replace(/__CLIENT_ID__/g,e.getClientId()).replace(/__FRAMEWORK__/g,r.length?r[0].name:"")}var Fo=require("os");async function wo(e,t){let n=new URL("/cli-auth","https://builder.io");n.searchParams.set("client_id",e.getClientId()),n.searchParams.set("host",await e.getDeviceId()),n.searchParams.set("response_type","code"),n.searchParams.set("cli","true");let r=new URL(Ft,e.devToolsServerUrl);r.searchParams.set(Pr,(0,Fo.platform)()),r.searchParams.set(Tr,process.versions.node);let o=e.getFrameworks();return o.length>0&&(n.searchParams.set(Rt,o[0].name),r.searchParams.set(Rt,o[0].name)),n.searchParams.set("redirect_url",r.href),n.searchParams.set("preview_url",t),n.href}var yu=require("http");var Eu=require("os"),Ze=require("path"),$e=require("fs");var Fe=T(Nr(),1),Mr=require("process");var Tn=T(require("readline"),1),No=require("stream");function nl({onlyFirst:e=!1}={}){let t=["[\\u001B\\u009B][[\\]()#;?]*(?:(?:(?:(?:;[-a-zA-Z\\d\\/#&.:=?%@~_]+)*|[a-zA-Z\\d]+(?:;[-a-zA-Z\\d\\/#&.:=?%@~_]*)*)?(?:\\u0007|\\u001B\\u005C|\\u009C))","(?:(?:\\d{1,4}(?:;\\d{0,4})*)?[\\dA-PR-TZcf-nq-uy=><~]))"].join("|");return new RegExp(t,e?void 0:"g")}var il=nl();function $o(e){if(typeof e!="string")throw new TypeError(`Expected a \`string\`, got \`${typeof e}\``);return e.replace(il,"")}function Oo(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var Lo={exports:{}};(function(e){var t={};e.exports=t,t.eastAsianWidth=function(r){var o=r.charCodeAt(0),s=r.length==2?r.charCodeAt(1):0,i=o;return 55296<=o&&o<=56319&&56320<=s&&s<=57343&&(o&=1023,s&=1023,i=o<<10|s,i+=65536),i==12288||65281<=i&&i<=65376||65504<=i&&i<=65510?"F":i==8361||65377<=i&&i<=65470||65474<=i&&i<=65479||65482<=i&&i<=65487||65490<=i&&i<=65495||65498<=i&&i<=65500||65512<=i&&i<=65518?"H":4352<=i&&i<=4447||4515<=i&&i<=4519||4602<=i&&i<=4607||9001<=i&&i<=9002||11904<=i&&i<=11929||11931<=i&&i<=12019||12032<=i&&i<=12245||12272<=i&&i<=12283||12289<=i&&i<=12350||12353<=i&&i<=12438||12441<=i&&i<=12543||12549<=i&&i<=12589||12593<=i&&i<=12686||12688<=i&&i<=12730||12736<=i&&i<=12771||12784<=i&&i<=12830||12832<=i&&i<=12871||12880<=i&&i<=13054||13056<=i&&i<=19903||19968<=i&&i<=42124||42128<=i&&i<=42182||43360<=i&&i<=43388||44032<=i&&i<=55203||55216<=i&&i<=55238||55243<=i&&i<=55291||63744<=i&&i<=64255||65040<=i&&i<=65049||65072<=i&&i<=65106||65108<=i&&i<=65126||65128<=i&&i<=65131||110592<=i&&i<=110593||127488<=i&&i<=127490||127504<=i&&i<=127546||127552<=i&&i<=127560||127568<=i&&i<=127569||131072<=i&&i<=194367||177984<=i&&i<=196605||196608<=i&&i<=262141?"W":32<=i&&i<=126||162<=i&&i<=163||165<=i&&i<=166||i==172||i==175||10214<=i&&i<=10221||10629<=i&&i<=10630?"Na":i==161||i==164||167<=i&&i<=168||i==170||173<=i&&i<=174||176<=i&&i<=180||182<=i&&i<=186||188<=i&&i<=191||i==198||i==208||215<=i&&i<=216||222<=i&&i<=225||i==230||232<=i&&i<=234||236<=i&&i<=237||i==240||242<=i&&i<=243||247<=i&&i<=250||i==252||i==254||i==257||i==273||i==275||i==283||294<=i&&i<=295||i==299||305<=i&&i<=307||i==312||319<=i&&i<=322||i==324||328<=i&&i<=331||i==333||338<=i&&i<=339||358<=i&&i<=359||i==363||i==462||i==464||i==466||i==468||i==470||i==472||i==474||i==476||i==593||i==609||i==708||i==711||713<=i&&i<=715||i==717||i==720||728<=i&&i<=731||i==733||i==735||768<=i&&i<=879||913<=i&&i<=929||931<=i&&i<=937||945<=i&&i<=961||963<=i&&i<=969||i==1025||1040<=i&&i<=1103||i==1105||i==8208||8211<=i&&i<=8214||8216<=i&&i<=8217||8220<=i&&i<=8221||8224<=i&&i<=8226||8228<=i&&i<=8231||i==8240||8242<=i&&i<=8243||i==8245||i==8251||i==8254||i==8308||i==8319||8321<=i&&i<=8324||i==8364||i==8451||i==8453||i==8457||i==8467||i==8470||8481<=i&&i<=8482||i==8486||i==8491||8531<=i&&i<=8532||8539<=i&&i<=8542||8544<=i&&i<=8555||8560<=i&&i<=8569||i==8585||8592<=i&&i<=8601||8632<=i&&i<=8633||i==8658||i==8660||i==8679||i==8704||8706<=i&&i<=8707||8711<=i&&i<=8712||i==8715||i==8719||i==8721||i==8725||i==8730||8733<=i&&i<=8736||i==8739||i==8741||8743<=i&&i<=8748||i==8750||8756<=i&&i<=8759||8764<=i&&i<=8765||i==8776||i==8780||i==8786||8800<=i&&i<=8801||8804<=i&&i<=8807||8810<=i&&i<=8811||8814<=i&&i<=8815||8834<=i&&i<=8835||8838<=i&&i<=8839||i==8853||i==8857||i==8869||i==8895||i==8978||9312<=i&&i<=9449||9451<=i&&i<=9547||9552<=i&&i<=9587||9600<=i&&i<=9615||9618<=i&&i<=9621||9632<=i&&i<=9633||9635<=i&&i<=9641||9650<=i&&i<=9651||9654<=i&&i<=9655||9660<=i&&i<=9661||9664<=i&&i<=9665||9670<=i&&i<=9672||i==9675||9678<=i&&i<=9681||9698<=i&&i<=9701||i==9711||9733<=i&&i<=9734||i==9737||9742<=i&&i<=9743||9748<=i&&i<=9749||i==9756||i==9758||i==9792||i==9794||9824<=i&&i<=9825||9827<=i&&i<=9829||9831<=i&&i<=9834||9836<=i&&i<=9837||i==9839||9886<=i&&i<=9887||9918<=i&&i<=9919||9924<=i&&i<=9933||9935<=i&&i<=9953||i==9955||9960<=i&&i<=9983||i==10045||i==10071||10102<=i&&i<=10111||11093<=i&&i<=11097||12872<=i&&i<=12879||57344<=i&&i<=63743||65024<=i&&i<=65039||i==65533||127232<=i&&i<=127242||127248<=i&&i<=127277||127280<=i&&i<=127337||127344<=i&&i<=127386||917760<=i&&i<=917999||983040<=i&&i<=1048573||1048576<=i&&i<=1114109?"A":"N"},t.characterLength=function(r){var o=this.eastAsianWidth(r);return o=="F"||o=="W"||o=="A"?2:1};function n(r){return r.match(/[\uD800-\uDBFF][\uDC00-\uDFFF]|[^\uD800-\uDFFF]/g)||[]}t.length=function(r){for(var o=n(r),s=0,i=0;i<o.length;i++)s=s+this.characterLength(o[i]);return s},t.slice=function(r,o,s){textLen=t.length(r),o=o||0,s=s||1,o<0&&(o=textLen+o),s<0&&(s=textLen+s);for(var i="",a=0,u=n(r),l=0;l<u.length;l++){var c=u[l],p=t.length(c);if(a>=o-(p==2?1:0))if(a+p<=s)i+=c;else break;a+=p}return i}})(Lo);var ol=Lo.exports,sl=Oo(ol),al=function(){return/\uD83C\uDFF4\uDB40\uDC67\uDB40\uDC62(?:\uDB40\uDC77\uDB40\uDC6C\uDB40\uDC73|\uDB40\uDC73\uDB40\uDC63\uDB40\uDC74|\uDB40\uDC65\uDB40\uDC6E\uDB40\uDC67)\uDB40\uDC7F|(?:\uD83E\uDDD1\uD83C\uDFFF\u200D\u2764\uFE0F\u200D(?:\uD83D\uDC8B\u200D)?\uD83E\uDDD1|\uD83D\uDC69\uD83C\uDFFF\u200D\uD83E\uDD1D\u200D(?:\uD83D[\uDC68\uDC69]))(?:\uD83C[\uDFFB-\uDFFE])|(?:\uD83E\uDDD1\uD83C\uDFFE\u200D\u2764\uFE0F\u200D(?:\uD83D\uDC8B\u200D)?\uD83E\uDDD1|\uD83D\uDC69\uD83C\uDFFE\u200D\uD83E\uDD1D\u200D(?:\uD83D[\uDC68\uDC69]))(?:\uD83C[\uDFFB-\uDFFD\uDFFF])|(?:\uD83E\uDDD1\uD83C\uDFFD\u200D\u2764\uFE0F\u200D(?:\uD83D\uDC8B\u200D)?\uD83E\uDDD1|\uD83D\uDC69\uD83C\uDFFD\u200D\uD83E\uDD1D\u200D(?:\uD83D[\uDC68\uDC69]))(?:\uD83C[\uDFFB\uDFFC\uDFFE\uDFFF])|(?:\uD83E\uDDD1\uD83C\uDFFC\u200D\u2764\uFE0F\u200D(?:\uD83D\uDC8B\u200D)?\uD83E\uDDD1|\uD83D\uDC69\uD83C\uDFFC\u200D\uD83E\uDD1D\u200D(?:\uD83D[\uDC68\uDC69]))(?:\uD83C[\uDFFB\uDFFD-\uDFFF])|(?:\uD83E\uDDD1\uD83C\uDFFB\u200D\u2764\uFE0F\u200D(?:\uD83D\uDC8B\u200D)?\uD83E\uDDD1|\uD83D\uDC69\uD83C\uDFFB\u200D\uD83E\uDD1D\u200D(?:\uD83D[\uDC68\uDC69]))(?:\uD83C[\uDFFC-\uDFFF])|\uD83D\uDC68(?:\uD83C\uDFFB(?:\u200D(?:\u2764\uFE0F\u200D(?:\uD83D\uDC8B\u200D\uD83D\uDC68(?:\uD83C[\uDFFB-\uDFFF])|\uD83D\uDC68(?:\uD83C[\uDFFB-\uDFFF]))|\uD83E\uDD1D\u200D\uD83D\uDC68(?:\uD83C[\uDFFC-\uDFFF])|[\u2695\u2696\u2708]\uFE0F|\uD83C[\uDF3E\uDF73\uDF7C\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uD83E[\uDDAF-\uDDB3\uDDBC\uDDBD]))?|(?:\uD83C[\uDFFC-\uDFFF])\u200D\u2764\uFE0F\u200D(?:\uD83D\uDC8B\u200D\uD83D\uDC68(?:\uD83C[\uDFFB-\uDFFF])|\uD83D\uDC68(?:\uD83C[\uDFFB-\uDFFF]))|\u200D(?:\u2764\uFE0F\u200D(?:\uD83D\uDC8B\u200D)?\uD83D\uDC68|(?:\uD83D[\uDC68\uDC69])\u200D(?:\uD83D\uDC66\u200D\uD83D\uDC66|\uD83D\uDC67\u200D(?:\uD83D[\uDC66\uDC67]))|\uD83D\uDC66\u200D\uD83D\uDC66|\uD83D\uDC67\u200D(?:\uD83D[\uDC66\uDC67])|\uD83C[\uDF3E\uDF73\uDF7C\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uD83E[\uDDAF-\uDDB3\uDDBC\uDDBD])|\uD83C\uDFFF\u200D(?:\uD83E\uDD1D\u200D\uD83D\uDC68(?:\uD83C[\uDFFB-\uDFFE])|\uD83C[\uDF3E\uDF73\uDF7C\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uD83E[\uDDAF-\uDDB3\uDDBC\uDDBD])|\uD83C\uDFFE\u200D(?:\uD83E\uDD1D\u200D\uD83D\uDC68(?:\uD83C[\uDFFB-\uDFFD\uDFFF])|\uD83C[\uDF3E\uDF73\uDF7C\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uD83E[\uDDAF-\uDDB3\uDDBC\uDDBD])|\uD83C\uDFFD\u200D(?:\uD83E\uDD1D\u200D\uD83D\uDC68(?:\uD83C[\uDFFB\uDFFC\uDFFE\uDFFF])|\uD83C[\uDF3E\uDF73\uDF7C\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uD83E[\uDDAF-\uDDB3\uDDBC\uDDBD])|\uD83C\uDFFC\u200D(?:\uD83E\uDD1D\u200D\uD83D\uDC68(?:\uD83C[\uDFFB\uDFFD-\uDFFF])|\uD83C[\uDF3E\uDF73\uDF7C\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uD83E[\uDDAF-\uDDB3\uDDBC\uDDBD])|(?:\uD83C\uDFFF\u200D[\u2695\u2696\u2708]|\uD83C\uDFFE\u200D[\u2695\u2696\u2708]|\uD83C\uDFFD\u200D[\u2695\u2696\u2708]|\uD83C\uDFFC\u200D[\u2695\u2696\u2708]|\u200D[\u2695\u2696\u2708])\uFE0F|\u200D(?:(?:\uD83D[\uDC68\uDC69])\u200D(?:\uD83D[\uDC66\uDC67])|\uD83D[\uDC66\uDC67])|\uD83C\uDFFF|\uD83C\uDFFE|\uD83C\uDFFD|\uD83C\uDFFC)?|(?:\uD83D\uDC69(?:\uD83C\uDFFB\u200D\u2764\uFE0F\u200D(?:\uD83D\uDC8B\u200D(?:\uD83D[\uDC68\uDC69])|\uD83D[\uDC68\uDC69])|(?:\uD83C[\uDFFC-\uDFFF])\u200D\u2764\uFE0F\u200D(?:\uD83D\uDC8B\u200D(?:\uD83D[\uDC68\uDC69])|\uD83D[\uDC68\uDC69]))|\uD83E\uDDD1(?:\uD83C[\uDFFB-\uDFFF])\u200D\uD83E\uDD1D\u200D\uD83E\uDDD1)(?:\uD83C[\uDFFB-\uDFFF])|\uD83D\uDC69\u200D\uD83D\uDC69\u200D(?:\uD83D\uDC66\u200D\uD83D\uDC66|\uD83D\uDC67\u200D(?:\uD83D[\uDC66\uDC67]))|\uD83D\uDC69(?:\u200D(?:\u2764\uFE0F\u200D(?:\uD83D\uDC8B\u200D(?:\uD83D[\uDC68\uDC69])|\uD83D[\uDC68\uDC69])|\uD83C[\uDF3E\uDF73\uDF7C\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uD83E[\uDDAF-\uDDB3\uDDBC\uDDBD])|\uD83C\uDFFF\u200D(?:\uD83C[\uDF3E\uDF73\uDF7C\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uD83E[\uDDAF-\uDDB3\uDDBC\uDDBD])|\uD83C\uDFFE\u200D(?:\uD83C[\uDF3E\uDF73\uDF7C\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uD83E[\uDDAF-\uDDB3\uDDBC\uDDBD])|\uD83C\uDFFD\u200D(?:\uD83C[\uDF3E\uDF73\uDF7C\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uD83E[\uDDAF-\uDDB3\uDDBC\uDDBD])|\uD83C\uDFFC\u200D(?:\uD83C[\uDF3E\uDF73\uDF7C\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uD83E[\uDDAF-\uDDB3\uDDBC\uDDBD])|\uD83C\uDFFB\u200D(?:\uD83C[\uDF3E\uDF73\uDF7C\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uD83E[\uDDAF-\uDDB3\uDDBC\uDDBD]))|\uD83E\uDDD1(?:\u200D(?:\uD83E\uDD1D\u200D\uD83E\uDDD1|\uD83C[\uDF3E\uDF73\uDF7C\uDF84\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uD83E[\uDDAF-\uDDB3\uDDBC\uDDBD])|\uD83C\uDFFF\u200D(?:\uD83C[\uDF3E\uDF73\uDF7C\uDF84\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uD83E[\uDDAF-\uDDB3\uDDBC\uDDBD])|\uD83C\uDFFE\u200D(?:\uD83C[\uDF3E\uDF73\uDF7C\uDF84\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uD83E[\uDDAF-\uDDB3\uDDBC\uDDBD])|\uD83C\uDFFD\u200D(?:\uD83C[\uDF3E\uDF73\uDF7C\uDF84\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uD83E[\uDDAF-\uDDB3\uDDBC\uDDBD])|\uD83C\uDFFC\u200D(?:\uD83C[\uDF3E\uDF73\uDF7C\uDF84\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uD83E[\uDDAF-\uDDB3\uDDBC\uDDBD])|\uD83C\uDFFB\u200D(?:\uD83C[\uDF3E\uDF73\uDF7C\uDF84\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uD83E[\uDDAF-\uDDB3\uDDBC\uDDBD]))|\uD83D\uDC69\u200D\uD83D\uDC66\u200D\uD83D\uDC66|\uD83D\uDC69\u200D\uD83D\uDC69\u200D(?:\uD83D[\uDC66\uDC67])|\uD83D\uDC69\u200D\uD83D\uDC67\u200D(?:\uD83D[\uDC66\uDC67])|(?:\uD83D\uDC41\uFE0F\u200D\uD83D\uDDE8|\uD83E\uDDD1(?:\uD83C\uDFFF\u200D[\u2695\u2696\u2708]|\uD83C\uDFFE\u200D[\u2695\u2696\u2708]|\uD83C\uDFFD\u200D[\u2695\u2696\u2708]|\uD83C\uDFFC\u200D[\u2695\u2696\u2708]|\uD83C\uDFFB\u200D[\u2695\u2696\u2708]|\u200D[\u2695\u2696\u2708])|\uD83D\uDC69(?:\uD83C\uDFFF\u200D[\u2695\u2696\u2708]|\uD83C\uDFFE\u200D[\u2695\u2696\u2708]|\uD83C\uDFFD\u200D[\u2695\u2696\u2708]|\uD83C\uDFFC\u200D[\u2695\u2696\u2708]|\uD83C\uDFFB\u200D[\u2695\u2696\u2708]|\u200D[\u2695\u2696\u2708])|\uD83D\uDE36\u200D\uD83C\uDF2B|\uD83C\uDFF3\uFE0F\u200D\u26A7|\uD83D\uDC3B\u200D\u2744|(?:(?:\uD83C[\uDFC3\uDFC4\uDFCA]|\uD83D[\uDC6E\uDC70\uDC71\uDC73\uDC77\uDC81\uDC82\uDC86\uDC87\uDE45-\uDE47\uDE4B\uDE4D\uDE4E\uDEA3\uDEB4-\uDEB6]|\uD83E[\uDD26\uDD35\uDD37-\uDD39\uDD3D\uDD3E\uDDB8\uDDB9\uDDCD-\uDDCF\uDDD4\uDDD6-\uDDDD])(?:\uD83C[\uDFFB-\uDFFF])|\uD83D\uDC6F|\uD83E[\uDD3C\uDDDE\uDDDF])\u200D[\u2640\u2642]|(?:\u26F9|\uD83C[\uDFCB\uDFCC]|\uD83D\uDD75)(?:\uFE0F|\uD83C[\uDFFB-\uDFFF])\u200D[\u2640\u2642]|\uD83C\uDFF4\u200D\u2620|(?:\uD83C[\uDFC3\uDFC4\uDFCA]|\uD83D[\uDC6E\uDC70\uDC71\uDC73\uDC77\uDC81\uDC82\uDC86\uDC87\uDE45-\uDE47\uDE4B\uDE4D\uDE4E\uDEA3\uDEB4-\uDEB6]|\uD83E[\uDD26\uDD35\uDD37-\uDD39\uDD3D\uDD3E\uDDB8\uDDB9\uDDCD-\uDDCF\uDDD4\uDDD6-\uDDDD])\u200D[\u2640\u2642]|[\xA9\xAE\u203C\u2049\u2122\u2139\u2194-\u2199\u21A9\u21AA\u2328\u23CF\u23ED-\u23EF\u23F1\u23F2\u23F8-\u23FA\u24C2\u25AA\u25AB\u25B6\u25C0\u25FB\u25FC\u2600-\u2604\u260E\u2611\u2618\u2620\u2622\u2623\u2626\u262A\u262E\u262F\u2638-\u263A\u2640\u2642\u265F\u2660\u2663\u2665\u2666\u2668\u267B\u267E\u2692\u2694-\u2697\u2699\u269B\u269C\u26A0\u26A7\u26B0\u26B1\u26C8\u26CF\u26D1\u26D3\u26E9\u26F0\u26F1\u26F4\u26F7\u26F8\u2702\u2708\u2709\u270F\u2712\u2714\u2716\u271D\u2721\u2733\u2734\u2744\u2747\u2763\u27A1\u2934\u2935\u2B05-\u2B07\u3030\u303D\u3297\u3299]|\uD83C[\uDD70\uDD71\uDD7E\uDD7F\uDE02\uDE37\uDF21\uDF24-\uDF2C\uDF36\uDF7D\uDF96\uDF97\uDF99-\uDF9B\uDF9E\uDF9F\uDFCD\uDFCE\uDFD4-\uDFDF\uDFF5\uDFF7]|\uD83D[\uDC3F\uDCFD\uDD49\uDD4A\uDD6F\uDD70\uDD73\uDD76-\uDD79\uDD87\uDD8A-\uDD8D\uDDA5\uDDA8\uDDB1\uDDB2\uDDBC\uDDC2-\uDDC4\uDDD1-\uDDD3\uDDDC-\uDDDE\uDDE1\uDDE3\uDDE8\uDDEF\uDDF3\uDDFA\uDECB\uDECD-\uDECF\uDEE0-\uDEE5\uDEE9\uDEF0\uDEF3])\uFE0F|\uD83C\uDFF3\uFE0F\u200D\uD83C\uDF08|\uD83D\uDC69\u200D\uD83D\uDC67|\uD83D\uDC69\u200D\uD83D\uDC66|\uD83D\uDE35\u200D\uD83D\uDCAB|\uD83D\uDE2E\u200D\uD83D\uDCA8|\uD83D\uDC15\u200D\uD83E\uDDBA|\uD83E\uDDD1(?:\uD83C\uDFFF|\uD83C\uDFFE|\uD83C\uDFFD|\uD83C\uDFFC|\uD83C\uDFFB)?|\uD83D\uDC69(?:\uD83C\uDFFF|\uD83C\uDFFE|\uD83C\uDFFD|\uD83C\uDFFC|\uD83C\uDFFB)?|\uD83C\uDDFD\uD83C\uDDF0|\uD83C\uDDF6\uD83C\uDDE6|\uD83C\uDDF4\uD83C\uDDF2|\uD83D\uDC08\u200D\u2B1B|\u2764\uFE0F\u200D(?:\uD83D\uDD25|\uD83E\uDE79)|\uD83D\uDC41\uFE0F|\uD83C\uDFF3\uFE0F|\uD83C\uDDFF(?:\uD83C[\uDDE6\uDDF2\uDDFC])|\uD83C\uDDFE(?:\uD83C[\uDDEA\uDDF9])|\uD83C\uDDFC(?:\uD83C[\uDDEB\uDDF8])|\uD83C\uDDFB(?:\uD83C[\uDDE6\uDDE8\uDDEA\uDDEC\uDDEE\uDDF3\uDDFA])|\uD83C\uDDFA(?:\uD83C[\uDDE6\uDDEC\uDDF2\uDDF3\uDDF8\uDDFE\uDDFF])|\uD83C\uDDF9(?:\uD83C[\uDDE6\uDDE8\uDDE9\uDDEB-\uDDED\uDDEF-\uDDF4\uDDF7\uDDF9\uDDFB\uDDFC\uDDFF])|\uD83C\uDDF8(?:\uD83C[\uDDE6-\uDDEA\uDDEC-\uDDF4\uDDF7-\uDDF9\uDDFB\uDDFD-\uDDFF])|\uD83C\uDDF7(?:\uD83C[\uDDEA\uDDF4\uDDF8\uDDFA\uDDFC])|\uD83C\uDDF5(?:\uD83C[\uDDE6\uDDEA-\uDDED\uDDF0-\uDDF3\uDDF7-\uDDF9\uDDFC\uDDFE])|\uD83C\uDDF3(?:\uD83C[\uDDE6\uDDE8\uDDEA-\uDDEC\uDDEE\uDDF1\uDDF4\uDDF5\uDDF7\uDDFA\uDDFF])|\uD83C\uDDF2(?:\uD83C[\uDDE6\uDDE8-\uDDED\uDDF0-\uDDFF])|\uD83C\uDDF1(?:\uD83C[\uDDE6-\uDDE8\uDDEE\uDDF0\uDDF7-\uDDFB\uDDFE])|\uD83C\uDDF0(?:\uD83C[\uDDEA\uDDEC-\uDDEE\uDDF2\uDDF3\uDDF5\uDDF7\uDDFC\uDDFE\uDDFF])|\uD83C\uDDEF(?:\uD83C[\uDDEA\uDDF2\uDDF4\uDDF5])|\uD83C\uDDEE(?:\uD83C[\uDDE8-\uDDEA\uDDF1-\uDDF4\uDDF6-\uDDF9])|\uD83C\uDDED(?:\uD83C[\uDDF0\uDDF2\uDDF3\uDDF7\uDDF9\uDDFA])|\uD83C\uDDEC(?:\uD83C[\uDDE6\uDDE7\uDDE9-\uDDEE\uDDF1-\uDDF3\uDDF5-\uDDFA\uDDFC\uDDFE])|\uD83C\uDDEB(?:\uD83C[\uDDEE-\uDDF0\uDDF2\uDDF4\uDDF7])|\uD83C\uDDEA(?:\uD83C[\uDDE6\uDDE8\uDDEA\uDDEC\uDDED\uDDF7-\uDDFA])|\uD83C\uDDE9(?:\uD83C[\uDDEA\uDDEC\uDDEF\uDDF0\uDDF2\uDDF4\uDDFF])|\uD83C\uDDE8(?:\uD83C[\uDDE6\uDDE8\uDDE9\uDDEB-\uDDEE\uDDF0-\uDDF5\uDDF7\uDDFA-\uDDFF])|\uD83C\uDDE7(?:\uD83C[\uDDE6\uDDE7\uDDE9-\uDDEF\uDDF1-\uDDF4\uDDF6-\uDDF9\uDDFB\uDDFC\uDDFE\uDDFF])|\uD83C\uDDE6(?:\uD83C[\uDDE8-\uDDEC\uDDEE\uDDF1\uDDF2\uDDF4\uDDF6-\uDDFA\uDDFC\uDDFD\uDDFF])|[#\*0-9]\uFE0F\u20E3|\u2764\uFE0F|(?:\uD83C[\uDFC3\uDFC4\uDFCA]|\uD83D[\uDC6E\uDC70\uDC71\uDC73\uDC77\uDC81\uDC82\uDC86\uDC87\uDE45-\uDE47\uDE4B\uDE4D\uDE4E\uDEA3\uDEB4-\uDEB6]|\uD83E[\uDD26\uDD35\uDD37-\uDD39\uDD3D\uDD3E\uDDB8\uDDB9\uDDCD-\uDDCF\uDDD4\uDDD6-\uDDDD])(?:\uD83C[\uDFFB-\uDFFF])|(?:\u26F9|\uD83C[\uDFCB\uDFCC]|\uD83D\uDD75)(?:\uFE0F|\uD83C[\uDFFB-\uDFFF])|\uD83C\uDFF4|(?:[\u270A\u270B]|\uD83C[\uDF85\uDFC2\uDFC7]|\uD83D[\uDC42\uDC43\uDC46-\uDC50\uDC66\uDC67\uDC6B-\uDC6D\uDC72\uDC74-\uDC76\uDC78\uDC7C\uDC83\uDC85\uDC8F\uDC91\uDCAA\uDD7A\uDD95\uDD96\uDE4C\uDE4F\uDEC0\uDECC]|\uD83E[\uDD0C\uDD0F\uDD18-\uDD1C\uDD1E\uDD1F\uDD30-\uDD34\uDD36\uDD77\uDDB5\uDDB6\uDDBB\uDDD2\uDDD3\uDDD5])(?:\uD83C[\uDFFB-\uDFFF])|(?:[\u261D\u270C\u270D]|\uD83D[\uDD74\uDD90])(?:\uFE0F|\uD83C[\uDFFB-\uDFFF])|[\u270A\u270B]|\uD83C[\uDF85\uDFC2\uDFC7]|\uD83D[\uDC08\uDC15\uDC3B\uDC42\uDC43\uDC46-\uDC50\uDC66\uDC67\uDC6B-\uDC6D\uDC72\uDC74-\uDC76\uDC78\uDC7C\uDC83\uDC85\uDC8F\uDC91\uDCAA\uDD7A\uDD95\uDD96\uDE2E\uDE35\uDE36\uDE4C\uDE4F\uDEC0\uDECC]|\uD83E[\uDD0C\uDD0F\uDD18-\uDD1C\uDD1E\uDD1F\uDD30-\uDD34\uDD36\uDD77\uDDB5\uDDB6\uDDBB\uDDD2\uDDD3\uDDD5]|\uD83C[\uDFC3\uDFC4\uDFCA]|\uD83D[\uDC6E\uDC70\uDC71\uDC73\uDC77\uDC81\uDC82\uDC86\uDC87\uDE45-\uDE47\uDE4B\uDE4D\uDE4E\uDEA3\uDEB4-\uDEB6]|\uD83E[\uDD26\uDD35\uDD37-\uDD39\uDD3D\uDD3E\uDDB8\uDDB9\uDDCD-\uDDCF\uDDD4\uDDD6-\uDDDD]|\uD83D\uDC6F|\uD83E[\uDD3C\uDDDE\uDDDF]|[\u231A\u231B\u23E9-\u23EC\u23F0\u23F3\u25FD\u25FE\u2614\u2615\u2648-\u2653\u267F\u2693\u26A1\u26AA\u26AB\u26BD\u26BE\u26C4\u26C5\u26CE\u26D4\u26EA\u26F2\u26F3\u26F5\u26FA\u26FD\u2705\u2728\u274C\u274E\u2753-\u2755\u2757\u2795-\u2797\u27B0\u27BF\u2B1B\u2B1C\u2B50\u2B55]|\uD83C[\uDC04\uDCCF\uDD8E\uDD91-\uDD9A\uDE01\uDE1A\uDE2F\uDE32-\uDE36\uDE38-\uDE3A\uDE50\uDE51\uDF00-\uDF20\uDF2D-\uDF35\uDF37-\uDF7C\uDF7E-\uDF84\uDF86-\uDF93\uDFA0-\uDFC1\uDFC5\uDFC6\uDFC8\uDFC9\uDFCF-\uDFD3\uDFE0-\uDFF0\uDFF8-\uDFFF]|\uD83D[\uDC00-\uDC07\uDC09-\uDC14\uDC16-\uDC3A\uDC3C-\uDC3E\uDC40\uDC44\uDC45\uDC51-\uDC65\uDC6A\uDC79-\uDC7B\uDC7D-\uDC80\uDC84\uDC88-\uDC8E\uDC90\uDC92-\uDCA9\uDCAB-\uDCFC\uDCFF-\uDD3D\uDD4B-\uDD4E\uDD50-\uDD67\uDDA4\uDDFB-\uDE2D\uDE2F-\uDE34\uDE37-\uDE44\uDE48-\uDE4A\uDE80-\uDEA2\uDEA4-\uDEB3\uDEB7-\uDEBF\uDEC1-\uDEC5\uDED0-\uDED2\uDED5-\uDED7\uDEEB\uDEEC\uDEF4-\uDEFC\uDFE0-\uDFEB]|\uD83E[\uDD0D\uDD0E\uDD10-\uDD17\uDD1D\uDD20-\uDD25\uDD27-\uDD2F\uDD3A\uDD3F-\uDD45\uDD47-\uDD76\uDD78\uDD7A-\uDDB4\uDDB7\uDDBA\uDDBC-\uDDCB\uDDD0\uDDE0-\uDDFF\uDE70-\uDE74\uDE78-\uDE7A\uDE80-\uDE86\uDE90-\uDEA8\uDEB0-\uDEB6\uDEC0-\uDEC2\uDED0-\uDED6]|(?:[\u231A\u231B\u23E9-\u23EC\u23F0\u23F3\u25FD\u25FE\u2614\u2615\u2648-\u2653\u267F\u2693\u26A1\u26AA\u26AB\u26BD\u26BE\u26C4\u26C5\u26CE\u26D4\u26EA\u26F2\u26F3\u26F5\u26FA\u26FD\u2705\u270A\u270B\u2728\u274C\u274E\u2753-\u2755\u2757\u2795-\u2797\u27B0\u27BF\u2B1B\u2B1C\u2B50\u2B55]|\uD83C[\uDC04\uDCCF\uDD8E\uDD91-\uDD9A\uDDE6-\uDDFF\uDE01\uDE1A\uDE2F\uDE32-\uDE36\uDE38-\uDE3A\uDE50\uDE51\uDF00-\uDF20\uDF2D-\uDF35\uDF37-\uDF7C\uDF7E-\uDF93\uDFA0-\uDFCA\uDFCF-\uDFD3\uDFE0-\uDFF0\uDFF4\uDFF8-\uDFFF]|\uD83D[\uDC00-\uDC3E\uDC40\uDC42-\uDCFC\uDCFF-\uDD3D\uDD4B-\uDD4E\uDD50-\uDD67\uDD7A\uDD95\uDD96\uDDA4\uDDFB-\uDE4F\uDE80-\uDEC5\uDECC\uDED0-\uDED2\uDED5-\uDED7\uDEEB\uDEEC\uDEF4-\uDEFC\uDFE0-\uDFEB]|\uD83E[\uDD0C-\uDD3A\uDD3C-\uDD45\uDD47-\uDD78\uDD7A-\uDDCB\uDDCD-\uDDFF\uDE70-\uDE74\uDE78-\uDE7A\uDE80-\uDE86\uDE90-\uDEA8\uDEB0-\uDEB6\uDEC0-\uDEC2\uDED0-\uDED6])|(?:[#\*0-9\xA9\xAE\u203C\u2049\u2122\u2139\u2194-\u2199\u21A9\u21AA\u231A\u231B\u2328\u23CF\u23E9-\u23F3\u23F8-\u23FA\u24C2\u25AA\u25AB\u25B6\u25C0\u25FB-\u25FE\u2600-\u2604\u260E\u2611\u2614\u2615\u2618\u261D\u2620\u2622\u2623\u2626\u262A\u262E\u262F\u2638-\u263A\u2640\u2642\u2648-\u2653\u265F\u2660\u2663\u2665\u2666\u2668\u267B\u267E\u267F\u2692-\u2697\u2699\u269B\u269C\u26A0\u26A1\u26A7\u26AA\u26AB\u26B0\u26B1\u26BD\u26BE\u26C4\u26C5\u26C8\u26CE\u26CF\u26D1\u26D3\u26D4\u26E9\u26EA\u26F0-\u26F5\u26F7-\u26FA\u26FD\u2702\u2705\u2708-\u270D\u270F\u2712\u2714\u2716\u271D\u2721\u2728\u2733\u2734\u2744\u2747\u274C\u274E\u2753-\u2755\u2757\u2763\u2764\u2795-\u2797\u27A1\u27B0\u27BF\u2934\u2935\u2B05-\u2B07\u2B1B\u2B1C\u2B50\u2B55\u3030\u303D\u3297\u3299]|\uD83C[\uDC04\uDCCF\uDD70\uDD71\uDD7E\uDD7F\uDD8E\uDD91-\uDD9A\uDDE6-\uDDFF\uDE01\uDE02\uDE1A\uDE2F\uDE32-\uDE3A\uDE50\uDE51\uDF00-\uDF21\uDF24-\uDF93\uDF96\uDF97\uDF99-\uDF9B\uDF9E-\uDFF0\uDFF3-\uDFF5\uDFF7-\uDFFF]|\uD83D[\uDC00-\uDCFD\uDCFF-\uDD3D\uDD49-\uDD4E\uDD50-\uDD67\uDD6F\uDD70\uDD73-\uDD7A\uDD87\uDD8A-\uDD8D\uDD90\uDD95\uDD96\uDDA4\uDDA5\uDDA8\uDDB1\uDDB2\uDDBC\uDDC2-\uDDC4\uDDD1-\uDDD3\uDDDC-\uDDDE\uDDE1\uDDE3\uDDE8\uDDEF\uDDF3\uDDFA-\uDE4F\uDE80-\uDEC5\uDECB-\uDED2\uDED5-\uDED7\uDEE0-\uDEE5\uDEE9\uDEEB\uDEEC\uDEF0\uDEF3-\uDEFC\uDFE0-\uDFEB]|\uD83E[\uDD0C-\uDD3A\uDD3C-\uDD45\uDD47-\uDD78\uDD7A-\uDDCB\uDDCD-\uDDFF\uDE70-\uDE74\uDE78-\uDE7A\uDE80-\uDE86\uDE90-\uDEA8\uDEB0-\uDEB6\uDEC0-\uDEC2\uDED0-\uDED6])\uFE0F|(?:[\u261D\u26F9\u270A-\u270D]|\uD83C[\uDF85\uDFC2-\uDFC4\uDFC7\uDFCA-\uDFCC]|\uD83D[\uDC42\uDC43\uDC46-\uDC50\uDC66-\uDC78\uDC7C\uDC81-\uDC83\uDC85-\uDC87\uDC8F\uDC91\uDCAA\uDD74\uDD75\uDD7A\uDD90\uDD95\uDD96\uDE45-\uDE47\uDE4B-\uDE4F\uDEA3\uDEB4-\uDEB6\uDEC0\uDECC]|\uD83E[\uDD0C\uDD0F\uDD18-\uDD1F\uDD26\uDD30-\uDD39\uDD3C-\uDD3E\uDD77\uDDB5\uDDB6\uDDB8\uDDB9\uDDBB\uDDCD-\uDDCF\uDDD1-\uDDDD])/g},ul=Oo(al);function nr(e,t={}){if(typeof e!="string"||e.length===0||(t={ambiguousIsNarrow:!0,...t},e=$o(e),e.length===0))return 0;e=e.replace(ul(),"  ");let n=t.ambiguousIsNarrow?1:2,r=0;for(let o of e){let s=o.codePointAt(0);if(!(s<=31||s>=127&&s<=159||s>=768&&s<=879))switch(sl.eastAsianWidth(o)){case"F":case"W":r+=2;break;case"A":r+=n;break;default:r+=1}}return r}var An=10,Ao=(e=0)=>t=>`\x1B[${t+e}m`,Po=(e=0)=>t=>`\x1B[${38+e};5;${t}m`,To=(e=0)=>(t,n,r)=>`\x1B[${38+e};2;${t};${n};${r}m`,H={modifier:{reset:[0,0],bold:[1,22],dim:[2,22],italic:[3,23],underline:[4,24],overline:[53,55],inverse:[7,27],hidden:[8,28],strikethrough:[9,29]},color:{black:[30,39],red:[31,39],green:[32,39],yellow:[33,39],blue:[34,39],magenta:[35,39],cyan:[36,39],white:[37,39],blackBright:[90,39],gray:[90,39],grey:[90,39],redBright:[91,39],greenBright:[92,39],yellowBright:[93,39],blueBright:[94,39],magentaBright:[95,39],cyanBright:[96,39],whiteBright:[97,39]},bgColor:{bgBlack:[40,49],bgRed:[41,49],bgGreen:[42,49],bgYellow:[43,49],bgBlue:[44,49],bgMagenta:[45,49],bgCyan:[46,49],bgWhite:[47,49],bgBlackBright:[100,49],bgGray:[100,49],bgGrey:[100,49],bgRedBright:[101,49],bgGreenBright:[102,49],bgYellowBright:[103,49],bgBlueBright:[104,49],bgMagentaBright:[105,49],bgCyanBright:[106,49],bgWhiteBright:[107,49]}};Object.keys(H.modifier);var ll=Object.keys(H.color),cl=Object.keys(H.bgColor);[...ll,...cl];function pl(){let e=new Map;for(let[t,n]of Object.entries(H)){for(let[r,o]of Object.entries(n))H[r]={open:`\x1B[${o[0]}m`,close:`\x1B[${o[1]}m`},n[r]=H[r],e.set(o[0],o[1]);Object.defineProperty(H,t,{value:n,enumerable:!1})}return Object.defineProperty(H,"codes",{value:e,enumerable:!1}),H.color.close="\x1B[39m",H.bgColor.close="\x1B[49m",H.color.ansi=Ao(),H.color.ansi256=Po(),H.color.ansi16m=To(),H.bgColor.ansi=Ao(An),H.bgColor.ansi256=Po(An),H.bgColor.ansi16m=To(An),Object.defineProperties(H,{rgbToAnsi256:{value:(t,n,r)=>t===n&&n===r?t<8?16:t>248?231:Math.round((t-8)/247*24)+232:16+36*Math.round(t/255*5)+6*Math.round(n/255*5)+Math.round(r/255*5),enumerable:!1},hexToRgb:{value:t=>{let n=/[a-f\d]{6}|[a-f\d]{3}/i.exec(t.toString(16));if(!n)return[0,0,0];let[r]=n;r.length===3&&(r=[...r].map(s=>s+s).join(""));let o=Number.parseInt(r,16);return[o>>16&255,o>>8&255,o&255]},enumerable:!1},hexToAnsi256:{value:t=>H.rgbToAnsi256(...H.hexToRgb(t)),enumerable:!1},ansi256ToAnsi:{value:t=>{if(t<8)return 30+t;if(t<16)return 90+(t-8);let n,r,o;if(t>=232)n=((t-232)*10+8)/255,r=n,o=n;else{t-=16;let a=t%36;n=Math.floor(t/36)/5,r=Math.floor(a/6)/5,o=a%6/5}let s=Math.max(n,r,o)*2;if(s===0)return 30;let i=30+(Math.round(o)<<2|Math.round(r)<<1|Math.round(n));return s===2&&(i+=60),i},enumerable:!1},rgbToAnsi:{value:(t,n,r)=>H.ansi256ToAnsi(H.rgbToAnsi256(t,n,r)),enumerable:!1},hexToAnsi:{value:t=>H.ansi256ToAnsi(H.hexToAnsi256(t)),enumerable:!1}}),H}var ml=pl(),Ur=new Set(["\x1B","\x9B"]),dl=39,Rn="\x07",_o="[",fl="]",jo="m",Bn=`${fl}8;;`,Io=e=>`${Ur.values().next().value}${_o}${e}${jo}`,Ro=e=>`${Ur.values().next().value}${Bn}${e}${Rn}`,gl=e=>e.split(" ").map(t=>nr(t)),Pn=(e,t,n)=>{let r=[...t],o=!1,s=!1,i=nr($o(e[e.length-1]));for(let[a,u]of r.entries()){let l=nr(u);if(i+l<=n?e[e.length-1]+=u:(e.push(u),i=0),Ur.has(u)&&(o=!0,s=r.slice(a+1).join("").startsWith(Bn)),o){s?u===Rn&&(o=!1,s=!1):u===jo&&(o=!1);continue}i+=l,i===n&&a<r.length-1&&(e.push(""),i=0)}!i&&e[e.length-1].length>0&&e.length>1&&(e[e.length-2]+=e.pop())},Dl=e=>{let t=e.split(" "),n=t.length;for(;n>0&&!(nr(t[n-1])>0);)n--;return n===t.length?e:t.slice(0,n).join(" ")+t.slice(n).join("")},hl=(e,t,n={})=>{if(n.trim!==!1&&e.trim()==="")return"";let r="",o,s,i=gl(e),a=[""];for(let[l,c]of e.split(" ").entries()){n.trim!==!1&&(a[a.length-1]=a[a.length-1].trimStart());let p=nr(a[a.length-1]);if(l!==0&&(p>=t&&(n.wordWrap===!1||n.trim===!1)&&(a.push(""),p=0),(p>0||n.trim===!1)&&(a[a.length-1]+=" ",p++)),n.hard&&i[l]>t){let m=t-p,D=1+Math.floor((i[l]-m-1)/t);Math.floor((i[l]-1)/t)<D&&a.push(""),Pn(a,c,t);continue}if(p+i[l]>t&&p>0&&i[l]>0){if(n.wordWrap===!1&&p<t){Pn(a,c,t);continue}a.push("")}if(p+i[l]>t&&n.wordWrap===!1){Pn(a,c,t);continue}a[a.length-1]+=c}n.trim!==!1&&(a=a.map(l=>Dl(l)));let u=[...a.join(`
`)];for(let[l,c]of u.entries()){if(r+=c,Ur.has(c)){let{groups:m}=new RegExp(`(?:\\${_o}(?<code>\\d+)m|\\${Bn}(?<uri>.*)${Rn})`).exec(u.slice(l).join(""))||{groups:{}};if(m.code!==void 0){let D=Number.parseFloat(m.code);o=D===dl?void 0:D}else m.uri!==void 0&&(s=m.uri.length===0?void 0:m.uri)}let p=ml.codes.get(Number(o));u[l+1]===`
`?(s&&(r+=Ro("")),o&&p&&(r+=Io(p))):c===`
`&&(o&&p&&(r+=Io(o)),s&&(r+=Ro(s)))}return r};function Bo(e,t,n){return String(e).normalize().replace(/\r\n/g,`
`).split(`
`).map(r=>hl(r,t,n)).join(`
`)}var Cl=["up","down","left","right","space","enter","cancel"],_r={actions:new Set(Cl),aliases:new Map([["k","up"],["j","down"],["h","left"],["l","right"],["","cancel"],["escape","cancel"]])};function Mo(e,t){if(typeof e=="string")return _r.aliases.get(e)===t;for(let n of e)if(n!==void 0&&Mo(n,t))return!0;return!1}function xl(e,t){if(e===t)return;let n=e.split(`
`),r=t.split(`
`),o=[];for(let s=0;s<Math.max(n.length,r.length);s++)n[s]!==r[s]&&o.push(s);return o}var yf=globalThis.process.platform.startsWith("win"),ko=Symbol("clack:cancel");function Lr(e,t){let n=e;n.isTTY&&n.setRawMode(t)}var yl=Object.defineProperty,El=(e,t,n)=>t in e?yl(e,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[t]=n,Ee=(e,t,n)=>(El(e,typeof t!="symbol"?t+"":t,n),n),In=class{constructor(t,n=!0){Ee(this,"input"),Ee(this,"output"),Ee(this,"_abortSignal"),Ee(this,"rl"),Ee(this,"opts"),Ee(this,"_render"),Ee(this,"_track",!1),Ee(this,"_prevFrame",""),Ee(this,"_subscribers",new Map),Ee(this,"_cursor",0),Ee(this,"state","initial"),Ee(this,"error",""),Ee(this,"value");let{input:r=Mr.stdin,output:o=Mr.stdout,render:s,signal:i,...a}=t;this.opts=a,this.onKeypress=this.onKeypress.bind(this),this.close=this.close.bind(this),this.render=this.render.bind(this),this._render=s.bind(this),this._track=n,this._abortSignal=i,this.input=r,this.output=o}unsubscribe(){this._subscribers.clear()}setSubscriber(t,n){let r=this._subscribers.get(t)??[];r.push(n),this._subscribers.set(t,r)}on(t,n){this.setSubscriber(t,{cb:n})}once(t,n){this.setSubscriber(t,{cb:n,once:!0})}emit(t,...n){let r=this._subscribers.get(t)??[],o=[];for(let s of r)s.cb(...n),s.once&&o.push(()=>r.splice(r.indexOf(s),1));for(let s of o)s()}prompt(){return new Promise((t,n)=>{if(this._abortSignal){if(this._abortSignal.aborted)return this.state="cancel",this.close(),t(ko);this._abortSignal.addEventListener("abort",()=>{this.state="cancel",this.close()},{once:!0})}let r=new No.Writable;r._write=(o,s,i)=>{this._track&&(this.value=this.rl?.line.replace(/\t/g,""),this._cursor=this.rl?.cursor??0,this.emit("value",this.value)),i()},this.input.pipe(r),this.rl=Tn.default.createInterface({input:this.input,output:r,tabSize:2,prompt:"",escapeCodeTimeout:50,terminal:!0}),Tn.default.emitKeypressEvents(this.input,this.rl),this.rl.prompt(),this.opts.initialValue!==void 0&&this._track&&this.rl.write(this.opts.initialValue),this.input.on("keypress",this.onKeypress),Lr(this.input,!0),this.output.on("resize",this.render),this.render(),this.once("submit",()=>{this.output.write(Fe.cursor.show),this.output.off("resize",this.render),Lr(this.input,!1),t(this.value)}),this.once("cancel",()=>{this.output.write(Fe.cursor.show),this.output.off("resize",this.render),Lr(this.input,!1),t(ko)})})}onKeypress(t,n){if(this.state==="error"&&(this.state="active"),n?.name&&(!this._track&&_r.aliases.has(n.name)&&this.emit("cursor",_r.aliases.get(n.name)),_r.actions.has(n.name)&&this.emit("cursor",n.name)),t&&(t.toLowerCase()==="y"||t.toLowerCase()==="n")&&this.emit("confirm",t.toLowerCase()==="y"),t==="	"&&this.opts.placeholder&&(this.value||(this.rl?.write(this.opts.placeholder),this.emit("value",this.opts.placeholder))),t&&this.emit("key",t.toLowerCase()),n?.name==="return"){if(!this.value&&this.opts.placeholder&&(this.rl?.write(this.opts.placeholder),this.emit("value",this.opts.placeholder)),this.opts.validate){let r=this.opts.validate(this.value);r&&(this.error=r instanceof Error?r.message:r,this.state="error",this.rl?.write(this.value))}this.state!=="error"&&(this.state="submit")}Mo([t,n?.name,n?.sequence],"cancel")&&(this.state="cancel"),(this.state==="submit"||this.state==="cancel")&&this.emit("finalize"),this.render(),(this.state==="submit"||this.state==="cancel")&&this.close()}close(){this.input.unpipe(),this.input.removeListener("keypress",this.onKeypress),this.output.write(`
`),Lr(this.input,!1),this.rl?.close(),this.rl=void 0,this.emit(`${this.state}`,this.value),this.unsubscribe()}restoreCursor(){let t=Bo(this._prevFrame,process.stdout.columns,{hard:!0}).split(`
`).length-1;this.output.write(Fe.cursor.move(-999,t*-1))}render(){let t=Bo(this._render(this)??"",process.stdout.columns,{hard:!0});if(t!==this._prevFrame){if(this.state==="initial")this.output.write(Fe.cursor.hide);else{let n=xl(this._prevFrame,t);if(this.restoreCursor(),n&&n?.length===1){let r=n[0];this.output.write(Fe.cursor.move(0,r)),this.output.write(Fe.erase.lines(1));let o=t.split(`
`);this.output.write(o[r]),this._prevFrame=t,this.output.write(Fe.cursor.move(0,o.length-r-1));return}if(n&&n?.length>1){let r=n[0];this.output.write(Fe.cursor.move(0,r)),this.output.write(Fe.erase.down());let o=t.split(`
`).slice(r);this.output.write(o.join(`
`)),this._prevFrame=t;return}this.output.write(Fe.erase.down())}this.output.write(t),this.state==="initial"&&(this.state="active"),this._prevFrame=t}}},jr=class extends In{get cursor(){return this.value?0:1}get _value(){return this.cursor===0}constructor(t){super(t,!1),this.value=!!t.initialValue,this.on("value",()=>{this.value=this._value}),this.on("confirm",n=>{this.output.write(Fe.cursor.move(0,-1)),this.value=n,this.state="submit",this.close()}),this.on("cursor",()=>{this.value=!this.value})}};var Fl;Fl=new WeakMap;var ve=T(require("process"),1),$=T(et(),1),Ko=T(Nr(),1);function wl(){return ve.default.platform!=="win32"?ve.default.env.TERM!=="linux":!!ve.default.env.CI||!!ve.default.env.WT_SESSION||!!ve.default.env.TERMINUS_SUBLIME||ve.default.env.ConEmuTask==="{cmd::Cmder}"||ve.default.env.TERM_PROGRAM==="Terminus-Sublime"||ve.default.env.TERM_PROGRAM==="vscode"||ve.default.env.TERM==="xterm-256color"||ve.default.env.TERM==="alacritty"||ve.default.env.TERMINAL_EMULATOR==="JetBrains-JediTerm"}var bl=wl(),Q=(e,t)=>bl?e:t,Sl=Q("\u25C6","*"),vl=Q("\u25A0","x"),Al=Q("\u25B2","x"),zo=Q("\u25C7","o"),Pl=Q("\u250C","T"),Le=Q("\u2502","|"),Go=Q("\u2514","\u2014"),Uo=Q("\u25CF",">"),Vo=Q("\u25CB"," "),Rf=Q("\u25FB","[\u2022]"),Bf=Q("\u25FC","[+]"),kf=Q("\u25FB","[ ]"),Nf=Q("\u25AA","\u2022"),$f=Q("\u2500","-"),Of=Q("\u256E","+"),Lf=Q("\u251C","+"),_f=Q("\u256F","+"),Tl=Q("\u25CF","\u2022"),Il=Q("\u25C6","*"),Rl=Q("\u25B2","!"),Bl=Q("\u25A0","x"),kl=e=>{switch(e){case"initial":case"active":return $.default.cyan(Sl);case"cancel":return $.default.red(vl);case"error":return $.default.yellow(Al);case"submit":return $.default.green(zo)}};var or=e=>{let t=e.active??"Yes",n=e.inactive??"No";return new jr({active:t,inactive:n,initialValue:e.initialValue??!0,render(){let r=`${$.default.gray(Le)}
${kl(this.state)}  ${e.message}
`,o=this.value?t:n;switch(this.state){case"submit":return`${r}${$.default.gray(Le)}  ${$.default.dim(o)}`;case"cancel":return`${r}${$.default.gray(Le)}  ${$.default.strikethrough($.default.dim(o))}
${$.default.gray(Le)}`;default:return`${r}${$.default.cyan(Le)}  ${this.value?`${$.default.green(Uo)} ${t}`:`${$.default.dim(Vo)} ${$.default.dim(t)}`} ${$.default.dim("/")} ${this.value?`${$.default.dim(Vo)} ${$.default.dim(n)}`:`${$.default.green(Uo)} ${n}`}
${$.default.cyan(Go)}
`}}}).prompt()};var tt=(e="")=>{process.stdout.write(`${$.default.gray(Pl)}  ${e}
`)},sr=(e="")=>{process.stdout.write(`${$.default.gray(Le)}
${$.default.gray(Go)}  ${e}

`)},M={message:(e="",{symbol:t=$.default.gray(Le)}={})=>{let n=[`${$.default.gray(Le)}`];if(e){let[r,...o]=e.split(`
`);n.push(`${t}  ${r}`,...o.map(s=>`${$.default.gray(Le)}  ${s}`))}process.stdout.write(`${n.join(`
`)}
`)},info:e=>{M.message(e,{symbol:$.default.blue(Tl)})},success:e=>{M.message(e,{symbol:$.default.green(Il)})},step:e=>{M.message(e,{symbol:$.default.green(zo)})},warn:e=>{M.message(e,{symbol:$.default.yellow(Rl)})},warning:e=>{M.warn(e)},error:e=>{M.message(e,{symbol:$.default.red(Bl)})}},jf=`${$.default.gray(Le)}  `;var yt=T(et(),1);var L=T(require("typescript"),1);async function _e(e){let t=Wo(e),n=await e.readFile(t);return typeof n=="string"?JSON.parse(n):{}}async function je(e,t){t=typeof t=="object"&&t!=null?t:{};let n=Wo(e);await e.writeFile(n,JSON.stringify(t??{},null,2))}function Wo(e){let t=e.getAppRootDir();return e.join(t,"node_modules",".builder","builder-cache.json")}async function pt(e,t,n){let r={envKey:n,envValue:null,file:""};for(let o of t){let s=e.join(e.getAppRootDir(),o),i=await Nl(e,s);if(i){let a=i[n];if(typeof a=="string"&&a.length>0&&a!=="YOUR_API_KEY")return r.envValue=a,r.file=s,r}}return r.file=e.join(e.getAppRootDir(),t[t.length-1]),r}async function Nl(e,t){let n=await e.readFile(t);return typeof n=="string"?qo(n):null}function qo(e){let t={},n=e.replace(/\r\n?/gm,`
`),r;for(;(r=$l.exec(n))!=null;){let o=r[1],s=r[2]||"";s=s.trim();let i=s[0];s=s.replace(/^(['"`])([\s\S]*)\1$/gm,"$2"),i==='"'&&(s=s.replace(/\\n/g,`
`),s=s.replace(/\\r/g,"\r")),t[o]=s}return t}var $l=/(?:^|^)\s*(?:export\s+)?([\w.-]+)(?:\s*=\s*?|:\s+?)(\s*'(?:\\'|[^'])*'|\s*"(?:\\"|[^"])*"|\s*`(?:\\`|[^`])*`|[^#\r\n]+)?\s*(?:#.*)?(?:$|$)/gm;async function mt(e,t,n,r){let o="# https://www.builder.io/c/docs/using-your-api-key",s=await e.readFile(t);try{if(s)if(s.includes(n))if(s.includes(r))e.debug(`"${n}" with "${r}" already set in ${t}`);else return e.debug(`Replace "${n}" in ${t}`),s=s.replace(new RegExp(`${n}=.*`),`${n}=${r}`),await e.writeFile(t,s),"update";else return e.debug(`Append "${n}" to ${t}`),s+=`

${o}
${n}=${r}

`,await e.writeFile(t,s),"update";else return e.debug(`Creating new .env file with "${n}" at ${t}`),s=[o,`${n}=${r}`,""].join(`
`),await e.writeFile(t,s),"create"}catch(i){if(i&&String(i).includes("EACCES"))return e.debug(`Permssion denied, failed to create or modify .env file with "${n}=${r}" at ${t}`),"permission-error";e.Sentry?.captureException(i)}return null}async function ar(e){return await pt(e,[".env.local",".env.development.local",".env.production.local",".env.development",".env.production",".env"],Me)}async function Jo(e,t){let n=await ar(e),r=await mt(e,n.file,n.envKey,t);return{...n,modifiedType:r}}var Me="NEXT_PUBLIC_BUILDER_API_KEY";function jt(e,t,n,r,o=!0){let s=t.properties.filter(a=>e.ts.isPropertyAssignment(a)),i=Ol(e,t,n);return i>-1?r==null&&o?e.ts.factory.updateObjectLiteralExpression(t,s.filter((a,u)=>u!==i)):(s[i]=e.ts.factory.updatePropertyAssignment(s[i],s[i].name,ur(e,r)),e.ts.factory.updateObjectLiteralExpression(t,s)):(r!=null&&s.push(e.ts.factory.createPropertyAssignment(n,ur(e,r))),e.ts.factory.updateObjectLiteralExpression(t,s))}function Ol(e,t,n){return t.properties.findIndex(r=>K(e,r)===n)}function lr(e,t){switch(t.kind){case e.ts.SyntaxKind.ArrayLiteralExpression:return _l(e,t);case e.ts.SyntaxKind.ObjectLiteralExpression:return Ll(e,t);case e.ts.SyntaxKind.StringLiteral:return t.text;case e.ts.SyntaxKind.NumericLiteral:return Number(t.text);case e.ts.SyntaxKind.NoSubstitutionTemplateLiteral:return t.text;case e.ts.SyntaxKind.TrueKeyword:return!0;case e.ts.SyntaxKind.FalseKeyword:return!1;case e.ts.SyntaxKind.Identifier:switch(t.escapedText){case"undefined":return;case"null":return null;case"String":return String;case"Number":return Number;case"Boolean":return Boolean;case"NaN":return NaN}}}function Ll(e,t){let n={};if(t&&e.ts.isObjectLiteralExpression(t)){for(let r of t.properties)if(e.ts.isPropertyAssignment(r)){let o=K(e,r);o&&(n[o]=lr(e,r.initializer))}}return n}function _l(e,t){return t&&e.ts.isArrayLiteralExpression(t)?t.elements.map(n=>lr(e,n)):[]}function K(e,t){if(t&&e.ts.isPropertyAssignment(t)){let n=t.name;switch(n.kind){case e.ts.SyntaxKind.Identifier:return n.text;case e.ts.SyntaxKind.StringLiteral:case e.ts.SyntaxKind.NumericLiteral:return n.text;case e.ts.SyntaxKind.ComputedPropertyName:let r=n.expression;if(e.ts.isStringLiteral(r)||e.ts.isNumericLiteral(r))return n.expression.text}}}function ur(e,t){return kn(e,t,new WeakSet)}function kn(e,t,n){return t===void 0?e.ts.factory.createIdentifier("undefined"):t===null?e.ts.factory.createIdentifier("null"):typeof t=="string"?e.ts.factory.createStringLiteral(t):typeof t=="number"?isNaN(t)?e.ts.factory.createIdentifier("NaN"):e.ts.factory.createNumericLiteral(t):t===!0?e.ts.factory.createTrue():t===!1?e.ts.factory.createFalse():t===String?e.ts.factory.createIdentifier("String"):t===Number?e.ts.factory.createIdentifier("Number"):t===Boolean?e.ts.factory.createIdentifier("Boolean"):Array.isArray(t)?jl(e,t,n):typeof t=="object"?Ml(e,t,n):e.ts.factory.createIdentifier(t)}function jl(e,t,n){let r=t.map(o=>kn(e,o,n));return e.ts.factory.createArrayLiteralExpression(r,!0)}function Ml(e,t,n){if(n.has(t))return e.ts.factory.createIdentifier("undefined");n.add(t);let r=Object.keys(t).map(o=>e.ts.factory.createPropertyAssignment(o,kn(e,t[o],n)));return e.ts.factory.createObjectLiteralExpression(r,!0)}function St(e,t,n){let r=[];if(!n)return r;let o=null;if(e.ts.isArrowFunction(n)||e.ts.isFunctionExpression(n)||e.ts.isFunctionDeclaration(n)){let s=n.parameters;if(s.length>0){let i=s[0],a=t.getTypeAtLocation(i);a.aliasTypeArguments&&a.aliasTypeArguments.length>0&&(a=a.aliasTypeArguments[0]),!!(a.flags&e.ts.TypeFlags.Object)&&(o=a.getProperties())}}else if(e.ts.isIdentifier(n)){let s=t.getTypeAtLocation(n),i=s.symbol?.valueDeclaration;if(i&&e.ts.isClassDeclaration(i)){let u=i.heritageClauses?.find(l=>l.token===e.ts.SyntaxKind.ExtendsKeyword)?.types;if(u){for(let l of u)if(t.getSymbolAtLocation(l.expression)?.name==="Component"){if(e.ts.isExpressionWithTypeArguments(l)){let p=l.typeArguments;if(p){let m=p[0];o=t.getTypeFromTypeNode(m).getProperties()}}break}}}if(!o){let a=s.getCallSignatures();if(a.length>0){let u=a[0].getParameters();u.length>0&&(o=t.getTypeOfSymbolAtLocation(u[0],n).getProperties())}}}else if(e.ts.isExportSpecifier(n)){let s=t.getSymbolAtLocation(n.name);if(s){let a=t.getTypeOfSymbolAtLocation(s,n).getCallSignatures();if(a.length>0){let u=a[0].getParameters();u.length>0&&(o=t.getTypeOfSymbolAtLocation(u[0],n).getProperties())}}}if(o)for(let s of o){let i=Ul(e,t,s);i&&r.push(i)}return r=r.filter(Yo),r.length>0?r:Vl(e,n)}function Ul(e,t,n){let r=n.valueDeclaration,o=n.getName();if(r||(r=n.getDeclarations()?.[0]),r&&e.ts.isPropertySignature(r)){if(o!=="children"&&r.getSourceFile().fileName.includes("node_modules/@types/"))return null;let s="string",i;if(r?.type){let u=t.getTypeFromTypeNode(r.type),l=t.typeToString(u),c=Nn(l);c.knownType?s=c.builderType:zl(l)||u.flags&e.ts.TypeFlags.StringLike?s="string":u.flags&e.ts.TypeFlags.NumberLike?s="number":u.flags&e.ts.TypeFlags.IndexedAccess?s="list":u.flags&e.ts.TypeFlags.Object||u.isUnion()&&u.types.every(p=>p.flags&e.ts.TypeFlags.Object)||u.isIntersection()&&u.types.some(p=>p.flags&e.ts.TypeFlags.Object)?s="object":s="string",l!==s&&(i=l)}let a={name:o,type:s,isRegistered:!1};if(i&&r.type){let u=Jl(e,t,t.getTypeFromTypeNode(r.type));a.meta=a.meta||{},u&&u.length>0&&a.type==="string"&&u.every(Wl)?a.enum=u.map(ql):a.meta.ts=i}return r.questionToken||(a.required=!0),a}return null}function Vl(e,t){let n=[],r=e.ts.getJSDocCommentsAndTags(t);for(let o of r)if(!(!e.ts.isJSDoc(o)||!o.tags))for(let s of o.tags){if(!e.ts.isJSDocParameterTag(s)||s.tagName.text!=="param")continue;let a=s.typeExpression?.type;if(!a||!e.ts.isJSDocTypeLiteral(a))continue;let u=a.jsDocPropertyTags;if(u)for(let l of u){if(!e.ts.isJSDocPropertyLikeTag(l))continue;let c=l.name;if(!e.ts.isQualifiedName(c))continue;let p=l.typeExpression;if(!p)continue;let m="";switch(p.type.kind){case e.ts.SyntaxKind.StringKeyword:{m="string";break}case e.ts.SyntaxKind.NumberKeyword:{m="number";break}case e.ts.SyntaxKind.BooleanKeyword:{m="boolean";break}default:continue}let g={name:c.right.text,type:m,isRegistered:!1};n.push(g)}}return n.filter(Yo)}var Kl=["ClassicComponent","FunctionComponent","IntrinsicElements","JSX","ReactNode","ReactElement","ReactPortal"];function zl(e){return typeof e!="string"?!1:!!Kl.some(t=>e.includes(t))}function Nn(e){return typeof e=="string"&&(e=e.trim(),Gl.some(t=>t.value===e))?{builderType:e,knownType:!0}:{builderType:"string",knownType:!1}}var Gl=[{value:"boolean",text:"boolean"},{value:"color",text:"color (provides a color in hex or rgb)"},{value:"date",text:"date (same format as the Date constructor)"},{value:"email",text:"email"},{value:"file",text:"file (uploads a file and provides a url)"},{value:"list",text:"list (collection of items)"},{value:"longText",text:"longText (multiline text editor)"},{value:"number",text:"number"},{value:"object",text:"object (set of specific names and values)"},{value:"richText",text:"richText (provides value as html)"},{value:"string",text:"string"}];function Wl(e){return/^['"].*['"]$/.test(e)}function ql(e){return(e.startsWith('"')||e.startsWith("'"))&&(e.endsWith('"')||e.endsWith("'"))?e.slice(1,-1):e}var Jl=(e,t,n)=>{let r=new Set;Ho(e,t,n,r);let o=r.delete("true"),s=r.delete("false");(o||s)&&r.add("boolean");let i=Array.from(r.keys()).sort();if(i.length>1&&(i=i.map(a=>a.indexOf("=>")>=0?`(${a})`:a)),!(i.length>20))return i},Hl=(e,t,n)=>{let r=e.ts.TypeFormatFlags.InElementType|e.ts.TypeFormatFlags.NoTruncation;return t.typeToString(n,void 0,r)},Ho=(e,t,n,r)=>{if(n.isUnion())n.types.forEach(o=>{Ho(e,t,o,r)});else if(n.isLiteral()){let o=Hl(e,t,n);r.add(o)}};function Yo(e){let t=e?.name;if(typeof t!="string"||t===""||t.startsWith("aria")||t.startsWith("data-"))return!1;if(t.startsWith("on")&&t.length>2){let n=t.charAt(2);if(n.toUpperCase()===n)return!1}return!Yl.has(t.toLowerCase())}var Yl=new Set(["about","accessKey","accessKeyLabel","asChild","autoCapitalize","autoCorrect","autoFocus","autoSave","blur","contentEditable","contextMenu","dangerouslySetInnerHTML","datatype","defaultChecked","defaultValue","dir","draggable","enterKeyHint","focus","form","formAction","formEncType","formMethod","formNoValidate","formTarget","inlist","innerText","inputMode","is","isContentEditable","itemID","itemProp","itemRef","itemScope","itemType","lang","nonce","offsetHeight","offsetLeft","offsetTop","offsetWidth","outerText","prefix","property","radioGroup","rel","resource","results","rev","role","security","slot","spellCheck","suppressContentEditableWarning","suppressHydrationWarning","tabIndex","translate","typeof","unselectable","vocab"].map(e=>e.toLowerCase()));function ge(e,t,n){for(let r of n.properties){if(!e.ts.isPropertyAssignment(r))continue;let o=K(e,r);if(o==="name"&&e.ts.isStringLiteral(r.initializer)){t.name=r.initializer.text;continue}if(o==="description"&&e.ts.isStringLiteral(r.initializer)){t.description=r.initializer.text;continue}if(o==="image"&&e.ts.isStringLiteral(r.initializer)){t.image=r.initializer.text;continue}if(o==="inputs"&&e.ts.isArrayLiteralExpression(r.initializer)){let s=Ql(e,r.initializer);we(t,s);continue}if(o==="meta"&&e.ts.isObjectLiteralExpression(r.initializer)){let s=lr(e,r.initializer);s&&typeof s=="object"&&(t.meta=s);continue}}return t}function Ql(e,t){let n=[];for(let r of t.elements)e.ts.isObjectLiteralExpression(r)&&n.push(Xl(e,r));return n}function Xl(e,t){let n=lr(e,t),r=oc(n);return r.isRegistered=!0,r}function ee(e,t,n){let r=ec(n);return t=jt(e,t,"name",r.name,!1),t=jt(e,t,"description",r.description),t=jt(e,t,"image",r.image),t=jt(e,t,"meta",r.meta),t=Zl(e,t,r),sc(e,t)}function Zl(e,t,n){let r=null,o=t.properties.filter(a=>e.ts.isPropertyAssignment(a)&&e.ts.isIdentifier(a.name)),s=o.findIndex(a=>e.ts.isIdentifier(a.name)&&a.name.text==="inputs"),i=[...n.inputs??[]];if(s>-1){if(i.length===0)return jt(e,t,"inputs",null);let a=o[s];e.ts.isPropertyAssignment(a)&&e.ts.isArrayLiteralExpression(a.initializer)&&(r=a.initializer)}return i.length===0?t:(r=rc(e,r||e.ts.factory.createArrayLiteralExpression(),i),s>-1?o[s]=e.ts.factory.updatePropertyAssignment(o[s],o[s].name,r):o.push(e.ts.factory.createPropertyAssignment("inputs",r)),e.ts.factory.updateObjectLiteralExpression(t,o))}function ec(e){return{name:e.name,description:e.description,image:e.image,inputs:(e.inputs||[]).filter(n=>n.isRegistered).map(tc),...e.meta?{meta:{...e.meta}}:{}}}function tc(e){let t={name:e.name,type:e.type};return(me(e.defaultValue)||Zt(e.defaultValue)||Bt(e.defaultValue))&&(t.defaultValue=e.defaultValue),me(e.friendlyName)&&(t.friendlyName=e.friendlyName),me(e.helperText)&&(t.helperText=e.helperText),e.required===!0&&(t.required=!0),Array.isArray(e.enum)&&(t.enum=e.enum),e.hideFromUI===!0&&(t.hideFromUI=!0),typeof e.meta=="object"&&e.meta!=null&&Object.keys(e.meta).length>0&&(t.meta=e.meta),t}function rc(e,t,n){let r=t.elements.filter(o=>{if(!e.ts.isObjectLiteralExpression(o))return!1;let s=o.properties.find(a=>K(e,a)==="name");if(!s)return!1;let i=s.initializer;return e.ts.isStringLiteral(i)?n.some(a=>a.name===i.text):!1});for(let o of n)r=nc(e,r,o);return r.sort((o,s)=>{let i=o.properties.find(m=>K(e,m)==="name"),a=s.properties.find(m=>K(e,m)==="name"),u=i?.initializer,l=a?.initializer,c=u&&e.ts.isStringLiteral(u)?u.text:"zz",p=l&&e.ts.isStringLiteral(l)?l.text:"zz";return c.toLowerCase().localeCompare(p.toLowerCase())}),e.ts.factory.updateArrayLiteralExpression(t,r)}function nc(e,t,n){let r=t.findIndex(o=>o.properties.some(s=>{let i=K(e,s);return e.ts.isPropertyAssignment(s)&&i==="name"&&e.ts.isStringLiteral(s.initializer)&&s.initializer.text===n.name}));if(r>-1)t[r]=Qo(e,t[r],n);else{let o=Qo(e,e.ts.factory.createObjectLiteralExpression([e.ts.factory.createPropertyAssignment("name",e.ts.factory.createStringLiteral(n.name))],!0),n);t.push(o)}return t}function Qo(e,t,n){let r=t.properties.filter(s=>e.ts.isPropertyAssignment(s)),o=Object.keys(n).filter(s=>s!=="isRegistered");for(let s of o)r=ic(e,r,n,s);return r=ac(e,r.filter(s=>{let i=K(e,s);return o.includes(i)})),e.ts.factory.updateObjectLiteralExpression(t,r)}function ic(e,t,n,r){let o=t.findIndex(s=>e.ts.isIdentifier(s.name)&&s.name.text===r);return o>-1?t[o]=e.ts.factory.updatePropertyAssignment(t[o],t[o].name,ur(e,n[r])):t.push(e.ts.factory.createPropertyAssignment(r,ur(e,n[r]))),t}function we(e,t){for(let n of t){let r=e.inputs.findIndex(o=>o.name===n.name);r>-1?(n.isRegistered||!e.inputs[r].isRegistered)&&(e.inputs[r]=n):e.inputs.push(n)}e.acceptsChildren=$n(e)}function oc(e){let t=Nn(e.type),n={name:e.name.trim(),type:t.builderType};return me(e.friendlyName)&&e.friendlyName.trim()!==e.name.trim()&&(n.friendlyName=e.friendlyName),(me(e.defaultValue)||Zt(e.defaultValue)||Bt(e.defaultValue))&&(n.defaultValue=e.defaultValue),me(e.helperText)&&(n.helperText=e.helperText),Bt(e.required)&&(n.required=e.required),typeof e.meta=="object"&&e.meta!=null&&Object.keys(e.meta).length>0&&(n.meta=e.meta),Array.isArray(e.enum)&&e.enum.length>0&&(n.enum=e.enum),e.hideFromUI===!0&&(n.hideFromUI=!0),On(n)}function $n(e){let t=e.inputs.some(r=>r.name==="children"),n=e.inputs.some(r=>r.meta?.ts==="ReactNode");return!!(t||n||e.acceptsChildren===!0)}function On(e){if(e.name==="children"&&(e.hideFromUI=!0,delete e.required),e.type==="object"&&e.defaultValue==null&&(e.hideFromUI=!0),e.type==="list"&&e.defaultValue==null&&(e.hideFromUI=!0),e.meta){let t=e.meta.ts;typeof t=="string"&&(t=t.trim(),t.endsWith("ReactNode")&&(t="ReactNode"),e.meta.ts=t,t==="ReactNode"&&(e.hideFromUI=!0))}return e}function sc(e,t){let n=[...t.properties].sort((r,o)=>{let s=K(e,r)||"zz",i=K(e,o)||"zz";if(s==="inputs")return 1;let a=Xo.indexOf(s),u=Xo.indexOf(i);return a>-1?u>-1&&a>u?1:-1:u>-1?a>-1&&u<a?-1:1:s.localeCompare(i)});return e.ts.factory.updateObjectLiteralExpression(t,n)}var Xo=["component","name","description"];function ac(e,t){return[...t].sort((r,o)=>{let s=K(e,r)||"zz",i=K(e,o)||"zz",a=Zo.indexOf(s),u=Zo.indexOf(i);return a>-1?u>-1&&a>u?1:-1:u>-1?a>-1&&u<a?-1:1:s.localeCompare(i)})}var Zo=["name","type"];function Mt(e,t){for(let n of t.properties){if(!e.ts.isPropertyAssignment(n)||!e.ts.isIdentifier(n.name))continue;if(K(e,n)==="canHaveChildren"){let{initializer:o}=n;return o.kind===e.ts.SyntaxKind.TrueKeyword}}return!1}function es(e,t){let n=`Builder.registerComponent(
`;if(e.appDir)t.acceptsChildren?n+=`  withChildren(${t.importName}),
`:n+=`  ${t.importName},
`;else{let o=t.externalImportPath?t.externalImportPath:_(e,e.registryPath,t.filePath);t.exportName==="default"?t.acceptsChildren?n+=`  withChildren(dynamic(() => import(${JSON.stringify(o)}))),
`:n+=`  dynamic(() => import(${JSON.stringify(o)})),
`:t.acceptsChildren?n+=`  withChildren(dynamic(async () => (await import(${JSON.stringify(o)})).${t.exportName})),
`:n+=`  dynamic(async () => (await import(${JSON.stringify(o)})).${t.exportName}),
`}n+=`  {
    name: "${t.name}",
  }
`,n+=");";let r=Ir(e,n);return Ln(e,r,t)}function Ln(e,t,n){if(!e.ts.isExpressionStatement(t))return t;let r=t.expression;if(!e.ts.isCallExpression(r))return t;let o=[...r.arguments];if(o.length<2)return t;n.acceptsChildren?e.ts.isCallExpression(o[0])&&e.ts.isIdentifier(o[0].expression)&&o[0].expression.text==="withChildren"||(o[0]=e.ts.factory.createCallExpression(e.ts.factory.createIdentifier("withChildren"),void 0,[o[0]])):e.ts.isCallExpression(o[0])&&e.ts.isIdentifier(o[0].expression)&&o[0].expression.text==="withChildren"&&(o[0]=o[0].arguments[0]);let s=o[1];return e.ts.isObjectLiteralExpression(s)?(o[1]=ee(e,s,n),e.ts.factory.updateExpressionStatement(t,e.ts.factory.updateCallExpression(r,r.expression,r.typeArguments,o))):t}function O(e,t,n,r="esm"){return Array.isArray(n.namedImports)&&n.namedImports.forEach(o=>{t=uc(e,t,o,n.importPath,!!n.isTypeOnly,r)}),typeof n.defaultImport=="string"&&(t=lc(e,t,n.defaultImport,n.importPath,r)),t}function uc(e,t,n,r,o,s){return s==="cjs"?rs(e,t,null,n,r):ts(e,t,null,n,r,o)}function lc(e,t,n,r,o){return o==="cjs"?rs(e,t,n,null,r):ts(e,t,n,null,r,!1)}function ts(e,t,n,r,o,s){let i=[...t.statements],a=0,u=!1,l=!1;for(let D=0;D<i.length;D++){let g=i[D];if(!e.ts.isImportDeclaration(g)||(a=D,!g.moduleSpecifier||!e.ts.isStringLiteral(g.moduleSpecifier))||g.moduleSpecifier.text!==o||!!g.importClause?.isTypeOnly!==s)continue;let f=[],h=g.importClause?.namedBindings;if(h&&e.ts.isNamedImports(h)&&h.elements&&f.push(...h.elements),typeof r=="string"){if(f.some(y=>y.name.text===r))return t;f.push(e.ts.factory.createImportSpecifier(!1,void 0,e.ts.factory.createIdentifier(r))),f.sort((y,F)=>y.name.text.localeCompare(F.name.text)),u=!0}let d=g.importClause?g.importClause.name:void 0;if(typeof n=="string"){if(d&&d.text===n)return t;d=e.ts.factory.createIdentifier(n),l=!0}if(u||l)return i[D]=e.ts.factory.updateImportDeclaration(g,void 0,e.ts.factory.createImportClause(s,d,e.ts.factory.createNamedImports(f)),g.moduleSpecifier,void 0),e.ts.factory.updateSourceFile(t,i)}let c,p;typeof n=="string"&&(c=e.ts.factory.createIdentifier(n)),typeof r=="string"&&(p=e.ts.factory.createNamedImports([e.ts.factory.createImportSpecifier(!1,void 0,e.ts.factory.createIdentifier(r))]));let m=e.ts.factory.createImportDeclaration(void 0,e.ts.factory.createImportClause(s,c,p),e.ts.factory.createStringLiteral(o));return i.splice(a,0,m),e.ts.factory.updateSourceFile(t,i)}function rs(e,t,n,r,o){let s=[...t.statements],i=0;for(let a=0;a<s.length;a++){let u=s[a];if(e.ts.isVariableStatement(u))for(let l=0;l<u.declarationList.declarations.length;l++){let c=[...u.declarationList.declarations],p=c[l],m=p.initializer;if(!m||!e.ts.isCallExpression(m))continue;let D=m.expression;if(!e.ts.isIdentifier(D)||D.text!=="require"||m.arguments.length!==1)continue;let g=m.arguments[0];if(e.ts.isStringLiteral(g)&&(i=a,g.text===o)){if(e.ts.isIdentifier(p.name)&&typeof n=="string")return p.name.text===n?t:(c[l]=e.ts.factory.updateVariableDeclaration(p,e.ts.factory.createIdentifier(n),p.exclamationToken,p.type,p.initializer),s[a]=e.ts.factory.updateVariableStatement(u,u.modifiers,e.ts.factory.updateVariableDeclarationList(u.declarationList,c)),e.ts.factory.updateSourceFile(t,s));if(e.ts.isObjectBindingPattern(p.name)&&typeof r=="string"){let f=[...p.name.elements];return f.some(d=>!e.ts.isBindingElement(d)||!e.ts.isIdentifier(d.name)?!1:d.name.text===r)?t:(f.push(e.ts.factory.createBindingElement(void 0,void 0,r)),f.sort((d,y)=>!e.ts.isBindingElement(d)||!e.ts.isIdentifier(d.name)||!e.ts.isBindingElement(y)||!e.ts.isIdentifier(y.name)?0:d.name.text.localeCompare(y.name.text)),c[l]=e.ts.factory.updateVariableDeclaration(p,e.ts.factory.createObjectBindingPattern(f),p.exclamationToken,p.type,p.initializer),s[a]=e.ts.factory.updateVariableStatement(u,u.modifiers,e.ts.factory.updateVariableDeclarationList(u.declarationList,c)),e.ts.factory.updateSourceFile(t,s))}}}}if(typeof n=="string"){let a=e.ts.factory.createVariableStatement(void 0,e.ts.factory.createVariableDeclarationList([e.ts.factory.createVariableDeclaration(n,void 0,void 0,e.ts.factory.createCallExpression(e.ts.factory.createIdentifier("require"),void 0,[e.ts.factory.createStringLiteral(o)]))],e.ts.NodeFlags.Const));return s.splice(i,0,a),e.ts.factory.updateSourceFile(t,s)}if(typeof r=="string"){let a=e.ts.factory.createVariableStatement(void 0,e.ts.factory.createVariableDeclarationList([e.ts.factory.createVariableDeclaration(e.ts.factory.createObjectBindingPattern([e.ts.factory.createBindingElement(void 0,void 0,r)]),void 0,void 0,e.ts.factory.createCallExpression(e.ts.factory.createIdentifier("require"),void 0,[e.ts.factory.createStringLiteral(o)]))],e.ts.NodeFlags.Const));return s.splice(i,0,a),e.ts.factory.updateSourceFile(t,s)}return t}function vt(e,t,n="esm"){return n==="cjs"?pc(e,t):cc(e,t)}function cc(e,t){let n=[];for(let r of t.statements){if(e.ts.isExportDeclaration(r)){if(r.exportClause&&e.ts.isNamedExports(r.exportClause)){for(let o of r.exportClause.elements)if(r.moduleSpecifier&&n.push({isDefaultExport:!1,statement:r,node:o}),e.ts.isIdentifier(o.name)){let s=o.name.text;for(let i of t.statements)if(e.ts.isVariableStatement(i))for(let a of i.declarationList.declarations)e.ts.isIdentifier(a.name)&&a.name.text===s&&n.push({isDefaultExport:!1,statement:i,node:i});else e.ts.isFunctionDeclaration(i)&&i.name&&i.name.text===s&&n.push({isDefaultExport:!1,statement:i,node:i})}}else!r.exportClause&&r.moduleSpecifier&&n.push({isDefaultExport:!1,statement:r,node:r});continue}if(e.ts.isExportAssignment(r)){let o=r.flags===e.ts.NodeFlags.None,s=r.expression;if(e.ts.isIdentifier(s)){let i=s.text;for(let a of t.statements){if(e.ts.isVariableStatement(a))for(let u of a.declarationList.declarations)e.ts.isIdentifier(u.name)&&u.name.text===i&&n.push({isDefaultExport:o,statement:a,node:a});e.ts.isFunctionDeclaration(a)&&a.name?.text===i&&n.push({isDefaultExport:o,statement:a,node:a})}}else(e.ts.isArrowFunction(s)||e.ts.isCallExpression(s)||e.ts.isFunctionDeclaration(s)||e.ts.isObjectLiteralExpression(s))&&n.push({isDefaultExport:o,statement:r,node:s});continue}if((e.ts.isVariableStatement(r)||e.ts.isFunctionDeclaration(r))&&r.modifiers&&r.modifiers.some(o=>o.kind===e.ts.SyntaxKind.ExportKeyword)){n.push({isDefaultExport:r.modifiers.some(o=>o.kind===e.ts.SyntaxKind.DefaultKeyword),statement:r,node:r});continue}}return n}function pc(e,t){let n=[];for(let r of t.statements)if(e.ts.isExpressionStatement(r)&&e.ts.isBinaryExpression(r.expression)&&e.ts.isPropertyAccessExpression(r.expression.left)){let o=r.expression.left,s=r.expression.right;if(!e.ts.isIdentifier(o.expression))continue;if(o.expression.text==="module"&&o.name.text==="exports"){if(e.ts.isIdentifier(s)){let i=s.text;for(let a of t.statements)if(e.ts.isVariableStatement(a))for(let u of a.declarationList.declarations)e.ts.isIdentifier(u.name)&&u.name.text===i&&n.push({isDefaultExport:!0,statement:a,node:a});else e.ts.isFunctionDeclaration(a)&&a.name&&a.name.text===i&&n.push({isDefaultExport:!0,statement:a,node:a})}else n.push({isDefaultExport:!0,statement:r,node:s});continue}}return n}function mc(e,t,n){for(let r of t.statements)if(e.ts.isImportDeclaration(r)&&r.importClause){if(r.importClause.namedBindings&&e.ts.isNamedImports(r.importClause.namedBindings)){for(let o of r.importClause.namedBindings.elements)if(e.ts.isIdentifier(o.name)&&o.name.text===n&&e.ts.isStringLiteral(r.moduleSpecifier))return{importPath:r.moduleSpecifier.text,exportType:"named"}}if(r.importClause.name&&r.importClause.name.text===n&&e.ts.isStringLiteral(r.moduleSpecifier))return{importPath:r.moduleSpecifier.text,exportType:"default"}}return null}async function Ue(e,t,n,r){let o=mc(e,n,r);if(o){let s=await cr(e,e.normalize(e.resolve(e.dirname(t),o.importPath))),i=e.relative(e.getAppRootDir(),s);return{displayFilePath:j(e,s),filePath:s,relFilePath:i,importPath:o.importPath,exportType:o.exportType}}return null}function Ut(e,t,n){for(let r=0;r<t.statements.length;r++){let o=t.statements[r];if(e.ts.isVariableStatement(o)){for(let s of o.declarationList.declarations)if(e.ts.isIdentifier(s.name)&&s.name.text===n)return{statement:o,statementIndex:r}}}return null}function X(e,t,n){let r=Ut(e,t,n);if(r&&r.statement.declarationList.declarations.length>0){let o=r.statement.declarationList.declarations[0];if(o.initializer&&e.ts.isArrayLiteralExpression(o.initializer))return{statement:r.statement,statementIndex:r.statementIndex,variableDeclaration:o,arrayLiteralExp:o.initializer}}return null}function Vr(e,t){if(t){if(dc(e,t))return!0;let n=!1;if(t.forEachChild(r=>{Vr(e,r)&&(n=!0)}),n)return!0}return!1}function dc(e,t){return e.ts.isJsxElement(t)||e.ts.isJsxOpeningElement(t)||e.ts.isJsxOpeningFragment(t)||e.ts.isJsxSelfClosingElement(t)||e.ts.isJsxFragment(t)||e.ts.isJsxChild(t)}async function cr(e,t){let n=e.extname(t).toLowerCase();if(n===""||!_n.includes(n)){for(let r of _n){let o=t+r;if(await e.exists(o))return o}for(let r of _n){let o=e.join(t,"index"+r);if(await e.exists(o))return o}}return t}var _n=[".tsx",".jsx",".ts",".js"];function Vt(e,t,n){if(!n||!t)return;let r=t.getSymbolAtLocation(n);if(!r)return;let o=r.valueDeclaration;if(!o)return;let s=o.getSourceFile().fileName,i=fc(e,s);return i?[{name:i}]:void 0}function fc(e,t){if(typeof t=="string"){t=e.normalize(Ie(t));let n=t.split("/"),r=n.lastIndexOf("node_modules");if(r>-1){let o=n.slice(r+1),s=o[0];if(s)return s.startsWith("@")&&o[1]&&(s+="/"+o[1]),s}}}function Ve(e){let t=[];for(let n of e)if(n.dependencies)for(let r of n.dependencies)t.some(o=>o.name===r.name)||t.push({...r});return t.sort((n,r)=>n.name.localeCompare(r.name))}function ns(e,t,n="esm"){return n==="cjs"?hc(e,t):Dc(e,t)}var gc=/^(@\w|\w)/;function Dc(e,t){let n=[];for(let r of t.statements)if(e.ts.isImportDeclaration(r)&&e.ts.isLiteralExpression(r.moduleSpecifier)){if(!gc.test(r.moduleSpecifier.text)||r.importClause?.isTypeOnly)continue;if(r.importClause&&r.importClause.namedBindings&&e.ts.isNamedImports(r.importClause.namedBindings))for(let o of r.importClause.namedBindings.elements)o.isTypeOnly||n.push({isDefaultExport:!1,statement:r,node:o.name});r.importClause&&r.importClause.name&&n.push({isDefaultExport:!0,statement:r,node:r.importClause.name})}return n}function hc(e,t){return[]}async function Kt(e,t){if(!t.some(i=>!i.isRegistered))return t;let r=await Z(e,t.map(i=>i.filePath)),o=r.getTypeChecker();return await Promise.all(t.map(async i=>{let a=r.getSourceFile(i.filePath);if(a){let l=(await dt(e,o,i.filePath,a,!1)).find(c=>c.cmpInfo.id===i.id);l&&(i.inputs=St(e,o,l.node.fnNode))}return i}))}async function zt(e,t,n,r){if(t.node.fnNode){let{sourceFile:o,typeChecker:s}=await Nt(e,t.cmpInfo.filePath,n),a=(await dt(e,s,t.cmpInfo.filePath,o,r)).find(u=>u.cmpInfo.id===t.cmpInfo.id);if(!a)throw new Error(`createComponentInputs() Could not find component ${t.cmpInfo.name} in ${t.cmpInfo.filePath}`);return St(e,s,a.node.fnNode)}return[]}async function os(e,t,n){let r=e.extname(t).toLowerCase();if(r===".tsx"||r===".jsx"||r===".ts"||r===".js"){let o=await e.readFile(t);if(o)return Cc(e,t,o,n)}return null}function Cc(e,t,n,r=!1){let o=N(e,n);return dt(e,null,t,o,r)}async function dt(e,t,n,r,o){let s=[];for(let a of r.statements)if(e.ts.isExpressionStatement(a)&&e.ts.isStringLiteral(a.expression)&&a.expression.text==="use server")return s;let i=vt(e,r);return o&&i.push(...ns(e,r)),n=e.normalize(n),await Promise.all(i.map(async a=>{let u=await xc(e,t,n,a);s.push(...u)})),s}async function xc(e,t,n,r){let o=[],s=e.relative(e.getAppRootDir(),n),i=W(e,n);if(e.ts.isVariableStatement(r.node)){for(let a of r.node.declarationList.declarations){if(!e.ts.isIdentifier(a.name)||!kt(a.name.text))continue;let u=rt(e,t,a.initializer);if(u){let l=u.name||a.name.text,c=r.isDefaultExport?"default":l,p=r.isDefaultExport?"default":"named";o.push({cmpInfo:{id:await z(e,n,c),displayFilePath:j(e,n),name:G(l),inputs:[],exportName:c,exportType:p,importName:l,filePath:n,relFilePath:s,importPath:i,dependencies:u.deps,framework:"react"},node:u})}}return o}if(e.ts.isArrowFunction(r.node)){let a=rt(e,t,r.node);if(a){let u=be(e,n),l=r.isDefaultExport?"default":u,c=r.isDefaultExport?"default":"named";o.push({cmpInfo:{id:await z(e,n,l),displayFilePath:j(e,n),name:u,inputs:[],exportName:l,exportType:c,importName:bt(e,n),filePath:n,relFilePath:s,importPath:i,dependencies:a.deps,framework:"react"},node:a})}return o}if(e.ts.isFunctionExpression(r.node)||e.ts.isFunctionDeclaration(r.node)){let a=r.node.name?.text;if(a&&!kt(a))return o;let u=rt(e,t,r.node);if(u){let l=u.name||be(e,n),c=r.isDefaultExport||!u.name?"default":u.name,p=r.isDefaultExport?"default":"named";o.push({cmpInfo:{id:await z(e,n,c),displayFilePath:j(e,n),name:l,inputs:[],exportName:c,exportType:p,importName:u.name||bt(e,n),filePath:n,relFilePath:s,importPath:i,dependencies:u.deps,framework:"react"},node:u})}return o}if((e.ts.isExportSpecifier(r.node)||e.ts.isIdentifier(r.node))&&kt(r.node.getText())){let a,u=rt(e,t,r.node);if(u){let l=u.name||be(e,n),c=r.isDefaultExport||!u.name?"default":u.name,p=r.isDefaultExport?"default":"named",m=yc(e,r.node)?.moduleSpecifier??Ec(e,r.node)?.moduleSpecifier;if(m&&e.ts.isStringLiteral(m)){let D=t?.getSymbolAtLocation(m);if(D&&D.declarations&&D.declarations.length>0){let g=D.declarations[0];(!e.ts.isSourceFile(g)||e.ts.isSourceFile(g)&&g.fileName.includes("node_modules"))&&(a=m.text)}}o.push({cmpInfo:{id:await z(e,n,c,a),displayFilePath:j(e,n),name:l,inputs:[],exportName:c,exportType:p,importName:u.name||bt(e,n),filePath:n,relFilePath:s,importPath:a||i,externalImportPath:a,dependencies:u.deps,framework:"react"},node:u})}return o}if(e.ts.isExportDeclaration(r.node)&&r.node.exportClause===void 0){let a=r.node.moduleSpecifier;if(a&&e.ts.isStringLiteral(a)){let u=await wc(e,t,n,a);o.push(...u)}return o}return o}function yc(e,t){for(;t;){if(e.ts.isExportDeclaration(t))return t;t=t.parent}return null}function Ec(e,t){for(;t;){if(e.ts.isImportDeclaration(t))return t;t=t.parent}return null}function rt(e,t,n){if(!n)return null;if(e.ts.isArrowFunction(n))return Vr(e,n.body)?{name:"",fnNode:n,deps:Vt(e,t,n)}:null;if(e.ts.isFunctionExpression(n)||e.ts.isFunctionDeclaration(n))return Vr(e,n.body)?{name:n.name?.text||"",fnNode:n,deps:Vt(e,t,n)}:null;if(e.ts.isCallExpression(n)){let r=n.expression;if(e.ts.isPropertyAccessExpression(r)){let o=n.arguments;if(o.length===0)return null;let s=r.expression;if(!e.ts.isIdentifier(s)||s.text!=="React")return null;let i=r.name;return!e.ts.isIdentifier(i)||i.text!=="forwardRef"?null:rt(e,t,o[0])}else if(e.ts.isIdentifier(r)&&(r.text==="observer"||r.text==="forwardRef")){let o=n.arguments;return o.length===0?null:rt(e,t,o[0])}return null}if(!t)return null;if(e.ts.isPropertyAccessExpression(n)){let r=n.expression,o=n.name;if(!e.ts.isIdentifier(r)||!e.ts.isIdentifier(o)||!kt(o.text))return null;let i=t.getTypeAtLocation(o).getCallSignatures();if(i.length>0&&i[0].getParameters().length>0)return{name:"",fnNode:o,deps:Vt(e,t,o)}}if(e.ts.isExportSpecifier(n)){let r=n.name;return{name:r.text||"",fnNode:r,deps:Vt(e,t,r)}}if(e.ts.isIdentifier(n))return{name:n.text||"",fnNode:n,deps:Vt(e,t,n)};if(e.ts.isExpressionStatement(n)){let r=n.expression;if(e.ts.isAsExpression(r)&&e.ts.isIdentifier(r.type)&&r.type.text==="default")return rt(e,t,r.expression)}if(e.ts.isVariableStatement(n)){for(let r of n.declarationList.declarations)if(r.initializer&&e.ts.isAsExpression(r.initializer)){let o=r.initializer;if(e.ts.isIdentifier(o.type)&&o.type.text==="default"){let s=rt(e,t,o.expression);if(s&&e.ts.isIdentifier(r.name))return{name:r.name.text,fnNode:s.fnNode,deps:s.deps}}}}return null}async function ss(e,t){let n=[],r=t.getSourceFiles(),o=t.getTypeChecker();return await Promise.all(r.map(async s=>{let i=e.normalize(s.fileName);if(Rr(e,Fc,s.fileName)||i===e.reactConfigPath||i===e.builderComponentPath)return;let a=await dt(e,o,i,s,i===e.registryPath);n.push(...a)})),n.sort((s,i)=>s.cmpInfo.name.localeCompare(i.cmpInfo.name))}var Fc=new Set(["node_modules","dist"]);async function wc(e,t,n,r){let o=[],s=r.text;if(!t)return o;try{let i=t.getSymbolAtLocation(r);if(!i)return o;let a=t.getExportsOfModule(i);for(let u of a){let l=u.valueDeclaration||u.declarations?.[0];if(!l)continue;let c=u.name;if(!kt(c)&&c!=="default"||!as(e,t,l))continue;let p=rt(e,t,l);if(p){let m=u.name,D=m==="default"?"default":"named",g=G(m),f=m==="default"?bt(e,n):m;o.push({cmpInfo:{id:await z(e,n,m,s),displayFilePath:j(e,n),name:g,inputs:[],exportName:m,exportType:D,importName:f,filePath:n,relFilePath:e.relative(e.getAppRootDir(),n),importPath:s,externalImportPath:s,dependencies:p.deps,framework:"react"},node:p})}}}catch(i){e.Sentry?.captureException(new Error(`Error processing module ${s}:`,{cause:i}),{extra:{modulePath:s,filePath:n}})}return o}function as(e,t,n){if(e.ts.isInterfaceDeclaration(n)||e.ts.isTypeAliasDeclaration(n))return!1;if(e.ts.isExportSpecifier(n)){let r=t.getSymbolAtLocation(n.name);if(r){let s=t.getAliasedSymbol(r).declarations?.[0];if(s)return as(e,t,s)}return!1}if(e.ts.isFunctionDeclaration(n)||e.ts.isArrowFunction(n)||e.ts.isFunctionExpression(n)){let r=t.getSignatureFromDeclaration(n);if(r){let o=t.getReturnTypeOfSignature(r);return is(o,t)}}return e.ts.isClassDeclaration(n)?n.heritageClauses?.some(o=>o.types.some(s=>s.expression.getText()==="React.Component"||s.expression.getText()==="Component"))??!1:e.ts.isVariableDeclaration(n)?t.getTypeAtLocation(n).getCallSignatures().some(s=>is(t.getReturnTypeOfSignature(s),t)):!1}function is(e,t){let n=t.typeToString(e);return n==="JSX.Element"||n==="Element"||n.includes("ReactElement")||n.includes("React.ReactElement")||n.includes("ReactNode")}async function us(e,t){let n=[],r=t.getSourceFiles(),o=t.getTypeChecker();return await Promise.all(r.map(async s=>{let i=e.basename(s.fileName);if(e.appDir&&bc.has(i)||e.dirname(s.fileName).includes("node_modules"))return;let a=e.normalize(s.fileName);if(a===e.nextConfigPath||a===e.builderComponentPath)return;let u=await dt(e,o,a,s,a===e.registryPath||he(a));n.push(...u)})),n.sort((s,i)=>s.cmpInfo.name.localeCompare(i.cmpInfo.name))}var bc=new Set(["default.tsx","default.ts","default.jsx","default.js","error.tsx","error.ts","error.jsx","error.js","layout.tsx","layout.ts","layout.jsx","layout.js","loading.tsx","loading.ts","loading.jsx","loading.js","not-found.tsx","not-found.ts","not-found.jsx","not-found.js","page.tsx","page.ts","page.jsx","page.js","route.tsx","route.ts","route.jsx","route.js","template.tsx","template.ts","template.jsx","template.js"]);function Ke(e,t){let n=[],r=[],o=[],s=[];for(let i of t.statements){if(e.ts.isImportDeclaration(i)){if(e.ts.isStringLiteral(i.moduleSpecifier)){let u=i.moduleSpecifier.text;if(!u.startsWith(".")&&!u.startsWith("/")){n.push(i);continue}}let a=i.importClause;if(a){if(a.namedBindings){r.push(i);continue}if(a.name){r.push(i);continue}}o.push(i);continue}s.push(i)}return e.ts.factory.updateSourceFile(t,[...jn(e,n),...jn(e,r),...jn(e,o),...s])}function Re(e){let t=e.split(`
`).map(r=>r.trimEnd());e="";let n=!1;for(let r=t.length-1;r>=0;r--){let o=t[r];!n&&o.startsWith("import ")&&(n=!0,o=o+`
`),/^builder.init(.*)$/.test(o)&&(o=o+`
`),t[r-1]&&!t[r-1].includes("*/")&&(o.trim().startsWith("Builder.registerComponent")&&(o=`
`+o),o.trim().startsWith("/**")&&(o=`
`+o),o.trim().startsWith("module.exports")&&(o=`
`+o),o.trim().startsWith("export ")&&(o=`
`+o)),e=o+`
`+e}return e.trim()+`
`}function jn(e,t){return t.sort((n,r)=>{let o=ls(e,n),s=ls(e,r);return o.toLocaleLowerCase().localeCompare(s.toLocaleLowerCase())})}function ls(e,t){let n=t.importClause;if(n){let r=n.namedBindings;if(r&&e.ts.isNamedImports(r)&&r.elements.length>0)return r.elements[0].name.text;if(n.name)return n.name.text}return t.moduleSpecifier&&e.ts.isStringLiteral(t.moduleSpecifier)?t.moduleSpecifier.text:""}function ps(e){return typeof e=="string"&&!e.includes("'use client'")&&!e.includes(`"use client"'`)&&(e=`"use client"
${e}`),e}function ms(e,t){let n=t.statements.filter(r=>!(e.ts.isExpressionStatement(r)&&e.ts.isStringLiteral(r.expression)&&e.ts.isStringLiteral(r.expression)&&r.expression.text==="use client"));return e.ts.factory.updateSourceFile(t,n)}function ze(e,t){return t.sort((n,r)=>{if(e.ts.isObjectLiteralExpression(n)&&e.ts.isObjectLiteralExpression(r)){let o=cs(e,n),s=cs(e,r);return o.toLocaleLowerCase().localeCompare(s.toLocaleLowerCase())}return 1})}function cs(e,t){let n=t.properties.find(r=>K(e,r)==="name");return n&&e.ts.isPropertyAssignment(n)&&e.ts.isStringLiteral(n.initializer)?n.initializer.text:"zzzz"}async function ds(e){let t=await e.readFile(e.registryPath);return t?Sc(e,t):{components:[],sourceFile:N(e,"")}}async function Sc(e,t){let n=N(e,t);return e.sdkVersion===A.gen2?Ac(e,n):vc(e,n)}async function vc(e,t){let n=[];for(let r=0;r<t.statements.length;r++){let o=t.statements[r];if(!e.ts.isExpressionStatement(o))continue;let s=o.expression;if(!e.ts.isCallExpression(s))continue;let i=s.expression;if(!e.ts.isPropertyAccessExpression(i))continue;let a=i.expression;if(!e.ts.isIdentifier(a)||a.text!=="Builder"||i.name.text!=="registerComponent")continue;let l=s.arguments;if(l.length<2)continue;let c=l[1];if(!e.ts.isObjectLiteralExpression(c))continue;let p=l[0];if(e.ts.isCallExpression(p)){let m=e.ts.isIdentifier(p.expression)&&p.expression.text;if(m==="withChildren"){let g=Vn(e,p.arguments[0]);if(e.ts.isCallExpression(g)){let f=await Mn(e,r,g,c,!0);f&&n.push(f)}else{let f=g;if(e.ts.isIdentifier(f)){let h=await Un(e,t,r,f,c,!0);h&&n.push(h)}}continue}if(m==="dynamic"){let g=await Mn(e,r,p,c,!1);g&&n.push(g);continue}let D=Vn(e,p.arguments[0]);if(e.ts.isCallExpression(D)&&e.ts.isIdentifier(D.expression)&&D.expression.text==="dynamic"){let g=await Mn(e,r,D,c,!1);g&&n.push(g);continue}if(e.ts.isIdentifier(D)){let g=await Un(e,t,r,D,c,!1);g&&n.push(g);continue}continue}if(e.ts.isIdentifier(p)){let m=await Un(e,t,r,p,c,!1);m&&n.push(m);continue}}return{sourceFile:t,components:fe(n)}}function Vn(e,t){return e.ts.isCallExpression(t)?(e.ts.isIdentifier(t.expression)&&t.expression.text)==="dynamic"?t:Vn(e,t.arguments[0]):t}async function Mn(e,t,n,r,o){let s={id:"",name:"",displayFilePath:"",exportName:"",importName:"",filePath:"",relFilePath:"",importPath:"",inputs:[],nodeIndex:t,acceptsChildren:o,framework:"react"},i=n.arguments;if(i.length===0)return null;let a=i[0];if(!e.ts.isArrowFunction(a))return null;let u=a.body;if(e.ts.isCallExpression(u)){if(u.expression.kind!==e.ts.SyntaxKind.ImportKeyword||u.arguments.length!==1)return null;let c=u.arguments[0];if(!e.ts.isStringLiteral(c))return null;let p=c.text,m=await Gt(e,p);s.filePath=m,s.relFilePath=e.relative(e.getAppRootDir(),s.filePath),await e.exists(m)?s.importPath=W(e,s.filePath):(s.externalImportPath=p,s.importPath=s.externalImportPath),s.name=be(e,s.filePath),s.importName="default",s.exportName="default",s.exportType="default"}else if(e.ts.isPropertyAccessExpression(u)){let l=u.expression;if(!e.ts.isParenthesizedExpression(l))return null;let c=l.expression;if(!e.ts.isAwaitExpression(c))return null;let p=c.expression;if(!e.ts.isCallExpression(p)||p.expression.kind!==e.ts.SyntaxKind.ImportKeyword||p.arguments.length!==1)return null;let D=p.arguments[0];if(!e.ts.isStringLiteral(D)||!e.ts.isIdentifier(u.name))return null;let g=D.text,f=await Gt(e,g);s.filePath=f,s.relFilePath=e.relative(e.getAppRootDir(),s.filePath),await e.exists(f)?s.importPath=W(e,s.filePath):(s.externalImportPath=g,s.importPath=s.externalImportPath),s.name=G(u.name.text),s.importName=u.name.text,s.exportName=u.name.text,s.exportType="named"}else return null;return s=ge(e,s,r),s.displayFilePath=j(e,s.filePath),s.filePath&&s.exportName&&(s.id=await z(e,s.filePath,s.exportName,s.externalImportPath)),s}async function Un(e,t,n,r,o,s){let i={id:"",name:"",displayFilePath:"",exportName:"",importName:"",filePath:"",relFilePath:"",importPath:"",inputs:[],nodeIndex:n,acceptsChildren:s,framework:"react"},a=t.statements.filter(l=>e.ts.isImportDeclaration(l)),u=a.find(l=>l.importClause&&l.importClause.name?.text===r.text);if(u){let l=u.moduleSpecifier;if(!e.ts.isStringLiteral(l))return null;let c=await Gt(e,l.text);i.filePath=c,i.relFilePath=e.relative(e.getAppRootDir(),i.filePath),await e.exists(c)?i.importPath=W(e,i.filePath):(i.externalImportPath=l.text,i.importPath=i.externalImportPath),i.name=be(e,i.filePath),i.importName=r.text,i.exportName="default",i.exportType="default"}else{let l=a.find(m=>!m.importClause||!m.importClause.namedBindings||!e.ts.isNamedImports(m.importClause.namedBindings)?!1:m.importClause.namedBindings.elements.some(D=>D.name.text===r.text));if(!l)return null;let c=l.moduleSpecifier;if(!e.ts.isStringLiteral(c))return null;let p=await Gt(e,c.text);i.filePath=p,i.relFilePath=e.relative(e.getAppRootDir(),i.filePath),await e.exists(p)?i.importPath=W(e,i.filePath):(i.externalImportPath=c.text,i.importPath=i.externalImportPath),i.name=G(r.text),i.importName=r.text,i.exportName=r.text,i.exportType="named"}return i=ge(e,i,o),i.displayFilePath=j(e,i.filePath),i.filePath&&i.exportName&&(i.id=await z(e,i.filePath,i.exportName,i.externalImportPath)),i}function Gt(e,t){return cr(e,e.normalize(e.resolve(e.dirname(e.registryPath),t)))}function fs(e,t,n){let r=!1,o=0,s=[...t.statements];for(let l=0;l<s.length;l++){let c=s[l];if(e.ts.isImportDeclaration(c)){o=l;continue}if(!e.ts.isExpressionStatement(c))continue;let p=c.expression;if(!e.ts.isCallExpression(p))continue;let m=p.expression;if(!e.ts.isPropertyAccessExpression(m))continue;let D=m.expression;if(!e.ts.isIdentifier(D)||D.text!=="builder")continue;if(m.name.text=="init"){r=!0;break}else continue}if(r)return t;let i=e.ts.factory.createPropertyAccessExpression(e.ts.factory.createPropertyAccessExpression(e.ts.factory.createIdentifier("process"),e.ts.factory.createIdentifier("env")),e.ts.factory.createIdentifier(Me)),a=n?e.ts.factory.createNonNullExpression(i):i,u=e.ts.factory.createExpressionStatement(e.ts.factory.createCallExpression(e.ts.factory.createPropertyAccessExpression(e.ts.factory.createIdentifier("builder"),e.ts.factory.createIdentifier("init")),void 0,[a]));return s.splice(o+1,0,u),e.ts.factory.updateSourceFile(t,s)}async function Ac(e,t){let n=[],r=X(e,t,"CUSTOM_COMPONENTS");return r&&await Promise.all(r.arrayLiteralExp.elements.map(async(o,s)=>{let i=await Kn(e,t,o);i&&(i.nodeIndex=s,n.push(i))})),{sourceFile:t,components:fe(n)}}async function Kn(e,t,n){if(!e.ts.isObjectLiteralExpression(n))return null;let r={id:"",name:"",displayFilePath:"",exportName:"",importName:"",filePath:"",relFilePath:"",importPath:"",inputs:[],acceptsChildren:!1,framework:"react"};Mt(e,n)&&(r.acceptsChildren=!0);for(let s of n.properties){if(!e.ts.isPropertyAssignment(s)||!e.ts.isIdentifier(s.name))continue;if(K(e,s)==="component"){let a,{initializer:u}=s;if(e.ts.isCallExpression(u)&&(e.ts.isIdentifier(u.expression)&&u.expression.text)==="dynamic"){let D=u.arguments;if(D.length===0)return null;let g=D[0];if(!e.ts.isArrowFunction(g))return null;let f=g.body;if(e.ts.isCallExpression(f)){if(f.expression.kind!==e.ts.SyntaxKind.ImportKeyword||f.arguments.length!==1)return null;let d=f.arguments[0];if(!e.ts.isStringLiteral(d))return null;let y=d.text,F=await Gt(e,y);r.filePath=F,r.relFilePath=e.relative(e.getAppRootDir(),r.filePath),await e.exists(F)?r.importPath=W(e,r.filePath):(r.externalImportPath=y,r.importPath=r.externalImportPath),r.name=be(e,r.filePath),r.importName="default",r.exportName="default",r.exportType="default"}else if(e.ts.isPropertyAccessExpression(f)){let h=f.expression;if(!e.ts.isParenthesizedExpression(h))return null;let d=h.expression;if(!e.ts.isAwaitExpression(d))return null;let y=d.expression;if(!e.ts.isCallExpression(y)||y.expression.kind!==e.ts.SyntaxKind.ImportKeyword||y.arguments.length!==1)return null;let w=y.arguments[0];if(!e.ts.isStringLiteral(w)||!e.ts.isIdentifier(f.name))return null;let b=w.text,E=await Gt(e,b);r.filePath=E,r.relFilePath=e.relative(e.getAppRootDir(),r.filePath),await e.exists(E)?r.importPath=W(e,r.filePath):(r.externalImportPath=b,r.importPath=r.externalImportPath),r.name=G(f.name.text),r.importName=f.name.text,r.exportName=f.name.text,r.exportType="named"}else return null;return r=ge(e,r,n),r.displayFilePath=j(e,r.filePath),r.filePath&&r.exportName&&(r.id=await z(e,r.filePath,r.exportName,r.externalImportPath)),r}if(e.ts.isIdentifier(u)&&(a=u.text),!a)continue;r.name===""&&(r.name=G(a)),r.importName=a;let l=await Ue(e,e.registryPath,t,a);if(!l)continue;r.filePath=l.filePath,r.relFilePath=l.relFilePath,await e.exists(l.filePath)?r.importPath=W(e,l.filePath):(r.externalImportPath=l.importPath,r.importPath=r.externalImportPath),r.importPath=W(e,l.filePath),r.displayFilePath=l.displayFilePath,r.exportType=l.exportType;let c=t.statements.filter(m=>e.ts.isImportDeclaration(m)),p=c.find(m=>m.importClause&&m.importClause.name?.text===a);if(p){let m=p.moduleSpecifier;if(!e.ts.isStringLiteral(m))return null;r.exportName="default"}else{let m=c.find(g=>!g.importClause||!g.importClause.namedBindings||!e.ts.isNamedImports(g.importClause.namedBindings)?!1:g.importClause.namedBindings.elements.some(f=>f.name.text===a));if(!m)return null;let D=m.moduleSpecifier;if(!e.ts.isStringLiteral(D))return null;r.exportName=a}continue}}return r=ge(e,r,n),r.filePath&&r.exportName&&(r.id=await z(e,r.filePath,r.exportName,r.externalImportPath)),r}function Ge(e,t){let n=[...t.statements],r=!1;for(let o=t.statements.length-1;o>=0;o--){let s=t.statements[o];if(e.ts.isImportDeclaration(s)&&s.importClause){let i=!1,a=s.importClause.namedBindings;if(a&&e.ts.isNamedImports(a)&&a.elements){let u=[...a.elements];for(let l=u.length-1;l>=0;l--){let c=u[l];if(e.ts.isImportSpecifier(c)){let p=c.name;if(p&&e.ts.isIdentifier(p)){let m=p.text;gs(e,t,m)||u.splice(l,1)}}}if(u.length===0)i=!0;else if(a.elements.length!==u.length){let l=e.ts.factory.updateImportClause(s.importClause,!1,s.importClause.name,e.ts.factory.createNamedImports(u)),c=e.ts.factory.updateImportDeclaration(s,void 0,l,s.moduleSpecifier,void 0);n[o]=c,r=!0}}else if(s.importClause.name&&e.ts.isIdentifier(s.importClause.name)){let u=s.importClause.name.text;gs(e,t,u)||(i=!0)}i&&(n.splice(o,1),r=!0)}}return r?e.ts.factory.updateSourceFile(t,n):t}function gs(e,t,n){let r=!1;function o(s){if(!e.ts.isImportDeclaration(s)){if(e.ts.isIdentifier(s)&&s.text===n){r=!0;return}e.ts.forEachChild(s,o)}}return e.ts.forEachChild(t,o),r}function We(e,t,n,r,o,s,i){let a=null,u=null,l=null,c=-1;t=Ce(t),n=Ce(n);let p=t.find(D=>D.id===e),m=n.find(D=>D.id===e);if(r)m||(a={...Ce(p),inputs:Ce(p.inputs).map(D=>(D.isRegistered=!0,D))},c=n.length,n.push(a));else if(typeof m?.nodeIndex=="number"&&m.nodeIndex>-1){if(o)c=m.nodeIndex,u=Ce(m),n=n.filter(D=>D.id!==e);else if(s!=null)Pc(m,s),c=m.nodeIndex,l=m;else if(i!=null){let D=m.inputs.find(g=>g.name===i.name);D&&(i.registerInput===!1?D.isRegistered=!1:(Tc(D,i),D.isRegistered=!0),l=m,c=m.nodeIndex)}}return{addCmpToRegistry:a,removeCmpFromRegistry:u,updateRegisteredCmp:l,nodeIndex:c,components:Be(t,n)}}function Be(e,t){let n=fe([...t.map(r=>(r.isRegistered=!0,r)),...e.filter(r=>!t.some(o=>o.id===r.id)).map(r=>(r.isRegistered=!1,r))]);return n.forEach(r=>{r.inputs=r.inputs.map(On),r.inputs.sort((i,a)=>i.name.toLowerCase().localeCompare(a.name.toLowerCase()));let o=t.find(i=>i.id===r.id);o&&(o.acceptsChildren=$n(r));let s=e.find(i=>i.id===r.id&&i.externalImportPath);s&&(r.filePath=s.filePath,r.relFilePath=s.relFilePath)}),n}function Pc(e,t){me(t.name)?e.name=t.name:t.name===null&&(e.name=e.importName),me(t.description)?e.description=t.description:t.description===null&&delete e.description,me(t.image)?e.image=t.image:t.image===null&&delete e.image}function Tc(e,t){me(t.type)&&(e.type=t.type),me(t.friendlyName)?e.friendlyName=t.friendlyName:t.friendlyName===null&&delete e.friendlyName,me(t.defaultValue)||Zt(t.defaultValue)||Bt(t.defaultValue)?e.defaultValue=t.defaultValue:t.defaultValue===null&&delete e.defaultValue,me(t.helperText)?e.helperText=t.helperText:t.helperText===null&&delete e.helperText,t.required===!0?e.required=t.required:(t.required===null||t.required===!1)&&delete e.required}async function ft(e){let t=new Set,n=async o=>{let s=await e.readdir(o);await Promise.all(s.map(async i=>{if(i.startsWith(".")||i==="node_modules")return;let a=e.join(o,i),u=e.extname(i).toLowerCase();if(u===".tsx"||u===".jsx"||u===".ts"||u===".js"){t.add(a);return}(await e.stat(a)).isDirectory()&&await n(a)}))};return await n(e.getAppRootDir()),await Z(e,[...t])}function qe(e,t,n){return Ut(e,t,n.variableName)?t:Ic(e,t,n)}function Ic(e,t,n){let r=typeof n.arrayType=="string"?e.ts.factory.createArrayTypeNode(e.ts.factory.createTypeReferenceNode(n.arrayType,void 0)):void 0,o=e.ts.factory.createArrayLiteralExpression([]),s=e.ts.factory.createVariableDeclaration(n.variableName,void 0,r,o),i=e.ts.factory.createVariableDeclarationList([s],e.ts.NodeFlags.Const),a=e.ts.factory.createModifier(e.ts.SyntaxKind.ExportKeyword),u=e.ts.factory.createVariableStatement([a],i),l=[...t.statements,u];return e.ts.factory.updateSourceFile(t,l)}async function Je(e,t,n,r,o,s,i,a){let u=await ft(e),[l,c,p,m]=await Promise.all([us(e,u),ds(e),ye(e),ar(e)]),D=l.map(F=>F.cmpInfo),g=c.components,f={components:Be(D,g),registryPath:e.registryPath,registryDisplayPath:j(e,e.registryPath),frameworks:e.getFrameworks(),dependencies:Ve(D),publicApiKey:m.envValue??void 0,devToolsVersion:e.version};if(a)return f.components=await Kt(e,f.components),f;let h=!1,d=c.sourceFile,y=Array.isArray(t)?t:typeof t=="string"?[t]:[];if(y.length>0){let F=y.map(E=>{let B=l.find(U=>U.cmpInfo.id===E);if(!B)throw new Error(`Component ${E} not found`);return B}),w=Array.from(new Set(F.map(E=>E.cmpInfo.filePath))),b=await Z(e,w);for(let E of F){let B=f.components.find(v=>v.id===E.cmpInfo.id),U=await zt(e,E,b,e.registryPath===E.cmpInfo.filePath||he(E.cmpInfo.filePath));we(B,U);let I=D.findIndex(v=>v.id===E.cmpInfo.id);D[I].inputs=U;let S=We(E.cmpInfo.id,D,g,n,r,o,s);if(e.sdkVersion===A.gen2){let{elements:v,elmIndex:ce,statementIndex:Te,statement:ie,variableDeclaration:V}=await kc(e,d,E);if(S.addCmpToRegistry)v.push(Bc(e,S.addCmpToRegistry)),h=!0;else if(S.removeCmpFromRegistry)v.splice(ce,1),h=!0;else if(S.updateRegisteredCmp){let pe=ee(e,v[ce],S.updateRegisteredCmp);v[ce]=e.ts.factory.updateObjectLiteralExpression(pe,[hs(e,S.updateRegisteredCmp),...pe.properties.slice(1)]),h=!0}if(h&&i){let pe=[...d.statements];pe[Te]=e.ts.factory.updateVariableStatement(ie,ie.modifiers,e.ts.factory.updateVariableDeclarationList(ie.declarationList,[e.ts.factory.updateVariableDeclaration(V,V.name,V.exclamationToken,V.type,e.ts.factory.createArrayLiteralExpression(ze(e,v)))])),d=e.ts.factory.updateSourceFile(d,pe),d=Ds(e,S,d),d=O(e,d,{namedImports:["RegisteredComponent"],importPath:"@builder.io/sdk-react",isTypeOnly:!0}),d=qe(e,d,{variableName:"CUSTOM_COMPONENTS",arrayType:"RegisteredComponent"}),f.components=S.components,g=S.components.filter(Et=>Et.isRegistered)}}else{let v=[...d.statements];S.addCmpToRegistry?(v.push(es(e,S.addCmpToRegistry)),h=!0):S.removeCmpFromRegistry?(v.splice(S.nodeIndex,1),h=!0):S.updateRegisteredCmp&&(v[S.nodeIndex]=Ln(e,v[S.nodeIndex],S.updateRegisteredCmp),h=!0),h&&i&&(d=e.ts.factory.updateSourceFile(d,v),d=O(e,d,{namedImports:["Builder","builder"],importPath:"@builder.io/react"}),d=fs(e,d,p),d=Ds(e,S,d),B?.acceptsChildren&&(d=O(e,d,{namedImports:["withChildren"],importPath:"@builder.io/react"})),f.components=S.components,g=S.components.filter(ce=>ce.isRegistered))}}}if(h&&i){d=Ge(e,d),d=Ke(e,d),e.appDir&&(d=ms(e,d));let F=te(e,d);F=Re(F),e.appDir&&(F=ps(F)),F=await e.formatCode(e.registryPath,F),await e.writeFile(e.registryPath,F)}return f}function hs(e,t){let n=e.ts.factory.createIdentifier(t.importName);return e.appDir?e.ts.factory.createPropertyAssignment("component",n):e.ts.factory.createPropertyAssignment("component",Nc(e,t))}function Rc(e){return e.ts.factory.createPropertyAssignment("canHaveChildren",e.ts.factory.createTrue())}function Bc(e,t){return ee(e,e.ts.factory.createObjectLiteralExpression([hs(e,t),...t.acceptsChildren?[Rc(e)]:[]],!0),t)}async function kc(e,t,n){let r=X(e,t,"CUSTOM_COMPONENTS");if(!r)throw new Error(`Exported name of the Builder registry must be "CUSTOM_COMPONENTS". Please update your Builder registry file: ${e.registryPath}`);let o=r.arrayLiteralExp.elements.filter(i=>e.ts.isObjectLiteralExpression(i)),s=-1;for(let i=0;i<o.length;i++)if((await Kn(e,t,o[i]))?.id===n.cmpInfo.id){s=i;break}return{...r,elements:o,elmIndex:s}}function Ds(e,t,n){if(e.appDir){let r=t.addCmpToRegistry||t.updateRegisteredCmp;if(r){let o=r.externalImportPath?r.externalImportPath:_(e,e.registryPath,r.filePath);r.exportType==="default"?n=O(e,n,{defaultImport:r.importName,importPath:o}):r.exportType==="named"&&(n=O(e,n,{namedImports:[r.importName],importPath:o}))}}else n=O(e,n,{defaultImport:"dynamic",importPath:"next/dynamic"});return n}function Nc(e,t){let n=t.externalImportPath?t.externalImportPath:_(e,e.registryPath,t.filePath),r=t.exportName!=="default",o;r?o=e.ts.factory.createPropertyAccessExpression(e.ts.factory.createAwaitExpression(e.ts.factory.createCallExpression(e.ts.factory.createIdentifier("import"),void 0,[e.ts.factory.createStringLiteral(n)])),e.ts.factory.createIdentifier(t.exportName)):o=e.ts.factory.createCallExpression(e.ts.factory.createIdentifier("import"),void 0,[e.ts.factory.createStringLiteral(n)]);let s=e.ts.factory.createArrowFunction(r?[e.ts.factory.createModifier(e.ts.SyntaxKind.AsyncKeyword)]:void 0,void 0,[],void 0,e.ts.factory.createToken(e.ts.SyntaxKind.EqualsGreaterThanToken),o);return e.ts.factory.createCallExpression(e.ts.factory.createIdentifier("dynamic"),void 0,[s])}async function xs(e){let t=[],n=await jc(e,t);return await bs(e,t,n),e.appDir?(e.debug(`ensure builder setup for next.js app ${e.appDir}`),await Oc(e,e.appDir,t)):e.pagesDir&&(e.debug(`ensure builder setup for next.js pages ${e.pagesDir}`),await Lc(e,e.pagesDir,t)),t}async function ys(e){let t=[];return await bs(e,t),e.appDir?(e.debug(`ensure figma-imports setup for next.js app ${e.appDir}`),await $c(e,e.appDir,t)):e.pagesDir&&(e.debug(`ensure figma-imports setup for next.js pages ${e.pagesDir}`),await _c(e,e.pagesDir,t)),t}async function $c(e,t,n){let r=`page.${e.typescriptEnabled?"tsx":"jsx"}`,o=e.join(t,"figma-imports",r);if(!await e.exists(o)){let s=await e.formatCode(o,Fs({sys:e,routePath:o,modelName:"figma-imports"}));await e.writeFile(o,s),n.push({filePath:o,modifiedType:"create"})}if(!await e.exists(e.builderComponentPath)){let s=await e.formatCode(e.builderComponentPath,Es(e));await e.writeFile(e.builderComponentPath,s),n.push({filePath:e.builderComponentPath,modifiedType:"create"})}}async function Oc(e,t,n){let r=`page.${e.typescriptEnabled?"tsx":"jsx"}`,o=e.join(t,"[...page]",r);if(!await e.exists(o)){let s=await e.formatCode(o,Fs({sys:e,routePath:o,modelName:"page"}));await e.writeFile(o,s),n.push({filePath:o,modifiedType:"create"})}if(!await e.exists(e.builderComponentPath)){let s=await e.formatCode(e.builderComponentPath,Es(e));await e.writeFile(e.builderComponentPath,s),n.push({filePath:e.builderComponentPath,modifiedType:"create"})}}function Es(e){let t=e.typescriptEnabled;return e.sdkVersion===A.gen2?`
  "use client";
  import { ${t?"BuilderContent, ":""} isPreviewing, Content } from "@builder.io/sdk-react";
  import DefaultErrorPage from "next/error";
  import { CUSTOM_COMPONENTS } from ${JSON.stringify(_(e,e.builderComponentPath,e.registryPath))};
  ${t?`
interface BuilderPageProps {
  ...
  const builderApiKey = process.env.${Me}${t?"!":""};
...
import DefaultErrorPage from "next/error";
import ${JSON.stringify(_(e,e.builderComponentPath,e.registryPath))};
${t?`
type BuilderPageProps = ComponentProps<typeof BuilderComponent>;`:""}

// Builder Public API Key set in .env file
builder.init(process.env.${Me}${t?"!":""});
...
`.trimStart()}function Cs(e){return e.features.asyncParams?`
interface PageProps {
      params: Promise<{
        page: string[];
      }>;
...
interface PageProps {
    ...
    }`}function Fs({sys:e,routePath:t,modelName:n}){let r=e.typescriptEnabled,o=_(e,t,e.builderComponentPath);return e.sdkVersion===A.gen2?`
import { fetchOneEntry } from "@builder.io/sdk-react";
import { RenderBuilderContent } from ${JSON.stringify(o)};

// Builder Public API Key set in .env file
const PUBLIC_API_KEY = process.env.${Me}${r?"!":""};

${r?Cs(e):""}

export default async function Page(props${r?": PageProps":""}) {
  const builderModelName = "${n}";
...
`.trimStart()}async function Lc(e,t,n){let r=`[...page].${e.typescriptEnabled?"tsx":"jsx"}`,o=e.join(t,r);if(!await e.exists(o)){let s=await e.formatCode(o,ws({sys:e,routePath:o,modelName:"page"}));await e.writeFile(o,s),n.push({filePath:o,modifiedType:"create"})}}async function _c(e,t,n){let r=`figma-imports.${e.typescriptEnabled?"tsx":"jsx"}`,o=e.join(t,r);if(!await e.exists(o)){let s=await e.formatCode(o,ws({sys:e,routePath:o,modelName:"figma-imports"}));await e.writeFile(o,s),n.push({filePath:o,modifiedType:"create"})}}function ws({sys:e,routePath:t,modelName:n}){let r=e.typescriptEnabled;return e.sdkVersion===A.gen2?`
import React from "react";
import { useRouter } from "next/router";
${r?'import type { BuilderContent } from "@builder.io/sdk-react";':""}
import {
  Content,
  fetchEntries,
  fetchOneEntry,
...
const BUILDER_API_KEY = process.env.${Me}${r?"!":""};
...
export default function Page(props${r?": { page: BuilderContent | null }":""}) {
...
import ${JSON.stringify(_(e,t,e.registryPath))};
...
${n==="page"?`// Define a function that generates the
// static paths for all pages in Builder
export async function getStaticPaths() {
  // Get a list of all pages in Builder
...
export default function Page({ page }${r?": { page: BuilderContent | null }":""}) {
  ...
  return (
    <>
      ...
      {/* Render the Builder page */}
      <BuilderComponent model="${n}" content={page || undefined} />
    </>
  );
}
`.trimStart()}async function jc(e,t){let r=e.typescriptEnabled?"tsx":"jsx",o=e.join(e.componentsDir,"Counter"),s=e.join(o,`Counter.${r}`),i=e.join(o,"styles.module.css"),{component:a,styles:u}=Mc(e);if(!await e.exists(s)){let l=await e.formatCode(s,a);await e.writeFile(s,l),t.push({filePath:s,modifiedType:"create"})}return await e.exists(i)||(await e.writeFile(i,u),t.push({filePath:i,modifiedType:"create"})),s}function Mc(e){let t=e.typescriptEnabled,n=`
"use client"
...
`.trimStart();return{component:n,styles:r}}async function bs(e,t,n){if(!await e.exists(e.registryPath)){if(e.sdkVersion===A.gen2){let s=Uc(e);await e.writeFile(e.registryPath,s)}else await e.writeFile(e.registryPath,"");t.push({filePath:e.registryPath,modifiedType:"create"})}if(!n)return;let o=(await Je(e,null,!1,!1,null,null,!1,!1)).components.find(s=>s.filePath===n);o&&await Je(e,o.id,!0,!1,null,null,!0,!1)}function Uc(e){return e.typescriptEnabled?`import type { RegisteredComponent } from "@builder.io/sdk-react";

export const CUSTOM_COMPONENTS: RegisteredComponent[] = [
];`:`export const CUSTOM_COMPONENTS = [
  ];
  `}async function Wt(e){let t=await ct(e,e.getRepoRootDir());if(t&&typeof t=="object"){let n=new Set(Object.keys({...t.dependencies,...t.devDependencies}));if(n.has("@builder.io/sdk-react"))return A.gen2;if(n.has("@builder.io/react"))return A.gen1}return null}async function Ss(e){let t=await Vc(e);return{builderPageOptions:async()=>({templateContentId:"3de2f13211234071a4b19a17b4fbc5a7",pathname:"/builder-demo",title:"Builder + Next.js Demo Page"}),ensureBuilderSetup:()=>xs(t),ensureFigmaImportPage:()=>ys(t),getRegistryPath:()=>t.registryPath,getRegistry:r=>Je(t,null,!1,!1,null,null,!1,!!r?.readAllInputTypes),addExternalPackage:r=>{t.addExternalPackage(r)},loadComponent:async r=>{let o=await Je(t,r.cmpId,!1,!1,null,null,!1,!1);return{...o,component:o.components.find(s=>s.id===r.cmpId)}},registerComponent:r=>Je(t,r.cmpId,!0,!1,null,null,!0,!1),setRegisteredComponentInfo:r=>Je(t,r.cmpId,!1,!1,r,null,!0,!1),setRegisteredComponentInput:r=>Je(t,r.cmpId,!1,!1,null,r,!0,!1),unregisterComponent:r=>Je(t,r.cmpId,!1,!0,null,null,!0,!1),getPublicApiKey:()=>ar(t),setPublicApiKey:r=>Jo(t,r.publicApiKey),getDependencies:r=>r.sdkVersion===A.gen2?[{name:"@builder.io/dev-tools"},{name:"@builder.io/sdk-react"}]:[{name:"@builder.io/dev-tools"},{name:"@builder.io/react"},{name:"@builder.io/sdk"}],getDevRunCommand:()=>"dev",getCache:()=>_e(t),setCache:r=>je(t,r)}}async function Vc(e){let t=e.getAppRootDir(),n=e.join(t,"src"),r=await Kc(e),o=await ye(e),s=e.getFrameworks().find(l=>l.name==="next"),i={asyncParams:s?.version?.major!==void 0&&s.version.major>=15},a={},u={...e,addExternalPackage:l=>{a[e.join(t,l,"index.ts")]=`export * from "${l}";`},readFileSync:l=>a[l]??e.readFileSync(l),existsSync:l=>!!a[l]||e.existsSync(l),readdirSync:l=>{let c=e.readdirSync(l);return l===t?[...c,...Object.keys(a).map(p=>p.slice(t.length+1))]:c},readdir:async l=>{let c=await e.readdir(l);return l===t?[...c,...Object.keys(a).map(p=>p.slice(t.length+1))]:c},appDir:null,pagesDir:null,srcDir:null,builderComponentPath:"",componentsDir:"",registryPath:"",nextConfigPath:r,typescriptEnabled:o,features:i};if(e.sdkVersion?u.sdkVersion=e.sdkVersion:u.sdkVersion=await Wt(u),await e.exists(n)){u.srcDir=n,u.componentsDir=e.join(n,"components");let l=e.join(n,"app");await e.exists(l)&&(u.appDir=l);let c=e.join(n,"pages");await e.exists(c)&&(u.pagesDir=c),u.registryPath=await Se(e,n)}else u.componentsDir=e.join(t,"components"),u.registryPath=await Se(e,t);if(u.builderComponentPath=e.join(u.componentsDir,`builder.${o?"tsx":"jsx"}`),!u.appDir){let l=e.join(t,"app");await e.exists(l)&&(u.appDir=l)}if(!u.pagesDir){let l=e.join(t,"pages");await e.exists(l)&&(u.pagesDir=l)}if(!u.appDir&&!u.pagesDir&&!e.ignoreMissingConfig)throw new Error(`Could not find Next.js "app" or "pages" directory. Searched in "${t}".`);return u}async function Kc(e){let t=e.join(e.getAppRootDir(),"next.config.ts");if(await e.exists(t))return t;let n=e.join(e.getAppRootDir(),"next.config.mjs");if(await e.exists(n))return n;let r=e.join(e.getAppRootDir(),"next.config.js");if(await e.exists(r))return r;throw new Error(`Could not find Next.js config file. Searched for "next.config.ts", "next.config.mjs" and "next.config.js" in "${e.getAppRootDir()}".`)}async function pr(e){return await pt(e,[".env"],As)}async function vs(e,t){zc(t);let n=await pr(e),r=await mt(e,n.file,n.envKey,t);return{...n,modifiedType:r}}function zc(e){typeof process<"u"&&(process.env[As]=e)}var As="PUBLIC_BUILDER_API_KEY";function Ps(e,t,n){if(n.length===0)return e;let r=e.split(`
`),o=r.findIndex(a=>a.includes(n));if(o===-1||r.some(a=>a.includes(t[0])))return e;let i=["/**",...t.map(a=>` * ${a.trim()}`)," */"];return r.splice(o,0,...i),r.join(`
`)}async function Is(e,t){let n=[],r=t.getSourceFiles(),o=t.getTypeChecker();return await Promise.all(r.map(async s=>{let i=e.basename(s.fileName);if(i.startsWith(".")||qc.has(i))return;let a=e.normalize(s.fileName);if(a===e.registryPath)return;let u=await Kr(e,o,a,s);n.push(...u)})),n}async function Rs(e,t){if(e.extname(t).toLowerCase()===".tsx"){let r=await e.readFile(t);if(r)return Gc(e,t,r)}return null}function Gc(e,t,n){let r=N(e,n);return Kr(e,null,t,r)}async function Kr(e,t,n,r){n=e.normalize(n);let o=[],s=vt(e,r);return await Promise.all(s.map(async i=>{let a=await Wc(e,t,n,i);a&&o.push(a)})),o}async function Wc(e,t,n,r){let o=e.relative(e.getAppRootDir(),n),s=W(e,n);if(e.ts.isVariableStatement(r.node))for(let i of r.node.declarationList.declarations){let a=Ts(e,i.initializer);if(a&&e.ts.isIdentifier(i.name)){let u=i.name.text;return{cmpInfo:{id:await z(e,n,u),displayFilePath:j(e,n),name:G(u),inputs:[],exportName:r.isDefaultExport?"default":u,exportType:r.isDefaultExport?"default":"named",importName:u,filePath:n,relFilePath:o,importPath:s,framework:"qwik"},node:a}}}else if(e.ts.isCallExpression(r.node)){let i=Ts(e,r.node);if(i)return{cmpInfo:{id:await z(e,n,"default"),displayFilePath:j(e,n),name:be(e,n),inputs:[],exportName:"default",exportType:"default",importName:bt(e,n),filePath:n,relFilePath:o,importPath:s,framework:"qwik"},node:i}}return null}function Ts(e,t){if(t&&e.ts.isCallExpression(t)&&e.ts.isIdentifier(t.expression)&&t.expression.text==="component$"&&t.arguments.length>0){let n=t.arguments[0];if(e.ts.isArrowFunction(n)||e.ts.isFunctionExpression(n))return{callExpression:t,fnNode:n}}return null}var qc=new Set(["node_modules","layout.tsx","404.tsx","router-head.tsx"]);async function Bs(e,t){let n=t.node.fnNode;if((e.ts.isArrowFunction(n)||e.ts.isFunctionExpression(n))&&n.parameters.length>0){let{sourceFile:o,typeChecker:s}=await Nt(e,t.cmpInfo.filePath,null);if(!(await Kr(e,s,t.cmpInfo.filePath,o)).find(u=>u.cmpInfo.id===t.cmpInfo.id))throw new Error(`createComponentInputs() Could not find component ${t.cmpInfo.name} in ${t.cmpInfo.filePath}`);return St(e,s,n)}return[]}async function ks(e){return zn(e)}async function zn(e){let t=[];return await e.exists(e.registryPath)||(await e.writeFile(e.registryPath,Jc),t.push({filePath:e.registryPath,modifiedType:"create"})),t}var Jc=`import type { RegisteredComponent } from "@builder.io/sdk-qwik";

export const CUSTOM_COMPONENTS: RegisteredComponent[] = [
];
`;async function Ns(e){await zn(e);let t=await e.readFile(e.registryPath);return t?Hc(e,t):{components:[],sourceFile:N(e,"")}}async function Hc(e,t){let n=N(e,t);return Yc(e,n)}async function Yc(e,t){let n=[],r=X(e,t,"CUSTOM_COMPONENTS");return r&&await Promise.all(r.arrayLiteralExp.elements.map(async(o,s)=>{let i=await Gn(e,t,o);i&&(i.nodeIndex=s,n.push(i))})),{sourceFile:t,components:fe(n)}}async function Gn(e,t,n){if(!e.ts.isObjectLiteralExpression(n))return null;let r={id:"",name:"",displayFilePath:"",exportName:"",importName:"",filePath:"",relFilePath:"",importPath:"",inputs:[],framework:"qwik"};for(let o of n.properties){if(!e.ts.isPropertyAssignment(o)||!e.ts.isIdentifier(o.name))continue;if(K(e,o)==="component"&&e.ts.isIdentifier(o.initializer)){let i=o.initializer.text;r.name===""&&(r.name=G(i)),r.importName=i;let a=await Ue(e,e.registryPath,t,i);if(!a)continue;r.filePath=a.filePath,r.relFilePath=a.relFilePath,r.importPath=W(e,a.filePath),r.displayFilePath=a.displayFilePath,r.exportType=a.exportType;let u=await Rs(e,a.filePath);if(u&&u.length>0)if(u.length===1)r.exportName=u[0].cmpInfo.exportName;else{let l=u.find(c=>c.cmpInfo.exportName===i);l&&(r.exportName=l.cmpInfo.exportName)}continue}}return r=ge(e,r,n),r.filePath&&r.exportName&&(r.id=await z(e,r.filePath,r.exportName)),r}async function $s(e){let t=new Set,n=async o=>{let s=await e.readdir(o);await Promise.all(s.map(async i=>{if(i.startsWith(".")||i==="node_modules")return;let a=e.join(o,i),u=e.extname(i).toLowerCase();if(u===".tsx"||u===".ts"){t.add(a);return}(await e.stat(a)).isDirectory()&&await n(a)}))};return await n(e.getAppRootDir()),await Z(e,[...t])}async function At(e,t,n,r,o,s,i,a){let u=await $s(e),[l,c,p]=await Promise.all([Is(e,u),Ns(e),pr(e)]),m=l.map(f=>f.cmpInfo),D=c.components,g={components:Be(m,D),registryPath:e.registryPath,registryDisplayPath:j(e,e.registryPath),frameworks:e.getFrameworks(),dependencies:Ve(m),publicApiKey:p.envValue??void 0,devToolsVersion:e.version};if(a)return g;if(t!=null){let f=l.find(S=>S.cmpInfo.id===t);if(!f)throw new Error(`Component ${t} not found`);let h=c.sourceFile,d=g.components.find(S=>S.id===t),y=await Bs(e,f);we(d,y),t=Array.isArray(t)?t[0]:t;let F=We(t,m,D,n,r,o,s),{elements:w,elmIndex:b,statementIndex:E,statement:B,variableDeclaration:U}=await Xc(e,h,f),I=!1;if(F.addCmpToRegistry?(w.push(Qc(e,F.addCmpToRegistry)),I=!0):F.removeCmpFromRegistry?(w.splice(b,1),I=!0):F.updateRegisteredCmp&&(w[b]=ee(e,w[b],F.updateRegisteredCmp),I=!0),I&&i){let S=[...h.statements];S[E]=e.ts.factory.updateVariableStatement(B,B.modifiers,e.ts.factory.updateVariableDeclarationList(B.declarationList,[e.ts.factory.updateVariableDeclaration(U,U.name,U.exclamationToken,U.type,e.ts.factory.createArrayLiteralExpression(ze(e,w)))])),h=e.ts.factory.updateSourceFile(h,S),d.exportType==="named"?h=O(e,h,{namedImports:[d.importName],importPath:_(e,e.registryPath,d.filePath)}):h=O(e,h,{defaultImport:d.importName,importPath:_(e,e.registryPath,d.filePath)}),h=O(e,h,{namedImports:["RegisteredComponent"],importPath:"@builder.io/sdk-qwik",isTypeOnly:!0}),h=qe(e,h,{variableName:"CUSTOM_COMPONENTS",arrayType:"RegisteredComponent"}),h=Ge(e,h),h=Ke(e,h);let v=te(e,h);v=Re(v),v=Ps(v,Zc,"CUSTOM_COMPONENTS"),v=await e.formatCode(e.registryPath,v),await e.writeFile(e.registryPath,v)}g.components=F.components}return g}function Qc(e,t){return ee(e,e.ts.factory.createObjectLiteralExpression([e.ts.factory.createPropertyAssignment("component",e.ts.factory.createIdentifier(t.importName))],!0),t)}async function Xc(e,t,n){let r=X(e,t,"CUSTOM_COMPONENTS");if(!r)throw new Error(`Exported name of the Builder registry must be "CUSTOM_COMPONENTS". Please update your Builder registry file: ${e.registryPath}`);let o=r.arrayLiteralExp.elements.filter(i=>e.ts.isObjectLiteralExpression(i)),s=-1;for(let i=0;i<o.length;i++)if((await Gn(e,t,o[i]))?.id===n.cmpInfo.id){s=i;break}return{...r,elements:o,elmIndex:s}}var Zc=["This array is used to integrate custom components within Builder.","https://www.builder.io/c/docs/custom-components-intro","",'These components will be found the "Custom Components"',"section of Builder's visual editor.",'You can also turn on "components only mode" to limit',"editing to only these components.","https://www.builder.io/c/docs/guides/components-only-mode"];async function Os(e){let t=await ep(e);return{builderPageOptions:async()=>({templateContentId:"dc70f1d979ad416d8fd357137eb9ddfb",pathname:"/",title:"Builder + Qwik Demo Page"}),ensureBuilderSetup:()=>ks(t),ensureFigmaImportPage:async()=>[],getRegistryPath:()=>t.registryPath,getRegistry:r=>At(t,null,!1,!1,null,null,!1,!!r?.readAllInputTypes),addExternalPackage:async r=>{},loadComponent:async r=>{let o=await At(t,r.cmpId,!1,!1,null,null,!1,!1);return{...o,component:o.components.find(s=>s.id===r.cmpId)}},registerComponent:r=>At(t,r.cmpId,!0,!1,null,null,!0,!1),setRegisteredComponentInfo:r=>At(t,r.cmpId,!1,!1,r,null,!0,!1),setRegisteredComponentInput:r=>At(t,r.cmpId,!1,!1,null,r,!0,!1),unregisterComponent:r=>At(t,r.cmpId,!1,!0,null,null,!0,!1),getPublicApiKey:()=>pr(t),setPublicApiKey:r=>vs(t,r.publicApiKey),getDependencies:r=>[{name:"@builder.io/dev-tools"},{name:"@builder.io/sdk-qwik"}],getDevRunCommand:()=>"dev",getCache:()=>_e(t),setCache:r=>je(t,r)}}async function ep(e){let t=await er(e,e.getAppRootDir(),"components");if(!t)throw new Error(`Could not find components directory within project: ${e.getAppRootDir()}`);let n=await Se(e,t),r=e.join(e.getAppRootDir(),".env");return{...e,componentsDir:t,registryPath:n,envPath:r}}async function mr(e){return await pt(e,[".env"],dr)}async function Ls(e,t){let n=await mr(e),r=await mt(e,n.file,n.envKey,t);return{...n,modifiedType:r}}var dr="PUBLIC_BUILDER_KEY";var tp=new Set(["dist","node_modules"]);async function _s(e,t){let n=[],r=t.getSourceFiles(),o=t.getTypeChecker(),s=e.join(e.getAppRootDir(),"build");return await Promise.all(r.map(async i=>{let a=e.basename(i.fileName);if(a.startsWith(".")||a==="node_modules"||Rr(e,tp,i.fileName)||rp.has(a)||a.includes("$."))return;let u=e.normalize(i.fileName);if(u===e.remixConfigPath||u===s)return;let l=await dt(e,o,u,i,u===e.registryPath);n.push(...l)})),n}var rp=new Set(["root.tsx","root.ts","root.jsx","root.js","_index.tsx","_index.jsx","_index.ts","_index.js"]);async function js(e){await zr(e);let t=await e.readFile(e.registryPath);return t?np(e,t):{components:[],sourceFile:N(e,"")}}async function np(e,t){let n=N(e,t);return ip(e,n)}async function ip(e,t){let n=[],r=X(e,t,"CUSTOM_COMPONENTS");return r&&await Promise.all(r.arrayLiteralExp.elements.map(async(o,s)=>{let i=await Wn(e,t,o);i&&(i.nodeIndex=s,n.push(i))})),{sourceFile:t,components:fe(n)}}async function Wn(e,t,n){if(!e.ts.isObjectLiteralExpression(n))return null;let r={id:"",name:"",displayFilePath:"",exportName:"",importName:"",filePath:"",relFilePath:"",importPath:"",inputs:[],acceptsChildren:!1,framework:"react"};e.sdkVersion===A.gen2&&Mt(e,n)&&(r.acceptsChildren=!0);for(let o of n.properties){if(!e.ts.isPropertyAssignment(o)||!e.ts.isIdentifier(o.name))continue;if(K(e,o)==="component"){let i,{initializer:a}=o;if(e.ts.isIdentifier(a))i=a.text;else if(e.ts.isCallExpression(a)){(e.ts.isIdentifier(a.expression)&&a.expression.text)==="withChildren"&&(r.acceptsChildren=!0);let c=a.arguments[0];e.ts.isIdentifier(c)&&(i=c.text)}if(!i)continue;r.name===""&&(r.name=G(i)),r.importName=i;let u=await Ue(e,e.registryPath,t,i);if(!u)continue;if(r.filePath=u.filePath,r.relFilePath=u.relFilePath,await e.exists(u.filePath)?r.importPath=W(e,u.filePath):(r.externalImportPath=u.importPath,r.importPath=r.externalImportPath),r.displayFilePath=u.displayFilePath,r.exportType=u.exportType,r.externalImportPath)r.exportName=i;else{let l=await os(e,u.filePath,e.registryPath===u.filePath||he(u.filePath));if(l&&l.length>0)if(l.length===1)r.exportName=l[0].cmpInfo.exportName;else{let c=l.find(p=>p.cmpInfo.exportName===i);c&&(r.exportName=c.cmpInfo.exportName)}}continue}}return r=ge(e,r,n),r.filePath&&r.exportName&&(r.id=await z(e,r.filePath,r.exportName,r.externalImportPath)),r}async function He(e,t,n,r,o,s,i,a){let u=await ft(e),[l,c,p]=await Promise.all([_s(e,u),js(e),mr(e)]),m=l.map(y=>y.cmpInfo),D=c.components,g={components:Be(m,D),registryPath:e.registryPath,registryDisplayPath:j(e,e.registryPath),frameworks:e.getFrameworks(),dependencies:Ve(m),publicApiKey:p.envValue??void 0,devToolsVersion:e.version};if(a)return g.components=await Kt(e,g.components),g;let f=!1,h=c.sourceFile,d=Array.isArray(t)?t:typeof t=="string"?[t]:[];if(d.length>0){let y=d.map(b=>{let E=l.find(B=>B.cmpInfo.id===b);if(!E)throw new Error(`Component ${b} not found`);return E}),F=Array.from(new Set(y.map(b=>b.cmpInfo.filePath))),w=await Z(e,F);for(let b of y){let E=g.components.find(V=>V.id===b.cmpInfo.id),B=await zt(e,b,w,e.registryPath===b.cmpInfo.filePath||he(b.cmpInfo.filePath));we(E,B);let U=m.findIndex(V=>V.id===b.cmpInfo.id);m[U].inputs=B;let I=We(b.cmpInfo.id,m,D,n,r,o,s),{elements:S,elmIndex:v,statementIndex:ce,statement:Te,variableDeclaration:ie}=await sp(e,h,b);if(I.addCmpToRegistry)S.push(op(e,I.addCmpToRegistry)),f=!0;else if(I.removeCmpFromRegistry)S.splice(v,1),f=!0;else if(I.updateRegisteredCmp){let V=ee(e,S[v],I.updateRegisteredCmp);S[v]=e.ts.factory.updateObjectLiteralExpression(V,[Ms(e,I.updateRegisteredCmp),...V.properties.slice(1)]),f=!0}if(f&&i){let V=[...h.statements];V[ce]=e.ts.factory.updateVariableStatement(Te,Te.modifiers,e.ts.factory.updateVariableDeclarationList(Te.declarationList,[e.ts.factory.updateVariableDeclaration(ie,ie.name,ie.exclamationToken,ie.type,e.ts.factory.createArrayLiteralExpression(ze(e,S)))])),h=e.ts.factory.updateSourceFile(h,V),E.exportType==="named"?h=O(e,h,{namedImports:[E.importName],importPath:E.externalImportPath?E.externalImportPath:_(e,e.registryPath,E.filePath)}):h=O(e,h,{defaultImport:E.importName,importPath:E.externalImportPath?E.externalImportPath:_(e,e.registryPath,E.filePath)});let pe=e.sdkVersion===A.gen2?"@builder.io/sdk-react":"@builder.io/react";h=O(e,h,{namedImports:["RegisteredComponent"],importPath:pe,isTypeOnly:!0}),E.acceptsChildren&&e.sdkVersion!==A.gen2&&(h=O(e,h,{namedImports:["withChildren"],importPath:"@builder.io/react"})),h=qe(e,h,{variableName:"CUSTOM_COMPONENTS",arrayType:"RegisteredComponent"}),g.components=I.components,D=I.components.filter(Et=>Et.isRegistered)}}}if(f&&i){h=Ge(e,h),h=Ke(e,h);let y=te(e,h);y=Re(y),y=await e.formatCode(e.registryPath,y),await e.writeFile(e.registryPath,y)}return g}function Ms(e,t){if(e.sdkVersion===A.gen2)return e.ts.factory.createPropertyAssignment("component",e.ts.factory.createIdentifier(t.importName));let n=e.ts.factory.createIdentifier(t.importName),r=t.acceptsChildren?e.ts.factory.createCallExpression(e.ts.factory.createIdentifier("withChildren"),void 0,[n]):n;return e.ts.factory.createPropertyAssignment("component",r)}function op(e,t){return ee(e,e.ts.factory.createObjectLiteralExpression([Ms(e,t),...t.acceptsChildren&&e.sdkVersion===A.gen2?[e.ts.factory.createPropertyAssignment("canHaveChildren",e.ts.factory.createTrue())]:[]],!0),t)}async function sp(e,t,n){let r=X(e,t,"CUSTOM_COMPONENTS");if(!r)throw new Error(`Exported name of the Builder registry must be "CUSTOM_COMPONENTS". Please update your Builder registry file: ${e.registryPath}`);let o=r.arrayLiteralExp.elements.filter(i=>e.ts.isObjectLiteralExpression(i)),s=-1;for(let i=0;i<o.length;i++)if((await Wn(e,t,o[i]))?.id===n.cmpInfo.id){s=i;break}return{...r,elements:o,elmIndex:s}}async function Us(e){let t=[],n=await lp(e,t);return t.push(...await zr(e)),await pp(e,n),await up(e,t),t}async function Vs(e){let t=[];return t.push(...await zr(e)),await ap(e,t),t}async function ap(e,t){let n=`figma-imports.${e.typescriptEnabled?"tsx":"jsx"}`;e.hasLocaleParam&&(e.debug("remixEnsureFigmaImportRoute, hasLocaleParam"),n=`($locale).${n}`);let r=e.join(e.routesDir,n),o=await e.exists(r);e.debug(`remixEnsureFigmaImportRoute, hasRoute: ${o}`);let s=await e.formatCode(r,Ks({sys:e,routePath:r,modelName:"figma-imports"}));await e.writeFile(r,s),t.push({filePath:r,modifiedType:o?"update":"create"})}async function up(e,t){let n=`$.${e.typescriptEnabled?"tsx":"jsx"}`;e.hasLocaleParam&&(e.debug("remixEnsureAppRoute, hasLocaleParam"),n=`($locale).${n}`),e.sdkVersion===A.gen2&&(n=`($slug)._index.${e.typescriptEnabled?"tsx":"jsx"}`);let r=e.join(e.routesDir,n),o=await e.exists(r);e.debug(`remixEnsureAppRoute, hasRoute: ${o}`);let s=await e.formatCode(r,Ks({sys:e,routePath:r,modelName:"page"}));await e.writeFile(r,s),t.push({filePath:r,modifiedType:o?"update":"create"})}function Ks({sys:e,routePath:t,modelName:n}){let r=e.typescriptEnabled,o=_(e,t,e.registryPath),s="",i="";r&&(s="import type { LoaderArgs } from '@remix-run/server-runtime';",i=": LoaderArgs");let a=`process.env.${dr}`,u="";return e.getFrameworks().some(l=>l.name==="@shopify/remix-oxygen")&&(a=`context.env.${dr}`,u=", context"),r&&(a+="!"),e.sdkVersion===A.gen2?`
...
export default function Page() {
  const { page, builderApiKey } = useLoaderData${r?"<typeof loader>":""}();
...
`:""}
`}async function lp(e,t){let r=e.typescriptEnabled?"tsx":"jsx",o=e.join(e.componentsDir,"Counter"),s=e.join(o,`Counter.${r}`),i=e.join(o,"styles.module.css"),{component:a,styles:u}=cp(e),l=await e.exists(s);if(e.debug(`remixEnsureCounterComponent, hasCounterCmp: ${l}`),!l){let p=await e.formatCode(s,a);await e.writeFile(s,p),t.push({filePath:s,modifiedType:"create"})}let c=await e.exists(i);return e.debug(`remixEnsureCounterComponent, hasCounterStyles: ${c}`),c||(await e.writeFile(i,u),t.push({filePath:i,modifiedType:"create"})),s}function cp(e){let t=e.typescriptEnabled,n=`
...
`.trimStart();return{component:n,styles:r}}async function pp(e,t){let r=(await He(e,null,!1,!1,null,null,!1,!1)).components.find(o=>o.filePath===t);r&&await He(e,r.id,!0,!1,null,null,!0,!1)}async function zr(e){let t=[];return await e.exists(e.registryPath)||(await e.writeFile(e.registryPath,mp(e)),t.push({filePath:e.registryPath,modifiedType:"create"})),t}function mp(e){let t=e.sdkVersion===A.gen2;return e.typescriptEnabled?`import type { RegisteredComponent } from ${t?'"@builder.io/sdk-react"':'"@builder.io/react"'};

export const CUSTOM_COMPONENTS: RegisteredComponent[] = [
];`:`export const CUSTOM_COMPONENTS = [
  ];
  `}async function zs(e){let t=await dp(e);return{builderPageOptions:async()=>{let r="/builder-demo",o=t.hasLocaleParam?`/en-us${r}`:void 0;return{templateContentId:"a5c9eef7909d4fc99554264a17de22c9",pathname:r,localePathname:o,title:"Builder + Remix Demo Page"}},ensureBuilderSetup:()=>Us(t),ensureFigmaImportPage:()=>Vs(t),getRegistryPath:()=>t.registryPath,getRegistry:r=>He(t,null,!1,!1,null,null,!1,!!r?.readAllInputTypes),addExternalPackage:r=>{t.addExternalPackage(r)},loadComponent:async r=>{let o=await He(t,r.cmpId,!1,!1,null,null,!1,!1);return{...o,component:o.components.find(s=>s.id===r.cmpId)}},registerComponent:r=>He(t,r.cmpId,!0,!1,null,null,!0,!1),setRegisteredComponentInfo:r=>He(t,r.cmpId,!1,!1,r,null,!0,!1),setRegisteredComponentInput:r=>He(t,r.cmpId,!1,!1,null,r,!0,!1),unregisterComponent:r=>He(t,r.cmpId,!1,!0,null,null,!0,!1),getPublicApiKey:()=>mr(t),setPublicApiKey:r=>Ls(t,r.publicApiKey),getDependencies:r=>r.sdkVersion===A.gen2?[{name:"@builder.io/dev-tools"},{name:"@builder.io/sdk-react"}]:[{name:"@builder.io/dev-tools"},{name:"@builder.io/react"},{name:"@builder.io/sdk"}],getDevRunCommand:()=>"dev",getCache:()=>_e(t),setCache:r=>je(t,r)}}async function dp(e){let t=await gp(e),n=e.getAppRootDir(),r=await Dp(e),o=e.dirname(r),s=e.join(o,"components"),i=await ye(e),a=await Se(e,o),u={},l={...e,registryPath:a,remixConfigPath:t,typescriptEnabled:i,appDir:o,componentsDir:s,routesDir:r,hasLocaleParam:await fp(e,r),addExternalPackage:c=>{u[e.join(n,c,"index.ts")]=`export * from "${c}";`},readFileSync:c=>u[c]??e.readFileSync(c),existsSync:c=>!!u[c]||e.existsSync(c),readdirSync:c=>{let p=e.readdirSync(c);return c===n?[...p,...Object.keys(u).map(m=>m.slice(n.length+1))]:p},readdir:async c=>{let p=await e.readdir(c);return c===n?[...p,...Object.keys(u).map(m=>m.slice(n.length+1))]:p}};return e.sdkVersion?l.sdkVersion=e.sdkVersion:l.sdkVersion=await Wt(l),l}async function fp(e,t){return(await e.readdir(t)).some(r=>r.startsWith("($locale)."))}async function gp(e){let t=["remix.config.ts","remix.config.js","vite.config.ts","vite.config.js"];for(let n of t){let r=e.join(e.getAppRootDir(),n);if(await e.exists(r))return r}if(e.ignoreMissingConfig)return"";throw new Error(`Could not find Remix config file. Searched for ${t.join(", ")} in "${e.getAppRootDir()}".`)}async function Dp(e){let t=await er(e,e.getAppRootDir(),"routes");if(t)return t;throw new Error(`Could not find Remix "routes" directory in "${e.getAppRootDir()}". Please ensure this command is ran from within your Remix project's directory.`)}async function fr(e){let t=[".env"],n=e.configType==="vite"?gr:Gr;return await pt(e,t,n)}async function Gs(e,t){let n=await fr(e),r=await mt(e,n.file,n.envKey,t);return{...n,modifiedType:r}}var gr="VITE_PUBLIC_BUILDER_KEY",Gr="PUBLIC_BUILDER_KEY";function Ws(e,t){let n=`Builder.registerComponent(
`;n+=`  ${t.importName},
`,n+=`  {
    name: "${t.name}",
  }
`,n+=");";let r=Ir(e,n);return qn(e,r,t)}function qn(e,t,n){if(!e.ts.isExpressionStatement(t))return t;let r=t.expression;if(!e.ts.isCallExpression(r))return t;let o=[...r.arguments];if(o.length<2)return t;let s=o[1];return e.ts.isObjectLiteralExpression(s)?(o[1]=ee(e,s,n),e.ts.factory.updateExpressionStatement(t,e.ts.factory.updateCallExpression(r,r.expression,r.typeArguments,o))):t}async function qs(e){let t=await e.readFile(e.registryPath);return t?hp(e,t):{components:[],sourceFile:N(e,"")}}async function hp(e,t){let n=N(e,t);return e.sdkVersion===A.gen2?yp(e,n):Cp(e,n)}async function Cp(e,t){let n=[];for(let r=0;r<t.statements.length;r++){let o=t.statements[r];if(!e.ts.isExpressionStatement(o))continue;let s=o.expression;if(!e.ts.isCallExpression(s))continue;let i=s.expression;if(!e.ts.isPropertyAccessExpression(i))continue;let a=i.expression;if(!e.ts.isIdentifier(a)||a.text!=="Builder"||i.name.text!=="registerComponent")continue;let l=s.arguments;if(l.length<2)continue;let c=l[1];if(!e.ts.isObjectLiteralExpression(c))continue;let p=l[0];if(e.ts.isIdentifier(p)){let m=await xp(e,t,r,p,c,!1);m&&n.push(m);continue}}return{sourceFile:t,components:fe(n)}}async function xp(e,t,n,r,o,s){let i={id:"",name:"",displayFilePath:"",exportName:"",importName:"",filePath:"",relFilePath:"",importPath:"",inputs:[],nodeIndex:n,acceptsChildren:s,framework:"react"},a=t.statements.filter(l=>e.ts.isImportDeclaration(l)),u=a.find(l=>l.importClause&&l.importClause.name?.text===r.text);if(u){let l=u.moduleSpecifier;if(!e.ts.isStringLiteral(l))return null;i.filePath=await Jn(e,l.text),i.relFilePath=e.relative(e.getAppRootDir(),i.filePath),i.importPath=W(e,i.filePath),i.name=be(e,i.filePath),i.importName=r.text,i.exportName="default",i.exportType="default"}else{let l=a.find(m=>!m.importClause||!m.importClause.namedBindings||!e.ts.isNamedImports(m.importClause.namedBindings)?!1:m.importClause.namedBindings.elements.some(D=>D.name.text===r.text));if(!l)return null;let c=l.moduleSpecifier;if(!e.ts.isStringLiteral(c))return null;let p=await Jn(e,c.text);i.filePath=await Jn(e,c.text),i.relFilePath=e.relative(e.getAppRootDir(),i.filePath),await e.exists(p)?i.importPath=W(e,i.filePath):(i.externalImportPath=c.text,i.importPath=i.externalImportPath),i.name=G(r.text),i.importName=r.text,i.exportName=r.text,i.exportType="named"}return i=ge(e,i,o),i.displayFilePath=j(e,i.filePath),i.filePath&&i.exportName&&(i.id=await z(e,i.filePath,i.exportName,i.externalImportPath)),i}function Jn(e,t){return cr(e,e.normalize(e.resolve(e.dirname(e.registryPath),t)))}async function yp(e,t){let n=[],r=X(e,t,"CUSTOM_COMPONENTS");return r&&await Promise.all(r.arrayLiteralExp.elements.map(async(o,s)=>{let i=await Hn(e,t,o);i&&(i.nodeIndex=s,n.push(i))})),{sourceFile:t,components:fe(n)}}async function Hn(e,t,n){if(!e.ts.isObjectLiteralExpression(n))return null;let r={id:"",name:"",displayFilePath:"",exportName:"",importName:"",filePath:"",relFilePath:"",importPath:"",inputs:[],acceptsChildren:!1,framework:"react"};Mt(e,n)&&(r.acceptsChildren=!0);for(let s of n.properties){if(!e.ts.isPropertyAssignment(s)||!e.ts.isIdentifier(s.name))continue;if(K(e,s)==="component"){let a,{initializer:u}=s;if(e.ts.isIdentifier(u)&&(a=u.text),!a)continue;r.name===""&&(r.name=G(a)),r.importName=a;let l=await Ue(e,e.registryPath,t,a);if(!l)continue;r.filePath=l.filePath,r.relFilePath=l.relFilePath,await e.exists(l.filePath)?r.importPath=W(e,l.filePath):(r.externalImportPath=l.importPath,r.importPath=r.externalImportPath),r.displayFilePath=l.displayFilePath,r.exportType=l.exportType;let c=t.statements.filter(m=>e.ts.isImportDeclaration(m)),p=c.find(m=>m.importClause&&m.importClause.name?.text===a);if(p){let m=p.moduleSpecifier;if(!e.ts.isStringLiteral(m))return null;r.exportName="default"}else{let m=c.find(g=>!g.importClause||!g.importClause.namedBindings||!e.ts.isNamedImports(g.importClause.namedBindings)?!1:g.importClause.namedBindings.elements.some(f=>f.name.text===a));if(!m)return null;let D=m.moduleSpecifier;if(!e.ts.isStringLiteral(D))return null;r.exportName=a}continue}}return r=ge(e,r,n),r.filePath&&r.exportName&&(r.id=await z(e,r.filePath,r.exportName,r.externalImportPath)),r}async function Ye(e,t,n,r,o,s,i,a){let u=await ft(e),[l,c,p,m]=await Promise.all([ss(e,u),qs(e),ye(e),fr(e)]),D=l.map(F=>F.cmpInfo),g=c.components,f={components:Be(D,g),registryPath:e.registryPath,registryDisplayPath:j(e,e.registryPath),frameworks:e.getFrameworks(),dependencies:Ve(D),publicApiKey:m.envValue??void 0,devToolsVersion:e.version};if(a)return f.components=await Kt(e,f.components),f;let h=!1,d=c.sourceFile,y=Array.isArray(t)?t:typeof t=="string"?[t]:[];if(y.length>0){let F=y.map(E=>{let B=l.find(U=>U.cmpInfo.id===E);if(!B)throw new Error(`Component ${E} not found`);return B}),w=Array.from(new Set(F.map(E=>E.cmpInfo.filePath))),b=await Z(e,w);for(let E of F){let B=f.components.find(v=>v.id===E.cmpInfo.id),U=await zt(e,E,b,e.registryPath===E.cmpInfo.filePath||he(E.cmpInfo.filePath));we(B,U);let I=D.findIndex(v=>v.id===E.cmpInfo.id);D[I].inputs=U;let S=We(E.cmpInfo.id,D,g,n,r,o,s);if(e.sdkVersion===A.gen2){let{elements:v,elmIndex:ce,statementIndex:Te,statement:ie,variableDeclaration:V}=await Ep(e,d,E);if(S.addCmpToRegistry)v.push(Fp(e,S.addCmpToRegistry)),h=!0;else if(S.removeCmpFromRegistry)v.splice(ce,1),h=!0;else if(S.updateRegisteredCmp){let pe=ee(e,v[ce],S.updateRegisteredCmp),Et=e.ts.factory.createIdentifier(S.updateRegisteredCmp.importName);v[ce]=e.ts.factory.updateObjectLiteralExpression(pe,[e.ts.factory.createPropertyAssignment("component",Et),...pe.properties.slice(1)]),h=!0}if(h&&i){let pe=[...d.statements];pe[Te]=e.ts.factory.updateVariableStatement(ie,ie.modifiers,e.ts.factory.updateVariableDeclarationList(ie.declarationList,[e.ts.factory.updateVariableDeclaration(V,V.name,V.exclamationToken,V.type,e.ts.factory.createArrayLiteralExpression(ze(e,v)))])),d=e.ts.factory.updateSourceFile(d,pe),d=Js(e,S,d),d=O(e,d,{namedImports:["RegisteredComponent"],importPath:"@builder.io/sdk-react",isTypeOnly:!0}),d=qe(e,d,{variableName:"CUSTOM_COMPONENTS",arrayType:"RegisteredComponent"}),f.components=S.components,g=S.components.filter(Et=>Et.isRegistered)}}else{let v=[...d.statements];S.addCmpToRegistry?(v.push(Ws(e,S.addCmpToRegistry)),h=!0):S.removeCmpFromRegistry?(v.splice(S.nodeIndex,1),h=!0):S.updateRegisteredCmp&&(v[S.nodeIndex]=qn(e,v[S.nodeIndex],S.updateRegisteredCmp),h=!0),h&&i&&(d=e.ts.factory.updateSourceFile(d,v),d=O(e,d,{namedImports:["Builder","builder"],importPath:"@builder.io/react"}),d=Js(e,S,d),B?.acceptsChildren&&(d=O(e,d,{namedImports:["withChildren"],importPath:"@builder.io/react"})),f.components=S.components,g=S.components.filter(ce=>ce.isRegistered))}}}if(h&&i){d=Ge(e,d),d=Ke(e,d);let F=te(e,d);F=Re(F),F=await e.formatCode(e.registryPath,F),await e.writeFile(e.registryPath,F)}return f}async function Ep(e,t,n){let r=X(e,t,"CUSTOM_COMPONENTS");if(!r)throw new Error(`Exported name of the Builder registry must be "CUSTOM_COMPONENTS". Please update your Builder registry file: ${e.registryPath}`);let o=r.arrayLiteralExp.elements.filter(i=>e.ts.isObjectLiteralExpression(i)),s=-1;for(let i=0;i<o.length;i++)if((await Hn(e,t,o[i]))?.id===n.cmpInfo.id){s=i;break}return{...r,elements:o,elmIndex:s}}function Fp(e,t){let n=e.ts.factory.createIdentifier(t.importName);return ee(e,e.ts.factory.createObjectLiteralExpression([e.ts.factory.createPropertyAssignment("component",n),...t.acceptsChildren?[e.ts.factory.createPropertyAssignment("canHaveChildren",e.ts.factory.createTrue())]:[]],!0),t)}function Js(e,t,n){let r=t.addCmpToRegistry||t.updateRegisteredCmp;if(r){let o=r.externalImportPath?r.externalImportPath:_(e,e.registryPath,r.filePath);r.exportType==="default"?n=O(e,n,{defaultImport:r.importName,importPath:o}):r.exportType==="named"&&(n=O(e,n,{namedImports:[r.importName],importPath:o}))}return n}async function Hs(e){let t=[],n=await wp(e,t);if(await Xs(e,t,n),!await e.exists(e.builderComponentPath)){let r=await e.formatCode(e.builderComponentPath,Qs(e,e.builderComponentPath));await e.writeFile(e.builderComponentPath,r),t.push({filePath:e.builderComponentPath,modifiedType:"create"})}return t}async function Ys(e){let t=[];await Xs(e,t);let n=`figma-imports.${e.typescriptEnabled?"tsx":"jsx"}`,r=e.join(e.componentsDir,n);if(!await e.exists(r)){let o=await e.formatCode(r,Qs(e,r,"figma-imports"));await e.writeFile(r,o),t.push({filePath:r,modifiedType:"create"})}return t}function Qs(e,t,n="page"){let r=e.typescriptEnabled;return e.sdkVersion===A.gen2?`
  import React from "react";
  import {
      Content,
      fetchOneEntry,
      getBuilderSearchParams,
      isPreviewing,
    ${r?"type BuilderContent,":""}
    } from "@builder.io/sdk-react";
  import { CUSTOM_COMPONENTS } from ${JSON.stringify(_(e,t,e.registryPath))};

  // Builder Public API Key set in .env file
  const BUILDER_API_KEY = ${e.configType==="vite"?`import.meta.env.${gr};`:`${Gr};`}
  const MODEL_NAME = "${n}";

  export default function BuilderPage() {
  const [notFound, setNotFound] = React.useState(false);
  const [content, setContent] = React.useState${r?"<BuilderContent | null>":""}(null);
...
// Builder Public API Key set in .env file
${e.configType==="vite"?`builder.init(import.meta.env.${gr}${r?"!":""})`:`builder.init("${Gr}")`}
...
export default function BuilderPage() {
  ...
  return (
    <>
      {/* Render the Builder page */}
      <BuilderComponent model="${n}" content={content} />
    </>
  );
}
`.trimStart()}async function Xs(e,t,n){if(!await e.exists(e.registryPath)){if(e.sdkVersion===A.gen2){let s=Sp(e);await e.writeFile(e.registryPath,s)}else await e.writeFile(e.registryPath,"");t.push({filePath:e.registryPath,modifiedType:"create"})}if(!n)return;let o=(await Ye(e,null,!1,!1,null,null,!1,!1)).components.find(s=>s.filePath===n);o&&await Ye(e,o.id,!0,!1,null,null,!0,!1)}async function wp(e,t){let r=e.typescriptEnabled?"tsx":"jsx",o=e.join(e.componentsDir,"Counter"),s=e.join(o,`Counter.${r}`),i=e.join(o,"styles.module.css"),{component:a,styles:u}=bp(e);if(!await e.exists(s)){let l=await e.formatCode(s,a);await e.writeFile(s,l),t.push({filePath:s,modifiedType:"create"})}return await e.exists(i)||(await e.writeFile(i,u),t.push({filePath:i,modifiedType:"create"})),s}function bp(e){let t=e.typescriptEnabled,n=`
"use client"
import React, { useState } from "react";
import styles from "./styles.module.css";
${t?`
...
`.trimStart();return{component:n,styles:r}}function Sp(e){return e.typescriptEnabled?`import type { RegisteredComponent } from "@builder.io/sdk-react";
    
export const CUSTOM_COMPONENTS: RegisteredComponent[] = [
];`:`export const CUSTOM_COMPONENTS = [
  ];
  `}async function Zs(e){let t=await vp(e);return{builderPageOptions:async()=>({templateContentId:"2e36438034894a8abf279ea9e6d3596f",pathname:"/builder-demo",title:"Builder + React Demo Page"}),ensureBuilderSetup:()=>Hs(t),ensureFigmaImportPage:()=>Ys(t),getRegistryPath:()=>t.registryPath,getRegistry:r=>Ye(t,null,!1,!1,null,null,!1,!!r?.readAllInputTypes),addExternalPackage:r=>{t.addExternalPackage(r)},loadComponent:async r=>{let o=await Ye(t,r.cmpId,!1,!1,null,null,!1,!1);return{...o,component:o.components.find(s=>s.id===r.cmpId)}},registerComponent:r=>Ye(t,r.cmpId,!0,!1,null,null,!0,!1),setRegisteredComponentInfo:r=>Ye(t,r.cmpId,!1,!1,r,null,!0,!1),setRegisteredComponentInput:r=>Ye(t,r.cmpId,!1,!1,null,r,!0,!1),unregisterComponent:r=>Ye(t,r.cmpId,!1,!0,null,null,!0,!1),getPublicApiKey:()=>fr(t),setPublicApiKey:r=>Gs(t,r.publicApiKey),getDependencies:r=>r.sdkVersion===A.gen2?[{name:"@builder.io/dev-tools"},{name:"@builder.io/sdk-react"}]:[{name:"@builder.io/dev-tools"},{name:"@builder.io/react"},{name:"@builder.io/sdk"}],getDevRunCommand:()=>"dev",getCache:()=>_e(t),setCache:r=>je(t,r)}}async function vp(e){let t=await Ap(e),n=e.getAppRootDir(),r=e.join(n,"src"),o=await ye(e),s={},i={...e,srcDir:null,builderComponentPath:"",componentsDir:"",registryPath:"",reactConfigPath:t,typescriptEnabled:o,configType:"",addExternalPackage:a=>{s[e.join(n,a,"index.ts")]=`export * from "${a}";`},readFileSync:a=>s[a]??e.readFileSync(a),existsSync:a=>!!s[a]||e.existsSync(a),readdirSync:a=>{let u=e.readdirSync(a);return a===n?[...u,...Object.keys(s).map(l=>l.slice(n.length+1))]:u},readdir:async a=>{let u=await e.readdir(a);return a===n?[...u,...Object.keys(s).map(l=>l.slice(n.length+1))]:u}};return e.sdkVersion?i.sdkVersion=e.sdkVersion:i.sdkVersion=await Wt(i),t.includes("webpack.config")&&(i.configType="webpack"),t.includes("vite.config")&&(i.configType="vite"),await e.exists(r)?(i.srcDir=r,i.componentsDir=e.join(r,"components"),i.registryPath=await Se(e,r),i.builderComponentPath=e.join(i.srcDir,`builder-page.${o?"tsx":"jsx"}`)):(i.componentsDir=e.join(n,"components"),i.registryPath=await Se(e,n),i.builderComponentPath=e.join(n,`builder-page.${o?"tsx":"jsx"}`)),i}async function Ap(e){let t=["vite.config.ts","vite.config.js","webpack.config.js","webpack.config.ts"];for(let n of t){let r=e.join(e.getAppRootDir(),n);if(await e.exists(r))return r}if(e.ignoreMissingConfig)return"";throw new Error(`Could not find React config file. Searched for ${t.join(", ")} in "${e.getAppRootDir()}".`)}async function Dr(e){return await Pp(e,["environment.ts"],Wr)}async function ea(e,t){let n=await Dr(e),r=await Bp(e,n.file,n.envKey,t);return{...n,modifiedType:r}}async function Pp(e,t,n){let r={envKey:n,envValue:null,file:""};for(let o of t){let s=e.join(e.getAppRootDir(),"src","environments",o),i=await Tp(e,s);if(typeof i=="string"&&i.length>0&&i!=="YOUR_API_KEY")return r.envValue=i,r.file=s,r}return r.file=e.join(e.getAppRootDir(),"src","environments",t[t.length-1]),r}async function Tp(e,t){let n=await e.readFile(t);return n?Ip(e,n):""}function Ip(e,t){let n=N(e,t),r="",s=Ut(e,n,"environment");if(s&&s.statement.declarationList.declarations.length>0){let a=s.statement.declarationList.declarations[0].initializer;a&&e.ts.isObjectLiteralExpression(a)&&a.properties.forEach(u=>{e.ts.isPropertyAssignment(u)&&e.ts.isIdentifier(u.name)&&u.name.text===Wr&&e.ts.isStringLiteral(u.initializer)&&(r=u.initializer.text)})}return r}async function Rp(e,t,n,r){let o=N(e,t),i=Ut(e,o,"environment");if(i&&i.statement.declarationList.declarations.length>0){let a=i.statement.declarationList,u=a.declarations[0],l=u.initializer;if(l&&e.ts.isObjectLiteralExpression(l)){let c=e.ts.factory.createPropertyAssignment(e.ts.factory.createIdentifier(n),e.ts.factory.createStringLiteral(r)),p=e.ts.factory.createNodeArray([...l.properties,c]),m=e.ts.factory.updateObjectLiteralExpression(l,p),D=e.ts.factory.updateVariableDeclaration(u,u.name,u.exclamationToken,u.type,m),g=e.ts.factory.updateVariableDeclarationList(a,[D]);return e.ts.factory.updateVariableStatement(i.statement,i.statement.modifiers,g)}return null}return null}async function Bp(e,t,n,r){let o=await e.readFile(t);if(o)if(o.includes(n))e.debug(`"${n}" already set in ${t}`);else{e.debug(`Add "${n}" to ${t}`);let s=await Rp(e,o,n,r);if(s){let i=te(e,s),a=await e.formatCode(t,i);await e.writeFile(t,a)}return"update"}else{e.debug(`Creating new env file with "${n}" at ${t}`);let s=`
    // https://www.builder.io/c/docs/using-your-api-key
    export const environment = {
      production: false,
      builderApiKey: "${r}",
    };
    `.trimStart(),i=await e.formatCode(t,s);return await e.writeFile(t,i),"create"}return null}var Wr="builderApiKey";async function ra(e,t){let n=[],r=t.getSourceFiles(),o=t.getTypeChecker();return await Promise.all(r.map(async s=>{let i=e.basename(s.fileName);if($p(e,s.fileName)||i.startsWith(".")||i==="node_modules"||kp.has(i))return;let a=e.normalize(s.fileName);if(a===e.registryPath)return;let u=await qr(e,o,a,s);n.push(...u)})),n.sort((s,i)=>s.cmpInfo.name.localeCompare(i.cmpInfo.name))}var kp=new Set([]),Np=new Set(["node_modules"]);function $p(e,t){for(let n of Np)if(e.dirname(t).includes(n))return!0;return!1}async function na(e,t){let n=e.extname(t).toLowerCase();if(n===".tsx"||n===".jsx"||n===".ts"||n===".js"){let r=await e.readFile(t);if(r)return Op(e,t,r)}return null}function Op(e,t,n){let r=N(e,n);return qr(e,null,t,r)}async function qr(e,t,n,r){let o=[],s={};n=e.normalize(n);let i=r.statements.filter(c=>e.ts.isClassDeclaration(c)&&Up(e,c)),a=r.statements.find(c=>e.ts.isImportDeclaration(c)&&e.ts.isStringLiteral(c.moduleSpecifier)&&c.moduleSpecifier.text==="@angular/core");if(a&&e.ts.isImportDeclaration(a)){let c=a.importClause?.namedBindings;if(c&&e.ts.isNamedImports(c)){let p=c.elements.find(m=>(m.propertyName??m.name).text==="input");p&&(s.inputSignalImportName=p.name.text)}}let u=await _p(e,t,n,r),l=Vp(e,r);return await Promise.all(i.map(async c=>{let p=await Lp(e,t,n,c,l,s);o.push(...p)})),o.push(...u),o}async function Yn(e,t,n){if(t.node.fnNode){let{sourceFile:r,typeChecker:o}=await Nt(e,t.cmpInfo.filePath,n),i=(await qr(e,o,t.cmpInfo.filePath,r)).find(a=>a.cmpInfo.id===t.cmpInfo.id);if(!i)throw new Error(`Could not find component ${t.cmpInfo.name} in ${t.cmpInfo.filePath}`);return i.cmpInfo.inputs}return[]}async function ia(e,t,n){let r=await Z(e,n.map(i=>i.filePath)),o=r.getTypeChecker();return await Promise.all(n.filter(i=>!(i.name.endsWith("Page")||i.name.endsWith("Module")||i.name==="AppComponent")).map(async i=>{if(!i.isRegistered){let a=r.getSourceFile(i.filePath);if(a){let l=(await qr(e,o,i.filePath,a)).find(c=>c.cmpInfo.id===i.id);if(l){i.inputs=St(e,o,l.node.fnNode);let c=t.find(p=>p.cmpInfo.id===i.id);if(c){let p=await Yn(e,c,r);we(i,p)}}}}return i}))}async function Lp(e,t,n,r,o,s){let i=[],a=e.relative(e.getAppRootDir(),n),u=W(e,n),l=r.name?.text;if(!l)return i;let c=!1;r.modifiers&&(c=r.modifiers.some(g=>g.kind===e.ts.SyntaxKind.DefaultKeyword));let p=c?"default":l,m=c?"default":"named",D=[];return r.members.forEach(g=>{if(e.ts.isPropertyDeclaration(g)||e.ts.isGetAccessor(g)||e.ts.isSetAccessor(g)){let d=(e.ts.getDecorators(g)??[]).find(F=>jp(e,F))!==void 0&&e.ts.isIdentifier(g.name),y=s?.inputSignalImportName!==void 0&&e.ts.isIdentifier(g.name)&&Mp(e,g,s.inputSignalImportName);if(d||y){let F="any";if(e.ts.isSetAccessor(g))F=ta(e,g.parameters[0].type);else if(g.type&&t){let b=t.getTypeAtLocation(g.type);F=t.typeToString(b)}else F=ta(e,g.type);let w={name:g.name.text,type:o[F]?"string":F};o[F]&&(w.enum=o[F]),D.push(w)}}}),i.push({cmpInfo:{id:await z(e,n,l),displayFilePath:j(e,n),name:G(l),inputs:D,exportName:p,exportType:m,importName:l,filePath:n,relFilePath:a,importPath:u,meta:{...zp(e,r)},framework:"angular"},node:{name:l,fnNode:r,deps:void 0}}),i}async function _p(e,t,n,r){let o=[],s=e.relative(e.getAppRootDir(),n),i=W(e,n);for(let a of r.statements)if(e.ts.isExportDeclaration(a)&&a.exportClause&&e.ts.isNamedExports(a.exportClause))for(let u of a.exportClause.elements){let l=u.name?.text;if(!l)continue;let c=l,p="named",m=[];if(t){let f=t.getSymbolAtLocation(u.name);if(f){let h=t.getDeclaredTypeOfSymbol(f);t.getPropertiesOfType(h).forEach(y=>{let F=y.getDeclarations();F&&F.forEach(w=>{if(e.ts.isPropertyDeclaration(w)){let b=t.getTypeAtLocation(w),E={name:y.getName(),type:Kp(e,t,b)};m.push(E)}})})}}let D=e.ts.isExportSpecifier(u)&&u.parent?u.parent.parent:void 0,g;if(D){let f=D.moduleSpecifier;if(f&&e.ts.isStringLiteral(f)){let h=t?.getSymbolAtLocation(f);if(h&&h.declarations&&h.declarations.length>0){let d=h.declarations[0];(!e.ts.isSourceFile(d)||e.ts.isSourceFile(d)&&d.fileName.includes("node_modules"))&&(g=f.text)}}}o.push({cmpInfo:{id:await z(e,n,l,g),displayFilePath:j(e,n),name:G(l),inputs:m,exportName:c,exportType:p,importName:l,filePath:n,relFilePath:s,importPath:g||i,externalImportPath:g,framework:"angular"},node:{name:l,fnNode:u,deps:void 0}})}else if(e.ts.isExportDeclaration(a)&&!a.exportClause&&a.moduleSpecifier&&e.ts.isStringLiteral(a.moduleSpecifier)){let u=a.moduleSpecifier.text;if(t)try{let l=t.getSymbolAtLocation(a.moduleSpecifier);if(l&&l.exports){let c=t.getExportsOfModule(l);for(let p of c)if(p.flags&e.ts.SymbolFlags.Class){let m=p.getName();if(m.startsWith("_"))continue;o.push({cmpInfo:{id:await z(e,n,m,u),displayFilePath:j(e,n),name:G(m),inputs:[],exportName:m,exportType:"named",importName:m,filePath:n,relFilePath:s,importPath:u,externalImportPath:u,framework:"angular"},node:{name:m,fnNode:a,deps:void 0}})}}}catch(l){console.warn(`Error processing star export from ${u}:`,l)}}return o}function jp(e,t){return oa(e,t,"Input")}function Mp(e,t,n){return e.ts.isPropertyDeclaration(t)&&t.initializer!==void 0&&e.ts.isCallExpression(t.initializer)&&e.ts.isIdentifier(t.initializer.expression)&&t.initializer.expression.text===n}function oa(e,t,n){if(e.ts.isCallExpression(t.expression)){let r=t.expression;if(e.ts.isIdentifier(r.expression))return r.expression?.text===n}return!1}function Up(e,t){return!!e.ts.getDecorators(t)?.some(o=>e.ts.isCallExpression(o.expression)&&e.ts.isIdentifier(o.expression.expression)&&o.expression.expression.text==="Component")}function ta(e,t){if(!t)return"any";let n="any";switch(t.kind){case e.ts.SyntaxKind.StringKeyword:n="string";break;case e.ts.SyntaxKind.NumberKeyword:n="number";break;case e.ts.SyntaxKind.BooleanKeyword:n="boolean";break;case e.ts.SyntaxKind.TypeReference:e.ts.isTypeReferenceNode(t)&&e.ts.isIdentifier(t.typeName)&&(n=t.typeName.text);break}return n.includes("|")?"string":n}function Vp(e,t){let n={};return e.ts.forEachChild(t,r=>{e.ts.isTypeAliasDeclaration(r)&&e.ts.isUnionTypeNode(r.type)&&r.type.types.every(o=>e.ts.isLiteralTypeNode(o)&&e.ts.isStringLiteral(o.literal))&&(n[r.name.text]=r.type.types.map(o=>o.literal.text))}),n}function Kp(e,t,n){let r=t.typeToString(n);if(r==="any"){let o=n.getSymbol();if(o){let s=o.getDeclarations();if(s&&s.length>0){let i=s[0];if(e.ts.isVariableDeclaration(i)){let a=i.type;a&&(r=t.typeToString(t.getTypeAtLocation(a)))}}}}return r}function zp(e,t){let{getDecorators:n,isCallExpression:r,isIdentifier:o,isObjectLiteralExpression:s,isPropertyAssignment:i,isStringLiteral:a,SyntaxKind:u}=e.ts,l,c;return n(t)?.forEach(m=>{if(oa(e,m,"Component")){let{expression:D}=m;if(r(D)){let[g]=D.arguments;s(g)&&g.properties.forEach(f=>{i(f)&&o(f.name)&&(f.name.escapedText==="selector"&&a(f.initializer)&&(l=f.initializer.text),f.name.escapedText==="standalone"&&(c=f.initializer.kind===u.TrueKeyword))})}}}),{selector:l,standalone:c}}async function Jr(e,t,n){let r=e.typescriptEnabled?".ts":".js",o=`app.module${r}`,s=e.join(e.appDir,o),i=await e.readFile(s);if(!i){e.Sentry?.captureException(new Error(`Unable to read app.module.${r} at ${s}`),{extra:{appModuleCode:i,appModulePath:s}});return}let a=await Gp(e,s,t,n,i);if(!a){e.Sentry?.captureException(new Error(`Unable to update app.module.${r} at ${s}`),{extra:{appModuleCode:i,appModulePath:s}});return}return await e.writeFile(s,a),s}async function Gp(e,t,n,r,o){let s=o,i=N(e,o),a=_(e,t,r);i=O(e,i,{namedImports:[n],importPath:a}),i=O(e,i,{namedImports:["Content"],importPath:"@builder.io/sdk-angular"});let u=[];for(let l of i.statements)if(e.ts.isClassDeclaration(l)&&l.name?.text==="AppModule"){let c=Wp(e,n,l);u.push(c)}else u.push(l);return i=e.ts.factory.updateSourceFile(i,u),s=te(e,i),s}function Wp(e,t,n){let r=e.ts.getDecorators(n);if(r){for(let o of r)if(e.ts.isCallExpression(o.expression)&&e.ts.isIdentifier(o.expression.expression)&&o.expression.expression.text==="NgModule"){let s=o.expression.arguments;if(s.length===1&&e.ts.isObjectLiteralExpression(s[0])){let i=sa(e,s[0],"declarations",t);if(i){let a=sa(e,i,"imports","Content");if(a&&(i=a),i){let u=e.ts.factory.updateDecorator(o,e.ts.factory.updateCallExpression(o.expression,o.expression.expression,o.expression.typeArguments,[i])),c=[...r.map(p=>p===o?u:p),...e.ts.getModifiers(n)||[]];return e.ts.factory.updateClassDeclaration(n,c,n.name,n.typeParameters,n.heritageClauses,n.members)}}}}}return n}function sa(e,t,n,r){let o=[...t.properties],s=o.findIndex(a=>K(e,a)===n);if(s>-1){let a=o[s];if(e.ts.isPropertyAssignment(a)&&a.initializer&&e.ts.isArrayLiteralExpression(a.initializer)){let u=aa(e,a.initializer,r);return u?(o[s]=e.ts.factory.updatePropertyAssignment(a,a.name,u),e.ts.factory.updateObjectLiteralExpression(t,o)):null}return null}let i=aa(e,e.ts.factory.createArrayLiteralExpression([],!0),r);return i?e.ts.factory.updateObjectLiteralExpression(t,[...o,e.ts.factory.createPropertyAssignment(n,i)]):null}function aa(e,t,n){return t.elements.some(o=>e.ts.isIdentifier(o)?o.text===n:!1)?null:e.ts.factory.updateArrayLiteralExpression(t,[...t.elements,e.ts.factory.createIdentifier(n)])}async function Qn(e,t,n,r){let s=`app.routes${e.typescriptEnabled?".ts":".js"}`,i=e.join(e.appDir,s);try{if(e.magicast){let a=await e.magicast.loadFile(i);Object.keys(a.exports).length===0&&(a.exports.routes=[]);let l=Object.keys(a.exports)[0],c=a.exports[l];if(c.find(m=>m.path===t))return;let p=e.magicast.builders.raw("{}");if(p.path=t,p.component=e.magicast.builders.raw(n),c.push(p),a.imports.$items.find(m=>m.imported===n))return;a.imports.$append({imported:n,from:r}),await e.magicast.writeFile(a,i)}}catch(a){let u=null;try{u=e.readFileSync(i)}catch(l){e.Sentry?.captureException(l,{level:"warning"})}e.Sentry?.captureException(a,{extra:{content:u,appRoutesPath:i,componentName:n,componentPath:r}})}}var xa=T(Ca(),1);async function ya(e){let t=e.ts.findConfigFile(e.getAppRootDir(),e.existsSync);if(t){let n=await e.readFile(t);if(!n)return;let r=xa.default.parse(n);if(!r||typeof r!="object"||Array.isArray(r))return;let o=r.compilerOptions;if(!o||typeof o!="object"||Array.isArray(o))return;let s=o.paths;(!s||typeof s!="object"||Array.isArray(s))&&(o.paths={},s=o.paths),Object.assign(o.paths,{"~/*":["./src/*"]}),await e.writeFile(t,JSON.stringify(r,null,2))}}async function Ea(e){let t=[],n=await nm(e,t);t.push(...await Zr(e)),await tm(e,n);let r="BuilderPage";if(!await e.exists(e.builderPageComponentPath)){let o=await e.formatCode(e.builderPageComponentPath,wa(e,r,e.builderPageComponentPath,"builder-page","page",!0));await e.writeFile(e.builderPageComponentPath,o),t.push({filePath:e.builderPageComponentPath,modifiedType:"create"})}if(e.hasAppModule){await Jr(e,"Counter",n);let o=await Jr(e,r,e.builderPageComponentPath);o&&t.push({filePath:o,modifiedType:"update"})}return await Qn(e,"**",r,"./components/builder-page.component"),t}async function Fa(e){let t=[];t.push(...await Zr(e));let n="FigmaImportsPage",r="figma-imports.component",o=e.join(e.componentsDir,`${r}.${e.typescriptEnabled?"ts":"js"}`);if(!await e.exists(o)){let s=await e.formatCode(o,wa(e,n,o,"figma-imports","figma-imports",!1));await e.writeFile(o,s),t.push({filePath:o,modifiedType:"create"})}if(e.hasAppModule){let s=await Jr(e,n,o);s&&t.push({filePath:s,modifiedType:"update"})}return await Qn(e,"figma-imports",n,`./components/${r}`),await ya(e),t}async function Zr(e){let t=[];return await e.exists(e.registryPath)||(await e.writeFile(e.registryPath,rm(e)),t.push({filePath:e.registryPath,modifiedType:"create"})),t}async function tm(e,t){let r=(await Qe(e,null,!1,!1,null,null,!1,!1)).components.find(o=>o.filePath===t);r&&await Qe(e,r.id,!0,!1,null,null,!0,!1)}function wa(e,t,n,r,o,s){let i=!e.hasAppModule,a=_(e,n,e.registryPath),u=e.join(e.getAppRootDir(),"src","environments","environment.ts"),l=_(e,n,u),c=s?`    <ng-container *ngIf="content || isPreviewing; else notFound">
      <builder-content
        [model]="model"
        [content]="content"
        [apiKey]="apiKey"
...
`}
  ...
  `.trimStart()}function rm(e){return e.typescriptEnabled?`import type { RegisteredComponent } from "@builder.io/sdk-angular";
    
export const CUSTOM_COMPONENTS: RegisteredComponent[] = [
];`:`export const CUSTOM_COMPONENTS = [
  ];
  `}async function nm(e,t){let r=e.typescriptEnabled?"ts":"js",o=e.join(e.componentsDir,`counter.component.${r}`),s=await e.exists(o);e.debug(`angularEnsureCounterComponent, hasCounterCmp: ${s}`);let i=im(e);if(!s){let a=await e.formatCode(o,i);await e.writeFile(o,a),t.push({filePath:o,modifiedType:"create"})}return o}function im(e){return`
import { Component, Input } from '@angular/core';
...
`.trimStart()}async function ba(e){await Zr(e);let t=await e.readFile(e.registryPath);return t?om(e,t):{components:[],sourceFile:N(e,"")}}async function om(e,t){let n=N(e,t);return sm(e,n)}async function sm(e,t){let n=[],r=X(e,t,"CUSTOM_COMPONENTS");return r&&await Promise.all(r.arrayLiteralExp.elements.map(async(o,s)=>{let i=await si(e,t,o);i&&(i.nodeIndex=s,n.push(i))})),{sourceFile:t,components:fe(n)}}async function si(e,t,n){if(!e.ts.isObjectLiteralExpression(n))return null;let r={id:"",name:"",displayFilePath:"",exportName:"",importName:"",filePath:"",relFilePath:"",importPath:"",inputs:[],framework:"angular"};for(let o of n.properties){if(!e.ts.isPropertyAssignment(o)||!e.ts.isIdentifier(o.name))continue;if(K(e,o)==="component"){let i,{initializer:a}=o;if(e.ts.isIdentifier(a))i=a.text;else if(e.ts.isCallExpression(a)){let l=a.arguments[0];e.ts.isIdentifier(l)&&(i=l.text)}if(!i)continue;r.name===""&&(r.name=G(i)),r.importName=i;let u=await Ue(e,e.registryPath,t,i);if(!u)continue;if(r.filePath=u.filePath,r.relFilePath=u.relFilePath,await e.exists(u.filePath)?r.importPath=W(e,u.filePath):(r.externalImportPath=u.importPath,r.importPath=r.externalImportPath),r.displayFilePath=u.displayFilePath,r.exportType=u.exportType,r.externalImportPath)r.exportName=i;else{let l=await na(e,u.filePath);if(l&&l.length>0)if(l.length===1)r.exportName=l[0].cmpInfo.exportName;else{let c=l.find(p=>p.cmpInfo.exportName===i);c&&(r.exportName=c.cmpInfo.exportName)}}continue}}return r=ge(e,r,n),r.filePath&&r.exportName&&(r.id=await z(e,r.filePath,r.exportName,r.externalImportPath)),r}async function Qe(e,t,n,r,o,s,i,a){let u=await ft(e),[l,c,p]=await Promise.all([ra(e,u),ba(e),Dr(e)]),m=l.map(y=>y.cmpInfo),D=c.components,g={components:Be(m,D),registryPath:e.registryPath,registryDisplayPath:j(e,e.registryPath),frameworks:e.getFrameworks(),dependencies:Ve(m),publicApiKey:p.envValue??void 0,devToolsVersion:e.version};if(a)return g.components=await ia(e,l,g.components),g;let f=!1,h=c.sourceFile,d=Array.isArray(t)?t:typeof t=="string"?[t]:[];if(d.length>0){let y=d.map(b=>{let E=l.find(B=>B.cmpInfo.id===b);if(!E)throw new Error(`Component ${b} not found`);return E}),F=Array.from(new Set(y.map(b=>b.cmpInfo.filePath))),w=await Z(e,F);for(let b of y){let E=g.components.find(V=>V.id===b.cmpInfo.id),B=await Yn(e,b,w);we(E,B);let U=m.findIndex(V=>V.id===b.cmpInfo.id);m[U].inputs=B;let I=We(b.cmpInfo.id,m,D,n,r,o,s),{elements:S,elmIndex:v,statementIndex:ce,statement:Te,variableDeclaration:ie}=await um(e,h,b);if(I.addCmpToRegistry)S.push(am(e,I.addCmpToRegistry)),f=!0;else if(I.removeCmpFromRegistry)S.splice(v,1),f=!0;else if(I.updateRegisteredCmp){let V=ee(e,S[v],I.updateRegisteredCmp);S[v]=e.ts.factory.updateObjectLiteralExpression(V,[Sa(e,I.updateRegisteredCmp),...V.properties.slice(1)]),f=!0}if(f&&i){let V=[...h.statements];V[ce]=e.ts.factory.updateVariableStatement(Te,Te.modifiers,e.ts.factory.updateVariableDeclarationList(Te.declarationList,[e.ts.factory.updateVariableDeclaration(ie,ie.name,ie.exclamationToken,ie.type,e.ts.factory.createArrayLiteralExpression(ze(e,S)))])),h=e.ts.factory.updateSourceFile(h,V),E.exportType==="named"?h=O(e,h,{namedImports:[E.importName],importPath:E.externalImportPath?E.externalImportPath:_(e,e.registryPath,E.filePath)}):h=O(e,h,{defaultImport:E.importName,importPath:E.externalImportPath?E.externalImportPath:_(e,e.registryPath,E.filePath)}),h=O(e,h,{namedImports:["RegisteredComponent"],importPath:"@builder.io/sdk-angular",isTypeOnly:!0}),h=qe(e,h,{variableName:"CUSTOM_COMPONENTS",arrayType:"RegisteredComponent"}),g.components=I.components,D=I.components.filter(pe=>pe.isRegistered)}}}if(f&&i){h=Ge(e,h),h=Ke(e,h);let y=te(e,h);y=Re(y),y=await e.formatCode(e.registryPath,y),await e.writeFile(e.registryPath,y)}return g}function Sa(e,t){let n=e.ts.factory.createIdentifier(t.importName);return e.ts.factory.createPropertyAssignment("component",n)}function am(e,t){return ee(e,e.ts.factory.createObjectLiteralExpression([Sa(e,t)],!0),t)}async function um(e,t,n){let r=X(e,t,"CUSTOM_COMPONENTS");if(!r)throw new Error(`Exported name of the Builder registry must be "CUSTOM_COMPONENTS". Please update your Builder registry file: ${e.registryPath}`);let o=r.arrayLiteralExp.elements.filter(i=>e.ts.isObjectLiteralExpression(i)),s=-1;for(let i=0;i<o.length;i++)if((await si(e,t,o[i]))?.id===n.cmpInfo.id){s=i;break}return{...r,elements:o,elmIndex:s}}async function va(e){let t=await lm(e);return{builderPageOptions:async()=>({templateContentId:"f0b8016ac92e474699293211a268ebaa",pathname:"/builder-demo",title:"Builder + Angular Demo Page"}),ensureBuilderSetup:()=>Ea(t),ensureFigmaImportPage:()=>Fa(t),getRegistryPath:()=>t.registryPath,getRegistry:r=>Qe(t,null,!1,!1,null,null,!1,!!r?.readAllInputTypes),addExternalPackage:async r=>{t.addExternalPackage(r)},loadComponent:async r=>{let o=await Qe(t,r.cmpId,!1,!1,null,null,!1,!1);return{...o,component:o.components.find(s=>s.id===r.cmpId)}},registerComponent:r=>Qe(t,r.cmpId,!0,!1,null,null,!0,!1),setRegisteredComponentInfo:r=>Qe(t,r.cmpId,!1,!1,r,null,!0,!1),setRegisteredComponentInput:r=>Qe(t,r.cmpId,!1,!1,null,r,!0,!1),unregisterComponent:r=>Qe(t,r.cmpId,!1,!0,null,null,!0,!1),getPublicApiKey:()=>Dr(t),setPublicApiKey:r=>ea(t,r.publicApiKey),getDependencies:r=>[{name:"@builder.io/dev-tools"},{name:"@builder.io/sdk-angular"},{name:"concurrently"}],getDevRunCommand:()=>"builder-dev",getCache:()=>_e(t),setCache:r=>je(t,r)}}async function lm(e){let t=await cm(e),n=e.getAppRootDir(),r=e.join(n,"src"),o=await ye(e),s=e.join(r,"app"),i=await Se(e,s),a={},u={...e,srcDir:"",appDir:"",componentsDir:"",registryPath:i,angularConfigPath:t,typescriptEnabled:o,builderPageComponentPath:"",hasAppModule:!1,addExternalPackage:p=>{a[e.join(n,p,"index.ts")]=`export * from "${p}";`},readFileSync:p=>a[p]??e.readFileSync(p),existsSync:p=>!!a[p]||e.existsSync(p),readdirSync:p=>{let m=e.readdirSync(p);return p===n?[...m,...Object.keys(a).map(D=>D.slice(n.length+1))]:m},readdir:async p=>{let m=await e.readdir(p);return p===n?[...m,...Object.keys(a).map(D=>D.slice(n.length+1))]:m}};if(!await e.exists(r))throw new Error(`Could not find src directory. Searched for src in "${e.getAppRootDir()}".`);u.srcDir=r,u.appDir=s,u.componentsDir=e.join(u.appDir,"components"),u.builderPageComponentPath=e.join(u.componentsDir,`builder-page.component.${o?"ts":"js"}`);let l=`app.module.${o?"ts":"js"}`,c=e.join(u.appDir,l);return await e.exists(c)&&(u.hasAppModule=!0),u}async function cm(e){let t=e.join(e.getAppRootDir(),"angular.json");if(await e.exists(t))return t;let n=e.join(e.getAppRootDir(),"project.json");if(await e.exists(n))return n;if(e.ignoreMissingConfig)return"";throw new Error(`Could not find Angular config file. Searched for angular.json & project.json in "${e.getAppRootDir()}".`)}var nn=T(ja(),1);async function Ma(e,t){let r={components:(await t.getRegistry()).components.filter(s=>s.isRegistered).map(s=>{let i={filePath:Ie(e.relative(e.getAppRootDir(),s.filePath)),name:s.name,image:s.image,description:s.description,exportName:s.exportName,inputs:Ce(s.inputs)};return Ce(i)}),version:1};e.debug("exporting registry components:",r.components.length);let o=(0,nn.compress)(r);return btoa(JSON.stringify(o))}async function Ua(e,t,n){if(typeof n!="string")throw new Error("Invalid registry to import");let r=await t.getRegistry(),o=JSON.parse(atob(n)),s=(0,nn.decompress)(o),i=Ce(r);e.debug("importing registry components:",s.components.length);for(let a of s.components){let u=Ie(e.normalize(a.filePath)),l=r.components.find(p=>Ie(p.filePath).endsWith(u)&&p.exportName===a.exportName);if(!l){console.error(`Could not find component to register: ${a.filePath}, ${a.exportName}`);continue}e.debug(`register (${l.id})`,l.filePath),await t.registerComponent({cmpId:l.id});for(let p of a.inputs)e.debug(`set input (${l.id})`),await t.setRegisteredComponentInput({cmpId:l.id,name:p.name,type:p.type,required:p.required,defaultValue:p.defaultValue,friendlyName:p.friendlyName,helperText:p.helperText});e.debug(`set input (${l.id}) info`);let c=await t.setRegisteredComponentInfo({cmpId:l.id,name:a.name,image:a.image,description:a.description});i=Ce(c)}return i}var Ne={react:"react",remix:"remix",angular:"angular",next:"next",qwik:"qwik"},mx={[Ne.react]:[{version:A.gen1,recommended:!0},{version:A.gen2,recommended:!1}],[Ne.remix]:[{version:A.gen1,recommended:!1},{version:A.gen2,recommended:!0}],[Ne.angular]:[{version:A.gen2,recommended:!0}],[Ne.next]:[{version:A.gen1,recommended:!0},{version:A.gen2,recommended:!1}],[Ne.qwik]:[{version:A.gen2,recommended:!0}]};async function Va(e,t){let n=[],r=new Set;async function o(s){let i=e.join(s,"package.json");try{if(!await e.exists(i))return null;let u=await e.readFile(i);if(u===null)throw new Error(`Failed to read package.json at ${i}`);let l=JSON.parse(u);if(r.has(l.name))return null;r.add(l.name);let c={name:l.name,subPackages:[]},p=await e.readdir(s);for(let m of p)m!=="node_modules"&&(await e.stat(e.join(s,m))).isDirectory()&&c.subPackages.push(m);return n.push(c),c}catch(a){return e.Sentry?.captureException(a,{level:"warning"}),null}}try{let s=e.join(t,"package.json");if(await e.exists(s)){let a=await e.readFile(s);if(a!==null){let u=JSON.parse(a),l={...u.dependencies,...u.devDependencies};for(let c of Object.keys(l)){let p=e.join(t,"node_modules",c);await o(p)}if(Array.isArray(u.workspaces))for(let c of u.workspaces){let p=await e.readdir(e.join(t,c));for(let m of p){let D=e.join(t,c,m);await o(D)}}}}}catch(s){e.Sentry?.captureException(s,{level:"warning"})}return n}var Nm={"@builder.io/qwik-city":Os,next:Ss,"@remix-run/react":zs,react:Zs,"@angular/core":va},$m={"@builder.io/qwik-city":Ne.qwik,next:Ne.next,"@remix-run/react":Ne.remix,react:Ne.react,"@angular/core":Ne.angular};async function on(e){if(!e.ts)throw new Error("createDevTools() requires a TypeScript instance passed to the 'ts' option");if((!e.frameworks||e.frameworks.length===0)&&(e.frameworks=await $t(e)),e.frameworks.length===0)throw new Error("Supported Devtools framework for not found");for(let t of e.frameworks){let n=Nm[t.name];if(n)try{let r=await n(e);return{...r,exportRegistry:()=>Ma(e,r),importRegistry:s=>Ua(e,r,s),framework:$m[t.name],findAllDependencies:async()=>await Va(e,e.getRepoRootDir())}}catch(r){e.Sentry?.captureException(r,{level:"warning"})}}throw new Error(`Devtools framework not found for ${e.getAppRootDir()}, ${JSON.stringify(e.frameworks,null,2)}`)}var ay=`
/** @type {import('next').NextConfig} */
const nextConfig = {
}
 
module.exports = nextConfig
`.trimStart();var Ka=T(require("@sentry/node"),1),za=T(require("@amplitude/analytics-node"),1);async function at(e){if(process.env.NODE_ENV!=="test")try{await Promise.allSettled([Ka.flush(2e3),za.flush().promise])}catch(t){console.error(t)}process.exit(e)}var Er=process.env.AIR_HOST||"https://ai.builder.io";var Ht=T(require("@amplitude/analytics-node"),1),Fr=T(require("@sentry/node"),1);var se=[];for(let e=0;e<256;++e)se.push((e+256).toString(16).slice(1));function Ga(e,t=0){return(se[e[t+0]]+se[e[t+1]]+se[e[t+2]]+se[e[t+3]]+"-"+se[e[t+4]]+se[e[t+5]]+"-"+se[e[t+6]]+se[e[t+7]]+"-"+se[e[t+8]]+se[e[t+9]]+"-"+se[e[t+10]]+se[e[t+11]]+se[e[t+12]]+se[e[t+13]]+se[e[t+14]]+se[e[t+15]]).toLowerCase()}var Wa=T(require("crypto")),an=new Uint8Array(256),sn=an.length;function Fi(){return sn>an.length-16&&(Wa.default.randomFillSync(an),sn=0),an.slice(sn,sn+=16)}var qa=T(require("crypto")),wi={randomUUID:qa.default.randomUUID};function Om(e,t,n){if(wi.randomUUID&&!t&&!e)return wi.randomUUID();e=e||{};let r=e.random||(e.rng||Fi)();if(r[6]=r[6]&15|64,r[8]=r[8]&63|128,t){n=n||0;for(let o=0;o<16;++o)t[n+o]=r[o];return t}return Ga(r)}var bi=Om;async function wr(e,t){let n={...t,app:"dev-tools-cli",package:"cli"},r=await Lm(),o=await _m();return await Ht.track(e,n,{user_id:r,device_id:o}).promise}var un,Si;async function Ja(e){un=e;let t=await Ot();await Fn({...t,userId:e})}async function Lm(){if(un)return un;let e=await Ot(),t;return En(e,"userId")&&(t=e.userId),un=t,t}async function _m(){if(Si)return Si;let e=await Ot(),t=bi();return En(e,"deviceId")?t=e.deviceId:await Fn({...e,deviceId:t}),Si=t,t}var Ya=T(et(),1),Qa=require("undici");var Xa=T(et(),1);var Ha="0.0.0";var vi=T(require("process"),1),Za=T(require("@sentry/node"),1),Ct=async(e,t)=>{let n="fetch"in globalThis?globalThis.fetch:Qa.fetch;try{let r=Za.getTraceData(),o=await n(e,{...t,headers:{...t?.headers,...Mm(),...r}});if(!o.ok&&o.status===429){let s=await o.json(),i=s.severity??"high",a=s.message??"Rate limit exceeded. Please try again later.";return console.log(),i==="high"?o.error((0,Ya.red)(`${o.status} ${a}

`)):o.warn((0,Xa.yellow)(`${o.status} ${a}

`)),await at(1)}return o}catch(r){if(r instanceof Error&&r.name==="AbortError")throw r;let o=typeof e=="string"?e:e instanceof URL?e.toString():e.url,s=t?.method||"GET",i=r instanceof Error?r.message:String(r),a=new Error(`Fetch failed for ${s} ${o}: ${i}`);throw r instanceof Error&&(a.cause=r),a.requestContext={url:o,method:s,headers:t?.headers},a}};function Mm(){let t={darwin:"Macintosh",win32:"Windows NT",linux:"Linux",android:"Android",ios:"iPhone"}[vi.default.platform]||"Unknown",n=vi.default.platform==="win32"?"10.0":"";return{"User-Agent":`Mozilla/5.0 (${t}${n?"; "+n:""}) builder-cli/${Ha}`,"Sec-Ch-Ua-Platform":t}}var Um=T(require("@sentry/node"),1);var Xe=T(et(),1);var Wm=require("glob");var Vm=T(require("prettier"),1);var qm=T(require("chokidar"),1),Jm=T(require("ignore"),1);var Ti=T(require("process"),1);function Ii(){let{env:e}=Ti.default,{TERM:t,TERM_PROGRAM:n}=e;return Ti.default.platform!=="win32"?t!=="linux":!!e.WT_SESSION||!!e.TERMINUS_SUBLIME||e.ConEmuTask==="{cmd::Cmder}"||n==="Terminus-Sublime"||n==="vscode"||t==="xterm-256color"||t==="alacritty"||t==="rxvt-unicode"||t==="rxvt-unicode-256color"||e.TERMINAL_EMULATOR==="JetBrains-JediTerm"}var Ri=T(et(),1),ut=T(Nr(),1),ln=require("process"),xt=T(require("readline"),1),br=T(et(),1),cn=()=>{let e=Bi?["\u25D2","\u25D0","\u25D3","\u25D1"]:["\u2022","o","O","0"],t=Bi?80:120,n,r,o=!1,s="",i="",a="",u=d=>{let y=d>1?"Something went wrong":"Canceled";o&&g(y,d)},l=(d,y)=>{console.error(y,d),u(2)},c=()=>u(1),p=()=>{process.on("uncaughtExceptionMonitor",l),process.on("unhandledRejection",l),process.on("SIGINT",c),process.on("SIGTERM",c),process.on("exit",u)},m=()=>{process.removeListener("uncaughtExceptionMonitor",l),process.removeListener("unhandledRejection",l),process.removeListener("SIGINT",c),process.removeListener("SIGTERM",c),process.removeListener("exit",u)},D=(d="")=>{o=!0,n=ed(),s=d.replace(/\.+$/,""),process.stdout.write(`${Ri.default.gray(Hm)}
`);let y=0,F=0;p(),process.env.CI||(r=setInterval(()=>{let w=Ri.default.magenta(e[y]),b=".".repeat(Math.floor(F)).slice(0,3);process.stdout.write(ut.cursor.move(-999,-a.split(`
`).length+1)),process.stdout.write(ut.erase.down(a.split(`
`).length));let E=`${w}  ${s}${b}${i}`;process.stdout.write(E),y=y+1<e.length?y+1:0,F=F<e.length?F+.125:0,a=E},t))},g=(d,y=0)=>{s=d??s,o=!1,clearInterval(r);let F=y===0?(0,br.green)(Xm):y===1?(0,br.red)(Ym):(0,br.red)(Qm);process.stdout.write(ut.cursor.move(-999,-a.split(`
`).length+1)),process.stdout.write(ut.erase.down(a.split(`
`).length)),process.stdout.write(`${F}  ${s}
`),a=s,m(),n()};return{start:D,stop:g,message:(d="")=>{s=d??s},extra:(d="")=>{i=d}}},Bi=Ii(),pn=(e,t)=>Bi?e:t,Hm=pn("\u2502","|"),Ym=pn("\u25A0","x"),Qm=pn("\u25B2","x"),Xm=pn("\u25C7","o"),Zm=globalThis.process.platform.startsWith("win");function ed({input:e=ln.stdin,output:t=ln.stdout,overwrite:n=!0,hideCursor:r=!0}={}){let o=xt.createInterface({input:e,output:t,prompt:"",tabSize:1});xt.emitKeypressEvents(e,o),e.isTTY&&e.setRawMode(!0);let s=(i,{name:a})=>{if(String(i)===""){r&&t.write(ut.cursor.show),process.exit(0);return}if(!n)return;xt.moveCursor(t,a==="return"?0:-1,a==="return"?-1:0,()=>{xt.clearLine(t,1,()=>{e.once("keypress",s)})})};return r&&t.write(ut.cursor.hide),e.once("keypress",s),()=>{e.off("keypress",s),r&&t.write(ut.cursor.show),e.isTTY&&!Zm&&e.setRawMode(!1),o.terminal=!1,o.close()}}function lt(){}lt.prototype={diff:function(t,n){var r,o=arguments.length>2&&arguments[2]!==void 0?arguments[2]:{},s=o.callback;typeof o=="function"&&(s=o,o={}),this.options=o;var i=this;function a(w){return s?(setTimeout(function(){s(void 0,w)},0),!0):w}t=this.castInput(t),n=this.castInput(n),t=this.removeEmpty(this.tokenize(t)),n=this.removeEmpty(this.tokenize(n));var u=n.length,l=t.length,c=1,p=u+l;o.maxEditLength&&(p=Math.min(p,o.maxEditLength));var m=(r=o.timeout)!==null&&r!==void 0?r:1/0,D=Date.now()+m,g=[{oldPos:-1,lastComponent:void 0}],f=this.extractCommon(g[0],n,t,0);if(g[0].oldPos+1>=l&&f+1>=u)return a([{value:this.join(n),count:n.length}]);var h=-1/0,d=1/0;function y(){for(var w=Math.max(h,-c);w<=Math.min(d,c);w+=2){var b=void 0,E=g[w-1],B=g[w+1];E&&(g[w-1]=void 0);var U=!1;if(B){var I=B.oldPos-w;U=B&&0<=I&&I<u}var S=E&&E.oldPos+1<l;if(!U&&!S){g[w]=void 0;continue}if(!S||U&&E.oldPos+1<B.oldPos?b=i.addToPath(B,!0,void 0,0):b=i.addToPath(E,void 0,!0,1),f=i.extractCommon(b,n,t,w),b.oldPos+1>=l&&f+1>=u)return a(td(i,b.lastComponent,n,t,i.useLongestToken));g[w]=b,b.oldPos+1>=l&&(d=Math.min(d,w-1)),f+1>=u&&(h=Math.max(h,w+1))}c++}if(s)(function w(){setTimeout(function(){if(c>p||Date.now()>D)return s();y()||w()},0)})();else for(;c<=p&&Date.now()<=D;){var F=y();if(F)return F}},addToPath:function(t,n,r,o){var s=t.lastComponent;return s&&s.added===n&&s.removed===r?{oldPos:t.oldPos+o,lastComponent:{count:s.count+1,added:n,removed:r,previousComponent:s.previousComponent}}:{oldPos:t.oldPos+o,lastComponent:{count:1,added:n,removed:r,previousComponent:s}}},extractCommon:function(t,n,r,o){for(var s=n.length,i=r.length,a=t.oldPos,u=a-o,l=0;u+1<s&&a+1<i&&this.equals(n[u+1],r[a+1]);)u++,a++,l++;return l&&(t.lastComponent={count:l,previousComponent:t.lastComponent}),t.oldPos=a,u},equals:function(t,n){return this.options.comparator?this.options.comparator(t,n):t===n||this.options.ignoreCase&&t.toLowerCase()===n.toLowerCase()},removeEmpty:function(t){for(var n=[],r=0;r<t.length;r++)t[r]&&n.push(t[r]);return n},castInput:function(t){return t},tokenize:function(t){return t.split("")},join:function(t){return t.join("")}};function td(e,t,n,r,o){for(var s=[],i;t;)s.push(t),i=t.previousComponent,delete t.previousComponent,t=i;s.reverse();for(var a=0,u=s.length,l=0,c=0;a<u;a++){var p=s[a];if(p.removed){if(p.value=e.join(r.slice(c,c+p.count)),c+=p.count,a&&s[a-1].added){var D=s[a-1];s[a-1]=s[a],s[a]=D}}else{if(!p.added&&o){var m=n.slice(l,l+p.count);m=m.map(function(f,h){var d=r[c+h];return d.length>f.length?d:f}),p.value=e.join(m)}else p.value=e.join(n.slice(l,l+p.count));l+=p.count,p.added||(c+=p.count)}}var g=s[u-1];return u>1&&typeof g.value=="string"&&(g.added||g.removed)&&e.equals("",g.value)&&(s[u-2].value+=g.value,s.pop()),s}var FE=new lt;var tu=/^[A-Za-z\xC0-\u02C6\u02C8-\u02D7\u02DE-\u02FF\u1E00-\u1EFF]+$/,ru=/\S/,nu=new lt;nu.equals=function(e,t){return this.options.ignoreCase&&(e=e.toLowerCase(),t=t.toLowerCase()),e===t||this.options.ignoreWhitespace&&!ru.test(e)&&!ru.test(t)};nu.tokenize=function(e){for(var t=e.split(/([^\S\r\n]+|[()[\]{}'"\r\n]|\b)/),n=0;n<t.length-1;n++)!t[n+1]&&t[n+2]&&tu.test(t[n])&&tu.test(t[n+2])&&(t[n]+=t[n+2],t.splice(n+1,2),n--);return t};var iu=new lt;iu.tokenize=function(e){this.options.stripTrailingCr&&(e=e.replace(/\r\n/g,`
`));var t=[],n=e.split(/(\n|\r\n)/);n[n.length-1]||n.pop();for(var r=0;r<n.length;r++){var o=n[r];r%2&&!this.options.newlineIsToken?t[t.length-1]+=o:(this.options.ignoreWhitespace&&(o=o.trim()),t.push(o))}return t};var rd=new lt;rd.tokenize=function(e){return e.split(/(\S.+?[.!?])(?=\s+|$)/)};var nd=new lt;nd.tokenize=function(e){return e.split(/([{}:;,]|\s+)/)};function mn(e){"@babel/helpers - typeof";return typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?mn=function(t){return typeof t}:mn=function(t){return t&&typeof Symbol=="function"&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t},mn(e)}var id=Object.prototype.toString,Sr=new lt;Sr.useLongestToken=!0;Sr.tokenize=iu.tokenize;Sr.castInput=function(e){var t=this.options,n=t.undefinedReplacement,r=t.stringifyReplacer,o=r===void 0?function(s,i){return typeof i>"u"?n:i}:r;return typeof e=="string"?e:JSON.stringify(ki(e,null,null,o),o,"  ")};Sr.equals=function(e,t){return lt.prototype.equals.call(Sr,e.replace(/,([\r\n])/g,"$1"),t.replace(/,([\r\n])/g,"$1"))};function ki(e,t,n,r,o){t=t||[],n=n||[],r&&(e=r(o,e));var s;for(s=0;s<t.length;s+=1)if(t[s]===e)return n[s];var i;if(id.call(e)==="[object Array]"){for(t.push(e),i=new Array(e.length),n.push(i),s=0;s<e.length;s+=1)i[s]=ki(e[s],t,n,r,o);return t.pop(),n.pop(),i}if(e&&e.toJSON&&(e=e.toJSON()),mn(e)==="object"&&e!==null){t.push(e),i={},n.push(i);var a=[],u;for(u in e)e.hasOwnProperty(u)&&a.push(u);for(a.sort(),s=0;s<a.length;s+=1)u=a[s],i[u]=ki(e[u],t,n,r,u);t.pop(),n.pop()}else i=e;return i}var Ni=new lt;Ni.tokenize=function(e){return e.slice()};Ni.join=Ni.removeEmpty=function(e){return e};var ud=T(require("prettier"),1);var sd=T(cu(),1);var Qt=T(require("fs"),1);var pu=T(require("path"),1);var ad=()=>{let e="/tmp/builder";return Qt.existsSync(e)||Qt.mkdirSync(e,{recursive:!0}),e},mu=e=>pu.default.join(ad(),e),GE=mu(".builder-logs"),WE=mu(".builder-status");var C=T(et(),1);function Oi(e){switch(wr("cli help",{subcommand:e}),console.log(""),tt((0,C.bgCyan)((0,C.bold)((0,C.white)(" help ")))+"  "+(0,C.dim)(De)),e){case"add":case"generate":case"gen":case"g":tt(`${(0,C.cyan)("\u2192")} ${(0,C.bold)("Generate Figma Components")}

${(0,C.bgGreen)((0,C.white)(` npx ${xe()} figma generate URL [URL ...] `))}
...
${(0,C.yellow)("Arguments:")}
  ...
  ${(0,C.cyan)("--yes")}            Auto-confirm all prompts`);break;case"auth":M.info(`${(0,C.cyan)("\u2192")} ${(0,C.bold)("Authentication")}

${(0,C.bgGreen)((0,C.white)(` npx ${xe()} auth `))}
...
${(0,C.yellow)("Non-Interactive Authentication:")}
  ...
  ${(0,C.dim)(`npx ${xe()} figma generate <url> --ci`)}
...
${(0,C.yellow)("Learn More:")}
  ...
  \u2022 CI setup guide: https://www.builder.io/c/docs/integrating-builder-figma`);break;case"publish":M.info(`${(0,C.cyan)("\u2192")} ${(0,C.bold)("Publish Mappings")}

${(0,C.bgGreen)((0,C.white)(` npx ${xe()} figma publish `))}
...
${(0,C.yellow)("Arguments:")}
  ...
  ${(0,C.cyan)("--yes")}            Auto-confirm all prompts`);break;case"migrate":M.info(`${(0,C.cyan)("\u2192")} ${(0,C.bold)("Migrate Mappings")}

${(0,C.bgGreen)((0,C.white)(` npx ${xe()} figma migrate `))}
...
${(0,C.yellow)("Arguments:")}
  ...
  ${(0,C.cyan)("--yes")}            Auto-confirm all prompts`);break;case"code":M.info(`${(0,C.cyan)("\u2192")} ${(0,C.bold)("Code Generation")}

${(0,C.bgGreen)((0,C.white)(` npx ${xe()} code --url URL `))}
...
${(0,C.yellow)("Configuration Files:")}
  ...
  ${(0,C.cyan)(".cursorrules")}     Cursor's settings are automatically supported for consistent behavior`);break;case"indexing":M.info(`${(0,C.cyan)("\u2192")} ${(0,C.bold)("Code Indexing")}

${(0,C.bgGreen)((0,C.white)(` npx ${xe()} code indexing `))}

Index your codebase to improve code generation results.

${(0,C.yellow)("Arguments:")}
  ${(0,C.cyan)("--spaceId")}        Builder.io space ID to use
  ${(0,C.cyan)("--cwd")}            Working directory to run commands from`);break;case"index-repo":M.info(`${(0,C.cyan)("\u2192")} ${(0,C.bold)("Repository Indexing")}

${(0,C.bgGreen)((0,C.white)(` npx ${xe()} index-repo `))}

Index your entire repository to improve code generation results.

${(0,C.yellow)("Arguments:")}
  ${(0,C.cyan)("--spaceId")}        Builder.io space ID to use
  ${(0,C.cyan)("--cwd")}            Working directory to run commands from`);break;case"launch":case"fusion":M.info(`${(0,C.cyan)("\u2192")} ${(0,C.bold)("Fusion Development Server")}

${(0,C.bgGreen)((0,C.white)(` npx ${xe()} launch -p <port> -c <command> `))}
...
${(0,C.yellow)("Note:")}
  - The proxy runs on port ${(0,C.cyan)("48752")} and the API server on port ${(0,C.cyan)("48753")}`);break;case"launch-init":tt(`${(0,C.cyan)("\u2192")} ${(0,C.bold)("Initialize Builder.io Repository")}

${(0,C.bgGreen)((0,C.white)(` npx ${xe()} init `))}
...
${(0,C.yellow)("Arguments:")}
  ...
  ${(0,C.cyan)("--installCommand")}  Command to install dependencies (defaults to npm install)
  ${(0,C.cyan)("--volumePath")}      Path to clone repository to (defaults to ~/builder)`);break;default:M.info(`${(0,C.bold)("Available Commands:")}
`),[{command:"generate URL [URL ...]",description:"Start the auto-mapping wizard for Figma Component URLs"},{command:"publish",description:"Publish your Figma Mappings to Builder.io"},{command:"migrate",description:"Migrate existing Figma Mappings into the repo as local files"},{command:"auth",description:"Re-authenticate with Figma and Builder.io"},{command:"code",description:"Generate or modify code based on Figma designs"},{command:"indexing",description:"Index your codebase to improve code generation results"},{command:"index-repo",description:"Index your entire repository to improve code generation results"},{command:"code-server",description:"Start a development server that provides project file information and code analysis"},{command:"launch",description:"Launch a development server"}].forEach(({command:n,description:r})=>{M.info(`${(0,C.cyan)("\u2192")} ${(0,C.bgGreen)((0,C.white)(` npx ${xe()} figma ${n} `))}
   ${(0,C.dim)(r)}
`)}),M.info(`
Use ${(0,C.cyan)(`npx ${xe()} figma help <command>`)} for detailed help about a command`)}sr("bye \u{1F44B}")}async function Li(e){let{default:t}=await import("open");await t(e)}var Dw=`
   `+(0,Xe.dim)("ESC to interrupt");var Pe=T(require("typescript"),1);function _i(e){return!(e.category!==Pe.DiagnosticCategory.Error||!e.file||e.code===6133||e.code===6138||e.code===6305||e.code===6196||e.code===6192||e.code===6198||e.code===6199||e.code===6205||e.code===1449||e.code===2578||e.code===7006||e.code===5074||e.code===7026||e.code===2503||e.code===2695||e.code===2322)}async function cd(e,t,n){let r=[],o=[t],s=e.relative(e.getAppRootDir(),t.fileName);for(;o.length>0;){let i=o.shift();if(gd(i,t)){let a=md(e,i,t,n),{line:u,character:l}=t.getLineAndCharacterOfPosition(i.getStart());a&&(a.loc=`${s}:${u+1}:${l+1}`,r.push(a))}o.push(...i.getChildren(t))}return r}var pd="figmaMapping";function md(e,t,n,r){let[o]=t.arguments;if(!o)throw new Error("Invalid figmaMapping call, no arguments found");if(!L.default.isObjectLiteralExpression(o))throw new Error("Invalid figmaMapping call, argument is not an object literal");let s=o.properties;if(!s)throw new Error("Invalid figmaMapping call, argument has no properties");let i="",a,u,l,c="-",p=e.basename(n.fileName).replace(/\.mapper\.[tsxjm]+$/,""),m,D,g,f;if(t.typeArguments&&t.typeArguments.length>0){let y=gu(t.typeArguments[0].getText(n));y&&(p=y)}for(let y of s){let F=y.name?.getText(n);if(!F)throw new Error("Invalid figmaMapping call, property has no name");switch(F){case"componentName":{if(!("initializer"in y))throw new Error("Invalid figmaMapping call, componentName has no initializer");let w=y.initializer;if(!L.default.isStringLiteral(w))throw new Error("Invalid figmaMapping call, componentName is not a string literal");a=w.text;break}case"url":{if(!("initializer"in y))throw new Error("Invalid figmaMapping call, url has no initializer");let w=y.initializer;if(!L.default.isStringLiteral(w))throw new Error("Invalid figmaMapping call, url is not a string literal");f=w.text;break}case"componentKey":{if(!("initializer"in y))throw new Error("Invalid figmaMapping call, componentKey has no initializer");let w=y.initializer;if(!L.default.isStringLiteral(w))throw new Error("Invalid figmaMapping call, componentKey is not a string literal");i=w.text;break}case"mapper":if(L.default.isMethodDeclaration(y)){let w=function(E){let U=r.getSymbolAtLocation(E)?.getDeclarations()?.[0];if(U){let I=fd(U);if(I?.importClause){let S=I.importClause.name?.getText(n);return S===c?(m="default",D=S):I.importClause.namedBindings&&L.default.isNamedImports(I.importClause.namedBindings)&&(m="named",I.importClause.namedBindings.elements.forEach(v=>{v.name.getText(n)===c&&(D=v.name.getText(n))})),D&&L.default.isStringLiteral(I.moduleSpecifier)&&(g=I.moduleSpecifier.text),!0}}return!1},b=function(E){if((L.default.isJsxOpeningElement(E)||L.default.isJsxSelfClosingElement(E))&&L.default.isIdentifier(E.tagName)){c=E.tagName.getText(n),w(E.tagName);return}else if(L.default.isTaggedTemplateExpression(E)&&L.default.isIdentifier(E.tag)&&E.tag.escapedText==="html"){if(L.default.isTemplateExpression(E.template)){let U=E.template.templateSpans.find(I=>L.default.isIdentifier(I.expression)&&dd(I.expression.text)&&w(I.expression));if(U&&L.default.isIdentifier(U.expression)){c=U.expression.text;return}}let B=E.template.getText(n).match(/^`\s*<([^\s]+)/);if(B){c=B[1];return}}else L.default.forEachChild(E,b)};var h=w,d=b;if(y.parameters[0].type){let E=y.parameters[0].type.getText(n),B=gu(E);B&&(p=B)}L.default.forEachChild(y,b),l=y.getText(n).replace(/^mapper/,"function Mapper"),u=ji(l);break}case"designTokenMapper":if(L.default.isMethodDeclaration(y)){l=y.getText(n).replace(/^designTokenMapper/,"function Mapper"),u=ji(l),i="design-tokens";break}case"genericMapper":if(L.default.isMethodDeclaration(y)){l=y.getText(n).replace(/^genericMapper/,"function Mapper"),u=ji(l),i="*";break}}}if(!i&&!f)throw new Error("Invalid figmaMapping call, no componentKey or url found");if(!i&&!u)throw new Error("Invalid figmaMapping call, no mapper found");if(!i&&!l)throw new Error("Invalid figmaMapping call, no original mapper found");return{builderName:c,figmaName:a??p,figmaKey:i,figmaUrl:f,inputMapper:u,exportType:m,importName:D,importPath:g,originalInputMapper:l,imports:Cd(n),source:"cli"}}function dd(e){return e.charAt(0)===e.charAt(0).toUpperCase()}function ji(e){return L.default.transpile(e,{target:L.default.ScriptTarget.Latest,allowNonTsExtensions:!0,moduleResolution:L.default.ModuleResolutionKind.NodeJs,module:L.default.ModuleKind.CommonJS,noImplicitAny:!1,esModuleInterop:!0,noUnusedLocals:!1,noUnusedParameters:!1,jsx:L.default.JsxEmit.React,jsxFactory:"React.createElement",jsxFragmentFactory:"React.Fragment",allowJs:!0,checkJs:!0,strict:!0,suppressImplicitAnyIndexErrors:!0,typeRoots:["node_modules/@types"],inlineSources:!0,inlineSourceMap:!0})}function fd(e){let t=e;for(;t;){if(L.default.isImportDeclaration(t))return t;t=t.parent}}function gd(e,t){return L.default.isCallExpression(e)&&e.expression.getText(t)===pd}async function Du(e){let t=["node_modules","dist","build","public"];return(await e.readdirRecursive(e.getAppRootDir(),t)).filter(r=>he(r))}function gu(e){let t=e.match(/^Figma(\w+)Props$/);if(t&&typeof t[1]=="string")return t[1]}async function hu(e,t,n,r=!1){try{return n||(n=await on(e)),(await n.setPublicApiKey({publicApiKey:t})).modifiedType==="permission-error"?!1:(r&&await n.ensureFigmaImportPage(),!0)}catch{return!1}}var Dd={getCanonicalFileName:e=>e,getCurrentDirectory:()=>L.default.sys.getCurrentDirectory(),getNewLine:()=>L.default.sys.newLine};function hd(e){return L.default.formatDiagnosticsWithColorAndContext(e,Dd)}async function Cu({sys:e,mappingFiles:t,typeCheck:n}){if(e.Sentry?.setContext("findMappings",{mappingFiles:t}),!t.length)return{mapperFiles:[],figmaBuilderLinks:[],figmaLinksToResolve:[],diagnostics:[]};let r=[],o=[],s=[],i=await Z(e,t),a=i.getTypeChecker(),u=i.getSyntacticDiagnostics().filter(_i).filter(p=>p.file?.fileName?t.includes(p.file.fileName):!1);if(u.length>0)return M.error(`At least one of the mappings contain syntactic errors:

${hd(u)}`),at(1);let l=[...n?i.getSemanticDiagnostics():[]].filter(_i);for(let p of t)try{let m=i.getSourceFile(p);if(!m){e.Sentry?.captureException(new Error("Could not find source file"),{extra:{file:p,sourceFiles:i.getSourceFiles().map(f=>f.fileName)},level:"warning"});continue}let D=m?.fileName;if(o.push({filePath:p,content:m.getText()}),D){let f=l.filter(h=>h.file?.fileName===D);f.length>0&&s.push(...f)}let g=await cd(e,m,a);r.push(...g)}catch(m){return e.Sentry?.captureException(m),await at(1)}let c=r.filter(p=>p.figmaUrl&&!p.figmaKey).map(p=>p.figmaUrl);return{mapperFiles:o,figmaBuilderLinks:r,figmaLinksToResolve:c,diagnostics:s}}function Cd(e){let t=[];for(let n of e.statements){if(!L.default.isImportDeclaration(n)||!n.importClause||n.importClause.isTypeOnly||!L.default.isStringLiteral(n.moduleSpecifier))continue;let r=n.moduleSpecifier.text;if(r.startsWith("@builder.io"))continue;n.importClause.name&&t.push({importType:"default",importName:n.importClause.name.text,importPath:r});let o=n.importClause.namedBindings;if(o&&L.default.isNamedImports(o))for(let s of o.elements)s.isTypeOnly||t.push({importType:"named",importName:s.name.text,importPath:r})}return t}var Fu=require("crypto");var xd=5294,yd=5284,Ui=4,Mi=e=>!!(process.env.CI||e.ci),Yt=async(e,t,n)=>{let r=Mi(t)?{}:bd(e),o=r.spaceName,s,i=t.builderUserId??process.env.BUILDER_USER_ID??r.userId,a=t.builderPublicKey??process.env.BUILDER_PUBLIC_KEY??r.builderPublicKey,u=t.builderPrivateKey??process.env.BUILDER_PRIVATE_KEY??r.builderPrivateKey,l=process.env.FIGMA_PERSONAL_TOKEN??t.figmaToken;if(l?s={access_token:l,oauth:!1}:s=r.figmaAuth,n.forceSpaceId&&!t.yes&&a&&a!==n.forceSpaceId&&(M.warning(`CLI is currently logged in space ${(0,yt.yellow)(a)},
However the command required --spaceId=${(0,yt.green)(n.forceSpaceId)}`),await or({message:"Do you wanna switch spaces?",active:"Yes",inactive:`Stay in current ${o} space`})?(a=n.forceSpaceId,u=void 0,o=void 0,i=void 0):M.warning("Staying in the current space. Some other auth issues might occur.")),Mi(t)){if(!s&&n.figmaAuth)throw new Error(`No Figma personal token found.
Please set the FIGMA_PERSONAL_TOKEN environment variable.`);if(!u&&n.builderPrivateKey)throw new Error(`No Builder private key found.
Please set the BUILDER_PRIVATE_KEY environment variable.`);if(!a&&n.builderPublicKey)throw new Error(`No Builder public key found.
Please set the BUILDER_PUBLIC_KEY environment variable.`);return{figmaAuth:s,builderPublicKey:a,builderPrivateKey:u}}if((n.force||!s&&n.figmaAuth)&&(s=await Fd(e),xu(e,{figmaAuth:s})),n.force||!u&&n.builderPrivateKey||!a&&n.builderPublicKey){let{privateKey:c,spaceId:p,spaceName:m,userId:D}=await wd(e,n.forceSpaceId);if(n.forceSpaceId&&p!==n.forceSpaceId)throw new Error(`OAuth flow returned space ${(0,yt.yellow)(p)}, however the command specified --spaceId=${(0,yt.green)(n.forceSpaceId)}`);a=p,u=c,o=m,i=D,await Ja(i),await ct(e,e.getAppRootDir())&&(await hu(e,p,void 0,!1)||M.warn("Unable to set public api key in an existing .env file or create a new one. Please ensure you have write access in the current directory.")),xu(e,{builderPublicKey:a,builderPrivateKey:u,spaceName:o,userId:i})}return i&&e.Sentry?.setUser({id:i,username:process.env.USER||process.env.USERNAME||"unknown"}),(o||a)&&e.Sentry?.setContext("builder",{spaceId:a,spaceName:o,userId:i}),{figmaAuth:s,builderPublicKey:a,builderPrivateKey:u,spaceName:o,userId:i}},Ed="RHr2ed743waC2g2ZHMEJSn6O0NQ08L";async function Fd(e){let t=(0,Fu.randomUUID)();return wu({sys:e,name:"Figma",initialPort:xd,requestListener:async(n,r,o,s,i)=>{let a=new URL(r.url||"",`http://localhost:${n}`);if(a.pathname==="/figma-connect"){let u=a.searchParams.get("code"),l=a.searchParams.get("state"),c="nrGCqw6TLl95QJhVDi097A",p=Ed,D=`Basic ${Buffer.from(`${c}:${p}`).toString("base64")}`;if(u&&t===l){let g=await Ct("https://api.figma.com/v1/oauth/token",{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded",Authorization:D},body:new URLSearchParams({redirect_uri:`http://localhost:${n}/figma-connect`,code:u,grant_type:"authorization_code"}).toString()});g.ok||i(new Error("Failed to get figma access token"));let f=await g.json();o.end(`<!doctype html>
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8" />
    <script>
...
`.replace("{{MESSAGE}}","The CLI has authenticated correctly with Figma"),()=>{s({...f,oauth:!0})})}}},onListen:n=>{let r=new URL("https://www.figma.com/oauth");return r.searchParams.set("client_id","nrGCqw6TLl95QJhVDi097A"),r.searchParams.set("redirect_uri",`http://localhost:${n}/figma-connect`),r.searchParams.set("scope","files:read,file_dev_resources:read,file_variables:read"),r.searchParams.set("state",t),r.searchParams.set("response_type","code"),r.href}})}async function wd(e,t){let n=await e.getDeviceId();return wu({sys:e,name:"Builder.io",initialPort:yd,requestListener:async(r,o,s,i)=>{let a=new URL(o.url||"",`http://localhost:${r}`);a.pathname===Ft&&s.end(`<!doctype html>
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8" />
    <script>
...
`.replace("{{MESSAGE}}","The CLI has authenticated correctly with Builder.io"),()=>{i({privateKey:a.searchParams.get("p-key")||"",spaceId:a.searchParams.get("api-key")||"",spaceName:a.searchParams.get("org-name")||"",userId:a.searchParams.get("user-id")||""})})},onListen:r=>{let o=new URL("/cli-auth","https://builder.io");o.searchParams.set("client_id","builder-dev-tools-cli"),o.searchParams.set("host",n),o.searchParams.set("response_type","code"),o.searchParams.set("cli","true"),t&&o.searchParams.set("space_id",t);let s=new URL(Ft,`http://localhost:${r}`);s.searchParams.set(Pr,(0,Eu.platform)()),s.searchParams.set(Tr,process.versions.node);let i=e.getFrameworks();return i.length>0&&(o.searchParams.set(Rt,i[0].name),s.searchParams.set(Rt,i[0].name)),o.searchParams.set("redirect_url",s.href),o.href}})}function xu(e,t){let n=[(0,Ze.join)(e.getAppRootDir(),"node_modules",".builder","data.json"),(0,Ze.join)(e.getRepoRootDir(),".git",".builder.json")],r;for(let o of n)if((0,$e.existsSync)(o)){r=o;break}if(r)try{let o=(0,$e.readFileSync)(r,"utf8");t=Object.assign(JSON.parse(o).credentials,t)}catch(o){e.Sentry?.captureException(o)}else(0,$e.existsSync)((0,Ze.join)(e.getAppRootDir(),"package.json"))?r=(0,Ze.join)(e.getAppRootDir(),"node_modules",".builder","data.json"):r=(0,Ze.join)(e.getRepoRootDir(),".git",".builder.json"),(0,$e.mkdirSync)((0,Ze.dirname)(r),{recursive:!0});(0,$e.writeFileSync)(r,JSON.stringify({credentials:t},null,2))}function bd(e){let t=[(0,Ze.join)(e.getAppRootDir(),"node_modules",".builder","data.json"),(0,Ze.join)(e.getRepoRootDir(),".git",".builder.json")];for(let n of t)if((0,$e.existsSync)(n))try{let r=(0,$e.readFileSync)(n,"utf8");return JSON.parse(r).credentials}catch(r){e.Sentry?.captureException(r)}return{}}async function wu(e){let t,n,r,o=new Promise((p,m)=>{t=p,n=m}),s=e.initialPort,i=0,a=(0,yu.createServer)((p,m)=>e.requestListener(s,p,m,t,n)),u=()=>{l(),a&&("closeAllConnections"in a&&a.closeAllConnections(),a.close(p=>{p&&e.sys.Sentry?.captureException(p)}))};process.on("uncaughtExceptionMonitor",u),process.on("unhandledRejection",u),process.on("SIGINT",u),process.on("SIGTERM",u),process.on("exit",u);let l=()=>{process.removeListener("uncaughtExceptionMonitor",u),process.removeListener("unhandledRejection",u),process.removeListener("SIGINT",u),process.removeListener("SIGTERM",u),process.removeListener("exit",u)},c=()=>new Promise((p,m)=>{let D=g=>{a.removeListener("error",D),g.code==="EADDRINUSE"&&i<Ui?(M.warning(`Port ${s} is already in use, trying next port`),s++,i++,p(0)):m(g)};a.once("error",D),a.listen(s,()=>{a.removeListener("error",D);let g=a.address();p(g.port)})});try{let p=0;for(;p===0&&i<Ui;)p=await c();if(p===0)throw new Error(`Failed to find an available port after ${Ui} attempts`);let m=e.onListen(p);M.warn(`Required authenticating with ${e.name}
OPEN: ${(0,yt.dim)(m)}`),r=cn(),r.start(`Waiting for ${e.name} authentication`),await Li(m);let D=await o;return r&&r.stop(`Authenticated with ${e.name} successfully`),D}catch(p){throw r&&(r.stop(`Failed to authenticate with ${e.name}.`,-1),Oi("auth")),e.sys.Sentry?.captureException(p),u(),p}finally{u()}}async function Su(e,t,n,r){try{if(!e)return Xt(n,r,400,"Builder context closed");let o=Td(n);if(o.pathname===gn){if(n.method==="POST"){let s=await Pd(n);if(s)try{let i=await Co(e,JSON.parse(s));return bu(n,r,200,i)}catch(i){e.debug("Dev API Error",i.stack||i.message||i);let a={errors:[String(i.message||i)]};return bu(n,r,500,a)}}else if(n.method==="OPTIONS"){let s={"Access-Control-Allow-Methods":"POST, OPTIONS","Access-Control-Allow-Headers":"Content-Type, Cache-Control, X-Builder-Devtools-Version, sentry-trace, baggage"},i=n.headers.origin;i&&i!=="null"?vu(new URL(i))&&(s["Access-Control-Allow-Origin"]=i):s["Access-Control-Allow-Origin"]="*",r.writeHead(200,s),r.end();return}return Xt(n,r,405,`${gn} is an API endpoint used only during development by the Builder.io Devtools client-side script`)}if(o.pathname===Dn)return Sd(n,r,200,await xo(e));if(o.pathname===zi){let s=o.searchParams.get(fn);return s?Ad(r,302,await wo(e,s)):Xt(n,r,400,`Missing ${fn} querystring`)}if(o.pathname===Ft)return vd(n,r,200,await yo(e));if(o.pathname===Gi){await Yt(e,{_:[]},{});let s=await Du(e),{figmaBuilderLinks:i,diagnostics:a}=await Cu({mappingFiles:s,sys:e});return vr(n,r,200,"application/json",JSON.stringify({figmaBuilderLinks:i,foundErrors:a.length>0,diagnostics:a,version:2,local:!0},null,2))}return o.pathname===wt?(e.debug(`Close Dev Tools Server Requested: ${o.href}`),setTimeout(()=>{try{t.close(s=>{e.debug(`Dev Tools Server Closed Error: ${s}`)})}catch(s){e.debug(`Error closing devtools server: ${s}`)}},20),Xt(n,r,200,"Closing Dev Tools Server")):Xt(n,r,404,"Not found")}catch(o){return e?.Sentry?.captureException(o),Xt(n,r,500,`Dev Server Error: ${o}`)}}function bu(e,t,n,r){vr(e,t,n,"application/json",JSON.stringify(r))}function Sd(e,t,n,r){vr(e,t,n,"application/javascript",r)}function vd(e,t,n,r){vr(e,t,n,"text/html",r)}function Xt(e,t,n,r){vr(e,t,n,"text/plain",r)}function vr(e,t,n,r,o){let s={"Content-Type":`${r}; charset=utf-8`,"Cache-Control":"no-cache, no-store, must-revalidate","X-Builder-Devtools-Version":De},i=e.headers.origin;i&&i!=="null"?vu(new URL(i))&&(s["Access-Control-Allow-Origin"]=i):s["Access-Control-Allow-Origin"]="*",t.writeHead(n,s),t.end(o)}function vu(e){return e.hostname==="localhost"||e.origin==="https://builder.io"||e.origin==="https://www.builder.io"||e.origin.endsWith(".builder.io")?!0:e.port===""?!1:e.port!=="80"&&e.port!=="443"}function Ad(e,t,n){e.writeHead(t,{Location:n}),e.end()}async function Pd(e){let t="";for await(let n of e)t+=n;return t}function Td(e){let t=e.url||"/";return new URL(t,`http://${e.headers.host}`)}async function Au(e){if(globalThis.__builderDevToolsServer)return e.debug("reusing existing devtools server"),globalThis.__builderDevToolsServer.setContext(e),globalThis.__builderDevToolsServer;let t=await Id(e),n=(0,dn.createServer)((o,s)=>{Su(e,n,o,s)}),r=()=>new Promise((o,s)=>{n.listening?(e.debug(`closing devtools server on port ${t}`),n.close(i=>{e=null,i?(e.debug(`error closing devtools server on port ${t}`),s(i)):(e&&e.debug(`closed devtools server on port ${t}`),o())})):(e.debug(`devtools server on port ${t} not listening`),o())});return process.once("SIGTERM",r),process.once("SIGINT",r),process.env.CI!=="true"&&process.stdin.on("end",r),globalThis.__builderDevToolsServer={url:new URL(`http://localhost:${t}`).href,port:t,setContext:o=>{e.debug(`set devtools context on server ${t}`),e=o},close:async()=>{globalThis.__builderDevToolsServer=null,await r()}},new Promise(o=>{n.listen(t,()=>{e.debug(`started devtools server on port ${t}`),o(globalThis.__builderDevToolsServer)})})}function Id(e){return new Promise(t=>{let n=e.port;try{(0,dn.request)({hostname:"localhost",port:n,path:wt,method:"GET"},o=>{o.on("end",()=>{e.debug(`${wt} - Response ended`),t(n)})}).on("error",o=>{e.debug(`${wt} - No response ${o}`),t(n)}).end()}catch(r){e.debug(`${wt} - Error ${r}`),t(n)}})}async function Pi(e){let t={...e,devToolsServerUrl:"",isValid:!1,serverShouldRestart:!1,publicApiKey:"",port:e.port||5273,ignoreMissingConfig:!1,getAllProjectFiles:e.getAllProjectFiles||(()=>Promise.resolve([]))},n=e.getFrameworks().map(s=>s.name).join(", ");t.debug(`create devtools ${Vi} [${n}]`);let r=await Au(t);return t.devToolsServerUrl=r.url,t.port=r.port,{getUrl:()=>t.devToolsServerUrl}}var Vi=De;0&&(module.exports={createDevToolsServer,version});
